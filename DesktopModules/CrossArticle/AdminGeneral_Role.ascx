<%@ control language="C#" autoeventwireup="true" inherits="Cross.Modules.Article.View.AdminGeneral_Role, App_Web_admingeneral_role.ascx.6c70b780" %>
    ...
    <tr visible="true" id="trGrid" runat="server" valign="top">
        <td align="left" valign="top">
            <asp:GridView ID="gvList" runat="server" AutoGenerateColumns="False" 
                Width="100%" CellPadding="1"  CellSpacing="1"  GridLines="Both" BackColor="Gray" ForeColor="#333333" DataKeyNames="RoleId" OnRowCommand="gvList_RowCommand">
                <EmptyDataTemplate>
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="ArticleCount" SortExpression="ArticleCount">
                        <HeaderTemplate>
                            <asp:Label ID="lblArticleCount" runat="server" resourcekey="lblArticleCount">ArticleCount</asp:Label>
                        </HeaderTemplate>
                        <ItemTemplate>
                            <asp:Label ID="lblArticleCountData" runat="server" Text='<%# Eval("ArticleCount") %>'></asp:Label>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="right" />
                    </asp:TemplateField>
                     <asp:TemplateField>
                        <HeaderTemplate>
                            <asp:Label ID="lblAllowImportFromRss" runat="server" resourcekey="lblAllowImportFromRss">AllowImportFromRss</asp:Label>
                        </HeaderTemplate>
                        <ItemTemplate>
                            <asp:CheckBox ID="chkAllowImportFromRssField" runat="server" Checked='<%# Eval("AllowImportFromRss") %>'
                                Enabled="false" />
                        </ItemTemplate>
                    ...
                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                        ...
                        <ItemTemplate>
                            <asp:ImageButton ID="imgEdit" runat="server" CausesValidation="False" CommandName="Select"
                                CommandArgument='<%# Eval("RoleId")%>' ToolTip='<%#Localization.GetString("imgEdit",Cross.Modules.Article.Business.LocalUtils.ResourcesFile_Shared)%>'
                            ...
                            <asp:ImageButton ID="imgDel" runat="server" CausesValidation="False" CommandName="Del"
                                CommandArgument='<%# Eval("RoleId")%>' ImageUrl="~/images/delete.gif" AlternateText='<%#Localization.GetString("imgDel",Cross.Modules.Article.Business.LocalUtils.ResourcesFile_Shared)%>'
            ...
            <table width="100%" cellspacing="2" cellpadding="2" border="0" class="dnnFormItem">
                ...
                <tr>
                    <td style="width:150px">
                        <dnn:Label ID="plRole" runat="server"></dnn:Label>
                    </td>
                    <td >
                ...
                <tr>
                    <td >
                        <dnn:Label ID="plDiskQuote" runat="server" ControlName="txtDiskQuote"></dnn:Label>
                    </td>
                    <td>
                        <asp:TextBox ID="txtDiskQuote" runat="server" CssClass="NormalTextBox" width="200px"
                            Text="50"></asp:TextBox>
                ...
                <tr>
                    <td colspan="2">
                        <asp:Label ID="Label3" runat="server" resourcekey="Tip_ArticleCount" CssClass="dnnFormMessage dnnFormInfo"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td >
                        <dnn:Label ID="plArticleCount" runat="server" ControlName="txtArticleCount"></dnn:Label>
                    </td>
                    <td >
                        <asp:TextBox ID="txtArticleCount" runat="server" CssClass="NormalTextBox" width="200px"
                            Text="-1"></asp:TextBox>
                        <asp:Label ID="lblArticleCountTip" runat="server" resourcekey="lblDiskQuoteTip"></asp:Label>
                        <asp:RegularExpressionValidator ID="Regularexpressionvalidator1" resourcekey="MustBeInteger"
                            runat="server" ValidationExpression="^-?\d+$" ControlToValidate="txtArticleCount"></asp:RegularExpressionValidator>
                    </td>
                </tr>
                 <tr>
                    <td colspan="2">
                        <asp:Label ID="Label5" runat="server" resourcekey="Tip_AllowImportFromRss" CssClass="dnnFormMessage dnnFormInfo"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td>
                        <dnn:Label ID="plAllowImportFromRss" runat="server" ControlName="chkAllowImportFromRss"></dnn:Label>
                    </td>
                    <td >
                        <asp:CheckBox runat="server" ID="chkAllowImportFromRss" />
                    </td>
                </tr>
                 <tr>
                    <td colspan="2">
                        <asp:Label ID="Label4" runat="server" resourcekey="Tip_Types" CssClass="dnnFormMessage dnnFormInfo"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <asp:CheckBoxList ID="cblType" runat="server" RepeatColumns="3">
                        </asp:CheckBoxList>
                    </td>
                </tr>
            </table>
