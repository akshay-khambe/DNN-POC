            ...
            <div class="panel-body">
                <div class="form-horizontal">
                   ...
                   <div class="form-group">
                    ...
                    <div class="form-group">
                        <%=ViewControlTitle("lblSSLEnforced", "SSL Enforced", "cbSSLEnforced", ":", "col-sm-3 control-label")%>
                        <div class="col-sm-5">
                            <div class="checkbox-inline">
                                <asp:CheckBox ID="cbSSLEnforced" runat="server" CssClass="auto" />
                                </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <%=ViewControlTitle("lblValidationLang", "Language used for validation", "ddlValidationLang", ":", "col-sm-3 control-label")%>
                        <div class="col-sm-5">
                            <div class="control-inline">
                               <asp:DropDownList ID="ddlValidationLang" runat="server" CssClass="form-control"  style="width:150px;"></asp:DropDownList>
                            </div>
                        </div>
                    </div>
            ...
            <div class="panel-body">
                <div class="form-horizontal">
                   ...
                   <div class="form-group">
                    ...
                    <div class="form-group">
                        <%=ViewControlTitle("lblCleanupAttachments", "Cleanup Attachments", "cbCleanupAttachments", ":", "col-sm-3 control-label")%>
                        <div class="col-sm-5">
                            <div class="checkbox-inline">
                                <asp:CheckBox ID="cbCleanupAttachments" runat="server" CssClass="auto" />
                             </div>
                        </div>
                    </div>
                </div>
