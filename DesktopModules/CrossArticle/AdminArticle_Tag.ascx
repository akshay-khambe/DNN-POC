<%@ control language="C#" autoeventwireup="true" inherits="Cross.Modules.Article.View.AdminArticle_Tag, App_Web_adminarticle_tag.ascx.6c70b780" %>
...
<table width="100%" cellpadding="1" cellspacing="1" class="dnnFormItem" align="center">
    <tr>
        <td align="center">
            ...
            <asp:DropDownList ID="ddlArticleType" runat="server" DataTextField="Name" DataValueField="Id" Width="100px"
