(function ($) {
    ...
    $.contentbuilder = function (options) {
        ...
        plugin.init = function () {
            ...
            if (plugin.settings.sourceEditor == false) {
            ...
            if (plugin.settings.framework == 'bootstrap') {
                ...
                if (plugin.settings.row != '' && plugin.settings.cols.length > 0) {} else {
            ...
            if (jQuery('#divFb').length == 0) {
                ...
                for (var j = 0; j < plugin.settings.buttons.length; j++) {
                    ...
                    if (btn == 'bold') html_rte += '<button title="' + out('Bold') + '" class="cell-format" data-command="bold"><span style="font-family:serif;font-size:14px;display:inline-block;">B</span></button>';
                    ...
                    else if (btn == 'createlink') html_rte += '<button title="' + out('Hyperlink') + '" class="cell-link"><svg class="is-icon-flex" style="fill:rgba(0, 0, 0, 0.65);width:16px;height:16px;"><use xlink:href="#ion-link"></use></svg></button>';
                        ...
                        html_rte += '<button title="button not found" data-plugin="' + btn + '">-</button>'
                    }
                }
                var html_rtemore = '';
                for (var j = 0; j < plugin.settings.buttonsMore.length; j++) {
                    ...
                    if (btn == 'createlink') html_rtemore += '<button title="' + out('Hyperlink') + '" class="cell-link"><svg class="is-icon-flex" style="fill:rgba(0, 0, 0, 0.65);width:16px;height:16px;"><use xlink:href="#ion-link"></use></svg></button>';
                        ...
                        html_rtemore += '<button title="button not found" data-plugin="' + btn + '">-</button>'
                    }
                }
                ...
                var html = '' + '<svg width="0" height="0" style="position:absolute;display:none;">' + '<defs>' + '<symbol viewBox="0 0 512 512" id="ion-ios-arrow-left"><path d="M352 115.4L331.3 96 160 256l171.3 160 20.7-19.3L201.5 256z"></path></symbol>' + '<symbol viewBox="0 0 512 512" id="ion-ios-arrow-right"><path d="M160 115.4L180.7 96 352 256 180.7 416 160 396.7 310.5 256z"></path></symbol>' + '<symbol viewBox="0 0 512 512" id="ion-ios-plus-outline"><path d="M256 48C141.1 48 48 141.1 48 256s93.1 208 208 208 208-93.1 208-208S370.9 48 256 48zm0 398.7c-105.1 0-190.7-85.5-190.7-190.7S150.9 65.3 256 65.3 446.7 150.9 446.7 256 361.1 446.7 256 446.7z"></path><path d="M264.1 128h-16.8v119.9H128v16.8h119.3V384h16.8V264.7H384v-16.8H264.1z"></path></symbol>' + '<symbol viewBox="0 0 512 512" id="ion-image"><path d="M368 224c26.5 0 48-21.5 48-48s-21.5-48-48-48-48 21.5-48 48 21.5 48 48 48z"></path><path d="M452 64H60c-15.6 0-28 12.7-28 28.3v327.4c0 15.6 12.4 28.3 28 28.3h392c15.6 0 28-12.7 28-28.3V92.3c0-15.6-12.4-28.3-28-28.3zM348.9 261.7c-3-3.5-7.6-6.2-12.8-6.2-5.1 0-8.7 2.4-12.8 5.7L304.6 277c-3.9 2.8-7 4.7-11.5 4.7-4.3 0-8.2-1.6-11-4.1-1-.9-2.8-2.6-4.3-4.1L224 215.3c-4-4.6-10-7.5-16.7-7.5-6.7 0-12.9 3.3-16.8 7.8L64 368.2V107.7c1-6.8 6.3-11.7 13.1-11.7h357.7c6.9 0 12.5 5.1 12.9 12l.3 260.4-99.1-106.7z"></path></symbol>' + '<symbol viewBox="0 0 512 512" id="ion-ios-photos-outline"><path d="M96 128v320h384V128H96zm368 304H112V144h352v288z"></path><path d="M32 64v320h48v-16H48V80h352v32h16V64z"></path></symbol>' + '<symbol viewBox="0 0 512 512" id="ion-ios-settings-strong"><path d="M32 376h283.35c6.186-14.112 20.281-24 36.65-24s30.465 9.888 36.65 24H480v32h-91.35c-6.186 14.112-20.281 24-36.65 24s-30.465-9.888-36.65-24H32M32 240h91.35c6.186-14.112 20.281-24 36.65-24s30.465 9.888 36.65 24H480v32H196.65c-6.186 14.112-20.281 24-36.65 24s-30.465-9.888-36.65-24H32M32 104h283.35c6.186-14.112 20.281-24 36.65-24s30.465 9.888 36.65 24H480v32h-91.35c-6.186 14.112-20.281 24-36.65 24s-30.465-9.888-36.65-24H32"></path></symbol>' + '<symbol viewBox="0 0 512 512" id="ion-ios-settings"><path d="M352 104c8.837 0 16 7.163 16 16s-7.163 16-16 16-16-7.163-16-16 7.163-16 16-16m0-16c-17.645 0-32 14.355-32 32s14.355 32 32 32 32-14.355 32-32-14.355-32-32-32zM352 376c8.837 0 16 7.163 16 16s-7.163 16-16 16-16-7.163-16-16 7.163-16 16-16m0-16c-17.645 0-32 14.355-32 32s14.355 32 32 32 32-14.355 32-32-14.355-32-32-32zM160 240c8.837 0 16 7.163 16 16s-7.163 16-16 16-16-7.163-16-16 7.163-16 16-16m0-16c-17.645 0-32 14.355-32 32s14.355 32 32 32 32-14.355 32-32-14.355-32-32-32zM207.32 248H480v16H207.32c.439-2.604.68-5.273.68-8s-.24-5.396-.68-8zM112 256c0 2.727.24 5.396.68 8H32v-16h80.68a47.955 47.955 0 0 0-.68 8zM399.32 384H480v16h-80.68c.439-2.604.68-5.273.68-8s-.24-5.396-.68-8zM304 392c0 2.727.24 5.396.68 8H32v-16h272.68a47.955 47.955 0 0 0-.68 8zM399.32 112H480v16h-80.68c.439-2.604.68-5.273.68-8s-.24-5.396-.68-8zM304.68 112c-.439 2.604-.68 5.273-.68 8s.24 5.396.68 8H32v-16h272.68z"></path></symbol>' + '<symbol viewBox="0 0 512 512" id="ion-android-options"><path d="M32 384h272v32H32zM400 384h80v32h-80zM384 447.5c0 17.949-14.327 32.5-32 32.5-17.673 0-32-14.551-32-32.5v-95c0-17.949 14.327-32.5 32-32.5 17.673 0 32 14.551 32 32.5v95z"></path><g><path d="M32 240h80v32H32zM208 240h272v32H208zM192 303.5c0 17.949-14.327 32.5-32 32.5-17.673 0-32-14.551-32-32.5v-95c0-17.949 14.327-32.5 32-32.5 17.673 0 32 14.551 32 32.5v95z"></path></g><g><path d="M32 96h272v32H32zM400 96h80v32h-80zM384 159.5c0 17.949-14.327 32.5-32 32.5-17.673 0-32-14.551-32-32.5v-95c0-17.949 14.327-32.5 32-32.5 17.673 0 32 14.551 32 32.5v95z"></path></g></symbol>' + '<symbol viewBox="0 0 2048.0 2048.0" id="icon-list-number"><rect x="0" y="0" width="2048.00" height="2048.00" fill="#ffffff" /><g id="document" transform="matrix(1,0,0,1,1024.0,1024.0)"><path d="M-1043.45,1024 C-1039.25,946.283 -1023.18,878.648 -995.249,821.096 C-967.313,763.544 -912.806,711.242 -831.728,664.192 L-710.742,594.247 C-656.55,562.74 -618.532,535.854 -596.687,513.589 C-562.24,478.722 -545.016,438.813 -545.016,393.863 C-545.016,341.352 -560.769,299.658 -592.276,268.781 C-623.783,237.904 -665.792,222.466 -718.304,222.466 C-796.02,222.466 -849.792,251.873 -879.619,310.685 C-895.582,342.192 -904.404,385.882 -906.084,441.754 L-1021.4,441.754 C-1020.14,363.197 -1005.65,299.133 -977.92,249.562 C-928.769,162.183 -842.02,118.494 -717.673,118.494 C-614.331,118.494 -538.82,146.43 -491.139,202.302 C-443.459,258.174 -419.619,320.347 -419.619,388.822 C-419.619,461.078 -445.034,522.831 -495.865,574.082 C-525.272,603.909 -577.993,640.037 -654.03,682.466 L-740.358,730.356 C-781.527,753.041 -813.874,774.676 -837.399,795.26 C-879.408,831.808 -905.874,872.347 -916.797,916.877 L-424.03,916.877 L-424.03,1024 L-1043.45,1024 Z "  />	<path d="M-922.391,-764.384 L-922.391,-851.343 C-840.474,-859.324 -783.341,-872.662 -750.994,-891.356 C-718.647,-910.05 -694.492,-954.265 -678.529,-1024 L-589.049,-1024 L-589.049,-125.425 L-710.035,-125.425 L-710.035,-764.384 L-922.391,-764.384 Z "  />	<path d="M-198.618,-510.942 L-198.618,-667.156 L1004.57,-667.156 L1004.57,-510.942 L-198.618,-510.942 Z "  />	<path d="M-198.618,78.1071 L-198.618,-78.1071 L1004.57,-78.1071 L1004.57,78.1071 L-198.618,78.1071 Z "  /><path d="M-179.185,649.354 L-179.185,493.14 L1024,493.14 L1024,649.354 L-179.185,649.354 Z "  /></g></symbol>' + '<symbol viewBox="0 0 2048.0 2048.0" id="icon-list-bullet"><rect x="0" y="0" width="2048.00" height="2048.00" fill="#ffffff" /><g id="document" transform="matrix(1,0,0,1,1024.0,1024.0)"><path d="M-379.801,-514.33 L-379.801,-670.545 L914.662,-670.545 L914.662,-514.33 L-379.801,-514.33 Z "  /><path d="M-379.801,78.1071 L-379.801,-78.1071 L914.662,-78.1071 L914.662,78.1071 L-379.801,78.1071 Z "  /><path d="M-379.801,670.545 L-379.801,514.33 L914.662,514.33 L914.662,670.545 L-379.801,670.545 Z "  /><path d="M-929.642,-469.441 L-929.642,-715.434 L-669.092,-715.434 L-669.092,-469.441 L-929.642,-469.441 Z "  /><path d="M-929.642,127.109 L-929.642,-118.885 L-669.092,-118.885 L-669.092,127.109 L-929.642,127.109 Z "  /><path d="M-929.642,715.434 L-929.642,469.441 L-669.092,469.441 L-669.092,715.434 L-929.642,715.434 Z "  /></g></symbol>' + '<symbol viewBox="0 0 2048.0 2048.0" id="icon-clean"><g transform="matrix(1,0,0,1,1024.0,1024.0)"><path d="M75.0013,893.849 L-1030.73,900.993 L-32.1518,-880.838 L1009.54,-880.838 L75.0013,893.849 Z " /><path d="M-30.8571,780.685 L-845.2,787.828 L-508.893,193.749 L305.26,194.963 L-30.8571,780.685 Z " fill="#ffffff" fill-opacity="1.00" /></g></symbol>' + '<symbol viewBox="0 0 2048.0 2048.0" id="icon-align-full"><rect x="0" y="0" width="2048.00" height="2048.00" fill="#ffffff" /><g id="document" transform="matrix(1,0,0,1,1024.0,1024.0)"><path d="M-770.727,738.299 L-770.727,582.085 L769.712,582.085 L769.712,738.299 L-770.727,738.299 Z " /><path d="M-770.727,-534.628 L-770.727,-690.842 L769.712,-690.842 L769.712,-534.628 L-770.727,-534.628 Z " /><path d="M-770.219,-115.563 L-770.219,-271.777 L770.219,-271.777 L770.219,-115.563 L-770.219,-115.563 Z " /><path d="M-770.219,303.503 L-770.219,147.288 L770.219,147.288 L770.219,303.503 L-770.219,303.503 Z " />		</g></symbol>' + '<symbol viewBox="0 0 2048.0 2048.0" id="icon-align-center"><rect x="0" y="0" width="2048.00" height="2048.00" fill="#ffffff" /><g id="document" transform="matrix(1,0,0,1,1024.0,1024.0)"><path d="M-770.727,738.299 L-770.727,582.085 L769.712,582.085 L769.712,738.299 L-770.727,738.299 Z " /><path d="M-552.286,-107.697 L-552.286,-263.911 L552.286,-263.911 L552.286,-107.697 L-552.286,-107.697 Z " /><path d="M-467.355,319.234 L-467.355,163.02 L466.34,163.02 L466.34,319.234 L-467.355,319.234 Z " /><path d="M-770.727,-534.628 L-770.727,-690.842 L769.712,-690.842 L769.712,-534.628 L-770.727,-534.628 Z " />		</g></symbol>' + '<symbol viewBox="0 0 2048.0 2048.0" id="icon-align-left"><rect x="0" y="0" width="2048.00" height="2048.00" fill="#ffffff" /><g id="document" transform="matrix(1,0,0,1,1024.0,1024.0)"><path d="M-770.727,738.299 L-770.727,582.085 L769.712,582.085 L769.712,738.299 L-770.727,738.299 Z " /><path d="M-770.727,-534.628 L-770.727,-690.842 L769.712,-690.842 L769.712,-534.628 L-770.727,-534.628 Z " /><path d="M-770.219,-115.563 L-770.219,-271.777 L482.839,-271.777 L482.839,-115.563 L-770.219,-115.563 Z " /><path d="M-770.219,303.503 L-770.219,147.288 L122.787,147.288 L122.787,303.503 L-770.219,303.503 Z " />		</g></symbol>' + '<symbol viewBox="0 0 2048.0 2048.0" id="icon-align-right"><rect x="0" y="0" width="2048.00" height="2048.00" fill="#ffffff" /><g id="document" transform="matrix(1,0,0,1,1024.0,1024.0)"><path d="M-770.727,738.299 L-770.727,582.085 L769.712,582.085 L769.712,738.299 L-770.727,738.299 Z " /><path d="M-770.727,-534.628 L-770.727,-690.842 L769.712,-690.842 L769.712,-534.628 L-770.727,-534.628 Z " /><path d="M-483.346,-118.081 L-483.346,-274.295 L769.712,-274.295 L769.712,-118.081 L-483.346,-118.081 Z " /><path d="M-123.871,303.503 L-123.871,147.288 L769.136,147.288 L769.136,303.503 L-123.871,303.503 Z " />		</g></symbol>' + '<symbol viewBox="0 0 2048.0 2048.0" id="icon-indent"><rect x="0" y="0" width="2048.00" height="2048.00" fill="#ffffff" /><g id="document" transform="matrix(1,0,0,1,1024.0,1024.0)"><path d="M-829.04,-514.33 L-829.04,-670.545 L808.959,-670.545 L808.959,-514.33 L-829.04,-514.33 Z " /><path d="M-829.04,670.545 L-829.04,514.33 L808.959,514.33 L808.959,670.545 L-829.04,670.545 Z " /><path d="M-254.279,-110.244 L-254.279,-266.458 L808.959,-266.458 L808.959,-110.244 L-254.279,-110.244 Z " /><path d="M-254.279,266.458 L-254.279,110.244 L808.959,110.244 L808.959,266.458 L-254.279,266.458 Z " /><path d="M-829.04,-195.117 L-490.958,-1.03508e-14 L-829.04,195.117 L-829.04,-195.117 Z " />		</g></symbol>' + '<symbol viewBox="0 0 2048.0 2048.0" id="icon-outdent"><rect x="0" y="0" width="2048.00" height="2048.00" fill="#ffffff" /><g id="document" transform="matrix(1,0,0,1,1024.0,1024.0)"><path d="M-829.04,-514.33 L-829.04,-670.545 L808.959,-670.545 L808.959,-514.33 L-829.04,-514.33 Z " /><path d="M-829.04,670.545 L-829.04,514.33 L808.959,514.33 L808.959,670.545 L-829.04,670.545 Z " /><path d="M-829.04,-110.244 L-829.04,-266.458 L234.198,-266.458 L234.198,-110.244 L-829.04,-110.244 Z " /><path d="M-829.04,266.458 L-829.04,110.244 L234.198,110.244 L234.198,266.458 L-829.04,266.458 Z " /><path d="M808.959,-195.117 L470.877,-1.03508e-14 L808.959,195.117 L808.959,-195.117 Z " />		</g></symbol>' + '<symbol viewBox="0 0 2048.0 2048.0" id="icon-table"><rect x="0" y="0" width="2048.00" height="2048.00" fill="#ffffff" /><g id="document" transform="matrix(1,0,0,1,1024.0,1024.0)"><path d="M-660.783,660.783 L660.783,660.783 L660.783,-660.783 L-660.783,-660.783 L-660.783,660.783 Z " fill="none" stroke-width="75.82" stroke="#000000" stroke-linecap="square" stroke-linejoin="miter" />			<path d="M-37.9645,698.933 L37.9645,698.933 L37.9645,-698.569 L-37.9645,-698.569 L-37.9645,698.933 Z " fill="#000000" fill-opacity="1.00" stroke-width="0.25" stroke="#000000" stroke-linecap="square" stroke-linejoin="miter" />			<path d="M-698.933,-37.7825 L-698.933,38.1465 L698.569,38.1465 L698.569,-37.7825 L-698.933,-37.7825 Z " fill="#000000" fill-opacity="1.00" stroke-width="0.25" stroke="#000000" stroke-linecap="square" stroke-linejoin="miter" /></g></symbol>' + '<symbol viewBox="0 0 512 512" id="ion-android-happy"><path d="M256 48C140.563 48 48 141.6 48 256s92.563 208 208 208 208-93.6 208-208S370.401 48 256 48zm0 374.4c-91.518 0-166.404-74.883-166.404-166.4 0-91.518 74.887-166.4 166.404-166.4S422.404 164.482 422.404 256 347.518 422.4 256 422.4zm72.8-187.2c17.683 0 31.201-13.518 31.201-31.2s-13.519-31.2-31.201-31.2c-17.682 0-31.2 13.518-31.2 31.2s13.518 31.2 31.2 31.2zm-145.6 0c17.682 0 31.2-13.518 31.2-31.2s-13.519-31.2-31.2-31.2c-17.683 0-31.201 13.518-31.201 31.2s13.519 31.2 31.201 31.2zM256 370.4c48.883 0 89.436-30.164 106.081-72.801H149.919C166.564 340.236 207.117 370.4 256 370.4z"></path></symbol>' + '<symbol viewBox="0 0 512 512" id="ion-android-create"><path d="M64 368v80h80l235.727-235.729-79.999-79.998L64 368zm377.602-217.602c8.531-8.531 8.531-21.334 0-29.865l-50.135-50.135c-8.531-8.531-21.334-8.531-29.865 0l-39.468 39.469 79.999 79.998 39.469-39.467z"></path></symbol>' + '<symbol viewBox="0 0 512 512" id="ion-ios-minus-empty"><path d="M384 265H128v-17h256v17z"></path></symbol>' + '<symbol viewBox="0 0 512 512" id="ion-eye"><path d="M256 128c-81.9 0-145.7 48.8-224 128 67.4 67.7 124 128 224 128 99.9 0 173.4-76.4 224-126.6C428.2 198.6 354.8 128 256 128zm0 219.3c-49.4 0-89.6-41-89.6-91.3 0-50.4 40.2-91.3 89.6-91.3s89.6 41 89.6 91.3c0 50.4-40.2 91.3-89.6 91.3z"></path><path d="M256 224c0-7.9 2.9-15.1 7.6-20.7-2.5-.4-5-.6-7.6-.6-28.8 0-52.3 23.9-52.3 53.3s23.5 53.3 52.3 53.3 52.3-23.9 52.3-53.3c0-2.3-.2-4.6-.4-6.9-5.5 4.3-12.3 6.9-19.8 6.9-17.8 0-32.1-14.3-32.1-32z"></path></symbol>' + '<symbol viewBox="0 0 512 512" id="ion-reply"><path d="M448 400s-36.8-208-224-208v-80L64 256l160 134.4v-92.3c101.6 0 171 8.9 224 101.9z"></path></symbol>' + '<symbol viewBox="0 0 512 512" id="ion-ios-redo"><path d="M64 400h10.3l19.2-31.2c20.5-32.7 44.9-62.8 75.8-76.6 24.4-10.9 46.7-18.9 86.7-20V352l192-128L256 96v80.3c-63 2.8-108.1 20.7-143.3 56.2C60.4 285.2 64 351.5 64 368.2c.1 8.9 0 21.7 0 31.8z"></path></symbol>' + '<symbol viewBox="0 0 512 512" id="ion-wrench"><path d="M461.9 114.9l-56.5 56.7-55.1-10-9.9-55.1 56.5-56.7c-12.7-12.7-30.8-18.5-44.2-17.8-13.5.7-42.3 8.3-64.6 32-21.6 22.8-44.3 65.3-24.2 112.5 2.4 5.7 5.1 13.2-2.9 21.2-8.1 8-215 202.8-215 202.8-19.4 16.7-18 47.6-.1 65.6 18.2 17.9 48.9 19 65.6-.3 0 0 193.2-205.8 202.7-215.1 8.5-8.3 16.1-5.5 21.2-2.9 35.6 18.4 86.3 2.4 112.6-23.9 26.3-26.3 31.1-51.7 31.9-64.7.8-12.9-3.7-30-18-44.3zM91.3 443.2c-6.3 6.2-16.5 6.2-22.7 0-6.2-6.3-6.2-16.5 0-22.7 6.3-6.2 16.5-6.2 22.7 0 6.2 6.3 6.2 16.5 0 22.7z"></path></symbol>' + '<symbol viewBox="0 0 512 512" id="ion-more"><path d="M113.7 304C86.2 304 64 282.6 64 256c0-26.5 22.2-48 49.7-48 27.6 0 49.8 21.5 49.8 48 0 26.6-22.2 48-49.8 48zM256 304c-27.5 0-49.8-21.4-49.8-48 0-26.5 22.3-48 49.8-48 27.5 0 49.7 21.5 49.7 48 0 26.6-22.2 48-49.7 48zM398.2 304c-27.5 0-49.8-21.4-49.8-48 0-26.5 22.2-48 49.8-48 27.5 0 49.8 21.5 49.8 48 0 26.6-22.2 48-49.8 48z"></path></symbol>' + '<symbol viewBox="0 0 512 512" id="ion-code-working"><circle cx="184.166" cy="256.166" r="24"></circle><circle cx="256.166" cy="256.166" r="24"></circle><circle cx="328.166" cy="256.166" r="24"></circle><g><path d="M168 392a23.929 23.929 0 0 1-16.971-7.029l-112-112c-9.373-9.373-9.373-24.569 0-33.941l112-112c9.373-9.372 24.568-9.372 33.941 0 9.371 9.372 9.371 24.568 0 33.941L89.941 256l95.029 95.029c9.371 9.372 9.371 24.568 0 33.941A23.925 23.925 0 0 1 168 392zM344 392a23.929 23.929 0 0 0 16.971-7.029l112-112c9.373-9.373 9.373-24.569 0-33.941l-112-112c-9.373-9.372-24.568-9.372-33.941 0-9.371 9.372-9.371 24.568 0 33.941L422.059 256l-95.029 95.029c-9.371 9.372-9.371 24.568 0 33.941A23.925 23.925 0 0 0 344 392z"></path></g></symbol>' + '<symbol viewBox="0 0 512 512" id="ion-ios-gear"><path d="M416.349 256.046c-.001-21.013 13.143-38.948 31.651-46.062a196.302 196.302 0 0 0-23.664-57.139 49.423 49.423 0 0 1-20.082 4.254c-12.621 0-25.238-4.811-34.871-14.442-14.863-14.863-18.248-36.846-10.18-54.97A196.274 196.274 0 0 0 302.074 64C294.971 82.529 277.027 95.69 256 95.69c-21.025 0-38.969-13.161-46.073-31.69a196.243 196.243 0 0 0-57.128 23.688c8.068 18.122 4.683 40.104-10.181 54.97-9.631 9.631-22.25 14.443-34.871 14.443a49.429 49.429 0 0 1-20.083-4.255A196.273 196.273 0 0 0 64 209.984c18.509 7.112 31.652 25.049 31.652 46.062 0 21.008-13.132 38.936-31.63 46.054a196.318 196.318 0 0 0 23.692 57.128 49.428 49.428 0 0 1 20.032-4.232c12.622 0 25.239 4.812 34.871 14.443 14.841 14.841 18.239 36.781 10.215 54.889a196.257 196.257 0 0 0 57.13 23.673c7.128-18.479 25.046-31.596 46.038-31.596 20.992 0 38.91 13.115 46.037 31.596a196.234 196.234 0 0 0 57.132-23.675c-8.023-18.106-4.626-40.046 10.216-54.887 9.629-9.632 22.248-14.444 34.868-14.444 6.836 0 13.67 1.411 20.033 4.233a196.318 196.318 0 0 0 23.692-57.128c-18.498-7.119-31.629-25.048-31.629-46.054zM256.9 335.9c-44.3 0-80-35.9-80-80 0-44.101 35.7-80 80-80 44.299 0 80 35.899 80 80 0 44.1-35.701 80-80 80z"></path></symbol>' + '<symbol viewBox="0 0 512 512" id="ion-arrow-expand"><path d="M274 209.7l63.9-63.8L288 96h128v128l-49.9-49.9-63.8 63.9zM274 302.3l63.9 63.8L288 416h128V288l-49.9 49.9-63.8-63.9zM238 302.3l-63.9 63.8L224 416H96V288l49.9 49.9 63.8-63.9zM238 209.7l-63.9-63.8L224 96H96v128l49.9-49.9 63.8 63.9z"></path></symbol>' + '<symbol viewBox="0 0 512 512" id="ion-android-expand"><path d="M396.795 396.8H320V448h128V320h-51.205zM396.8 115.205V192H448V64H320v51.205zM115.205 115.2H192V64H64v128h51.205zM115.2 396.795V320H64v128h128v-51.205z"></path></symbol>' + '<symbol viewBox="0 0 512 512" id="ion-arrow-move"><path d="M480 256l-96-96v76H276V128h76l-96-96-96 96h76v108H128v-76l-96 96 96 96v-76h108v108h-76l96 96 96-96h-76.2l-.4-108.5 108.6.3V352z"></path></symbol>' + '<symbol viewBox="0 0 512 512" id="ion-drag"><path d="M0 144h512v32H0zM0 240h512v32H0zM0 336h512v32H0z"></path></symbol>' + '<symbol viewBox="0 0 512 512" id="ion-link"><path d="M74.6 256c0-38.3 31.1-69.4 69.4-69.4h88V144h-88c-61.8 0-112 50.2-112 112s50.2 112 112 112h88v-42.6h-88c-38.3 0-69.4-31.1-69.4-69.4zm85.4 22h192v-44H160v44zm208-134h-88v42.6h88c38.3 0 69.4 31.1 69.4 69.4s-31.1 69.4-69.4 69.4h-88V368h88c61.8 0 112-50.2 112-112s-50.2-112-112-112z"/></symbol>' + '<symbol viewBox="0 0 512 512" id="ion-contrast"><path d="M256 32C132.3 32 32 132.3 32 256s100.3 224 224 224 224-100.3 224-224S379.7 32 256 32zm135.8 359.8C355.5 428 307 448 256 448V64c51 0 99.5 20 135.8 56.2C428 156.5 448 204.7 448 256c0 51.3-20 99.5-56.2 135.8z"></path></symbol>' + '<symbol viewBox="0 0 512 512" id="ion-ios-plus-empty"><path d="M384 265H264v119h-17V265H128v-17h119V128h17v120h120v17z"></path></symbol>' + '<symbol viewBox="0 0 512 512" id="ion-ios-arrow-thin-up"><path d="M349.7 189.8c-3.1 3.1-8 3-11.3 0L264 123.4V408c0 4.4-3.6 8-8 8s-8-3.6-8-8V123.4l-74.4 66.3c-3.4 2.9-8.1 3.2-11.2.1-3.1-3.1-3.3-8.5-.1-11.4 0 0 87-79.2 88-80s2.8-2.4 5.7-2.4 4.9 1.6 5.7 2.4 88 80 88 80c1.5 1.5 2.3 3.6 2.3 5.7s-.8 4.1-2.3 5.7z"></path></symbol>' + '<symbol viewBox="0 0 512 512" id="ion-ios-arrow-thin-down"><path d="M349.7 322.2c-3.1-3.1-8-3-11.3 0L264 388.6V104c0-4.4-3.6-8-8-8s-8 3.6-8 8v284.6l-74.4-66.3c-3.4-2.9-8.1-3.2-11.2-.1-3.1 3.1-3.3 8.5-.1 11.4 0 0 87 79.2 88 80s2.8 2.4 5.7 2.4 4.9-1.6 5.7-2.4 88-80 88-80c1.5-1.5 2.3-3.6 2.3-5.7s-.8-4.1-2.3-5.7z"></path></symbol>' + '<symbol viewBox="0 0 512 512" id="ion-ios-arrow-thin-left"><path d="M189.8 349.7c3.1-3.1 3-8 0-11.3L123.4 264H408c4.4 0 8-3.6 8-8s-3.6-8-8-8H123.4l66.3-74.4c2.9-3.4 3.2-8.1.1-11.2-3.1-3.1-8.5-3.3-11.4-.1 0 0-79.2 87-80 88S96 253.1 96 256s1.6 4.9 2.4 5.7 80 88 80 88c1.5 1.5 3.6 2.3 5.7 2.3s4.1-.8 5.7-2.3z"></path></symbol>' + '<symbol viewBox="0 0 512 512" id="ion-ios-arrow-thin-right"><path d="M322.2 349.7c-3.1-3.1-3-8 0-11.3l66.4-74.4H104c-4.4 0-8-3.6-8-8s3.6-8 8-8h284.6l-66.3-74.4c-2.9-3.4-3.2-8.1-.1-11.2 3.1-3.1 8.5-3.3 11.4-.1 0 0 79.2 87 80 88s2.4 2.8 2.4 5.7-1.6 4.9-2.4 5.7-80 88-80 88c-1.5 1.5-3.6 2.3-5.7 2.3s-4.1-.8-5.7-2.3z"></path></symbol>' + '<symbol viewBox="0 0 512 512" id="ion-ios-close-empty"><path d="M340.2 160l-84.4 84.3-84-83.9-11.8 11.8 84 83.8-84 83.9 11.8 11.7 84-83.8 84.4 84.2 11.8-11.7-84.4-84.3 84.4-84.2z"></path></symbol>' + '<symbol viewBox="0 0 512 512" id="ion-android-more-vertical"><path d="M296 136c0-22.002-17.998-40-40-40s-40 17.998-40 40 17.998 40 40 40 40-17.998 40-40zm0 240c0-22.002-17.998-40-40-40s-40 17.998-40 40 17.998 40 40 40 40-17.998 40-40zm0-120c0-22.002-17.998-40-40-40s-40 17.998-40 40 17.998 40 40 40 40-17.998 40-40z"></path></symbol>' + '<symbol viewBox="0 0 512 512" id="ion-quote"><path d="M192 64c-40.646 0-72.483 11.229-94.627 33.373C75.229 119.517 64 151.354 64 192v256h160V192h-96c0-23.056 4.922-39.666 14.627-49.373C152.334 132.922 168.944 128 192 128M416 64c-40.646 0-72.483 11.229-94.627 33.373C299.229 119.517 288 151.354 288 192v256h160V192h-96c0-23.056 4.922-39.666 14.627-49.373C376.334 132.922 392.944 128 416 128"></path></symbol>' + '<symbol viewBox="0 0 512 512" id="ion-code"><path d="M168 392a23.929 23.929 0 0 1-16.971-7.029l-112-112c-9.373-9.373-9.373-24.569 0-33.941l112-112c9.373-9.372 24.568-9.372 33.941 0 9.371 9.372 9.371 24.568 0 33.941L89.941 256l95.029 95.029c9.371 9.373 9.371 24.568 0 33.941A23.925 23.925 0 0 1 168 392zM344 392a23.929 23.929 0 0 0 16.971-7.029l112-112c9.373-9.373 9.373-24.569 0-33.941l-112-112c-9.373-9.372-24.568-9.372-33.941 0-9.371 9.372-9.371 24.568 0 33.941L422.059 256l-95.029 95.029c-9.371 9.373-9.371 24.568 0 33.941A23.925 23.925 0 0 0 344 392z"></path></symbol>' + '<symbol viewBox="0 0 512 512" id="ion-camera"><path d="M430.4 147h-67.5l-40.4-40.8s-.2-.2-.3-.2l-.2-.2c-6-6-14.1-9.8-23.3-9.8h-84c-9.8 0-18.5 4.2-24.6 10.9v.1l-39.5 40h-69C63 147 48 161.6 48 180.2v202.1c0 18.6 15 33.7 33.6 33.7h348.8c18.5 0 33.6-15.1 33.6-33.7V180.2c0-18.6-15.1-33.2-33.6-33.2zM256 365.5c-50.9 0-92.4-41.6-92.4-92.6 0-51.1 41.5-92.6 92.4-92.6 51 0 92.4 41.5 92.4 92.6 0 51-41.4 92.6-92.4 92.6zm168.1-165c-7.7 0-14-6.3-14-14.1s6.3-14.1 14-14.1 14 6.3 14 14.1-6.3 14.1-14 14.1z"></path><path d="M256 202.9c-38.6 0-69.8 31.3-69.8 70 0 38.6 31.2 70 69.8 70 38.5 0 69.8-31.3 69.8-70s-31.3-70-69.8-70z"></path></symbol>' + '<symbol viewBox="0 0 512 512" id="ion-move"><path d="M475.9 246.2l-79.4-79.4c-5.4-5.4-14.2-5.4-19.6 0l-.2.2c-5.4 5.4-5.4 14.2 0 19.6l54.9 54.9-161.8.5.5-161.8 54.9 54.9c5.4 5.4 14.2 5.4 19.6 0l.2-.2c5.4-5.4 5.4-14.2 0-19.6l-79.4-79.4c-5.4-5.4-14.2-5.4-19.6 0l-79.4 79.4c-5.4 5.4-5.4 14.2 0 19.6l.2.2c5.4 5.4 14.2 5.4 19.6 0l54.9-54.9.5 161.8-161.8-.5 54.9-54.9c5.4-5.4 5.4-14.2 0-19.6l-.2-.2c-5.4-5.4-14.2-5.4-19.6 0l-79.4 79.4c-5.4 5.4-5.4 14.2 0 19.6l79.4 79.4c5.4 5.4 14.2 5.4 19.6 0l.2-.2c5.4-5.4 5.4-14.2 0-19.6L80 270.5l161.8-.5-.5 161.8-54.9-54.9c-5.4-5.4-14.2-5.4-19.6 0l-.2.2c-5.4 5.4-5.4 14.2 0 19.6l79.4 79.4c5.4 5.4 14.2 5.4 19.6 0l79.4-79.4c5.4-5.4 5.4-14.2 0-19.6l-.2-.2c-5.4-5.4-14.2-5.4-19.6 0l-54.9 54.9-.5-161.8 161.8.5-54.9 54.9c-5.4 5.4-5.4 14.2 0 19.6l.2.2c5.4 5.4 14.2 5.4 19.6 0l79.4-79.4c5.5-5.4 5.5-14.2 0-19.6z"/></symbol>' + '<symbol viewBox="0 0 2048.0 2048.0" id="icon-ok"><rect x="0" y="0" width="2048.00" height="2048.00" fill="#ffffff" /><g id="document" transform="matrix(1,0,0,1,1024.0,1024.0)"><path d="M330.323,493.628 L330.323,398.406 L-330.323,398.406 L-330.323,493.628 L330.323,493.628 Z " fill="#011534" fill-opacity="1.00" />			<path d="M230.718,468.568 L328.59,468.568 L328.59,-599.718 L230.718,-599.718 L230.718,468.568 Z " fill="#011534" fill-opacity="1.00" />			<path d="M-300.714,376.053 L-373.748,449.088 L-68.5805,754.255 L4.45387,681.221 L-300.714,376.053 Z " fill="#011534" fill-opacity="1.00" />			<path d="M-9.9476e-14,216.241 L-73.0344,143.207 L-378.202,448.375 L-305.168,521.409 L-9.9476e-14,216.241 Z " fill="#011534" fill-opacity="1.00" /></g></symbol>' + '<symbol viewBox="0 0 512 512" id="ion-grid"><path d="M160 153.3c0 3.7-3 6.7-6.7 6.7h-50.5c-3.7 0-6.7-3-6.7-6.7v-50.5c0-3.7 3-6.7 6.7-6.7h50.5c3.7 0 6.7 3 6.7 6.7v50.5zM288 153.3c0 3.7-3 6.7-6.7 6.7h-50.5c-3.7 0-6.7-3-6.7-6.7v-50.5c0-3.7 3-6.7 6.7-6.7h50.5c3.7 0 6.7 3 6.7 6.7v50.5zM416 153.3c0 3.7-3 6.7-6.7 6.7h-50.5c-3.7 0-6.7-3-6.7-6.7v-50.5c0-3.7 3-6.7 6.7-6.7h50.5c3.7 0 6.7 3 6.7 6.7v50.5z"></path><g><path d="M160 281.3c0 3.7-3 6.7-6.7 6.7h-50.5c-3.7 0-6.7-3-6.7-6.7v-50.5c0-3.7 3-6.7 6.7-6.7h50.5c3.7 0 6.7 3 6.7 6.7v50.5zM288 281.3c0 3.7-3 6.7-6.7 6.7h-50.5c-3.7 0-6.7-3-6.7-6.7v-50.5c0-3.7 3-6.7 6.7-6.7h50.5c3.7 0 6.7 3 6.7 6.7v50.5zM416 281.3c0 3.7-3 6.7-6.7 6.7h-50.5c-3.7 0-6.7-3-6.7-6.7v-50.5c0-3.7 3-6.7 6.7-6.7h50.5c3.7 0 6.7 3 6.7 6.7v50.5z"></path></g><g><path d="M160 409.3c0 3.7-3 6.7-6.7 6.7h-50.5c-3.7 0-6.7-3-6.7-6.7v-50.5c0-3.7 3-6.7 6.7-6.7h50.5c3.7 0 6.7 3 6.7 6.7v50.5zM288 409.3c0 3.7-3 6.7-6.7 6.7h-50.5c-3.7 0-6.7-3-6.7-6.7v-50.5c0-3.7 3-6.7 6.7-6.7h50.5c3.7 0 6.7 3 6.7 6.7v50.5zM416 409.3c0 3.7-3 6.7-6.7 6.7h-50.5c-3.7 0-6.7-3-6.7-6.7v-50.5c0-3.7 3-6.7 6.7-6.7h50.5c3.7 0 6.7 3 6.7 6.7v50.5z"></path></g></symbol>' + '<symbol viewBox="0 0 512 512" id="ion-gear-b"><path d="M448 294.4v-76.8h-42.8c-3.4-14.4-8.9-28-16.1-40.5l29.8-29.7-54.3-54.3-29.1 29.1c-12.6-7.7-26.4-13.5-41.1-17.3V64h-76.8v40.9c-14.7 3.8-28.5 9.7-41.1 17.3l-29.1-29.1-54.3 54.3 29.8 29.7c-7.2 12.5-12.6 26.1-16.1 40.5H64v76.8h44.1c3.8 13.7 9.5 26.6 16.7 38.6l-31.7 31.7 54.3 54.3 32.3-32.3c11.7 6.8 24.5 11.9 37.9 15.4v46h76.8v-46c13.5-3.5 26.2-8.6 37.9-15.4l32.3 32.3 54.3-54.3-31.6-31.7c7.2-11.9 12.9-24.8 16.7-38.6h44zm-192 15.4c-29.7 0-53.7-24.1-53.7-53.8s24-53.8 53.7-53.8 53.8 24.1 53.8 53.8-24.1 53.8-53.8 53.8z"></path></symbol>' + '<symbol viewBox="0 0 512 512" id="ion-ios-grid-view-outline"><path d="M448 192v-16H336V64h-16v112H192V64h-16v112H64v16h112v128H64v16h112v112h16V336h128v112h16V336h112v-16H336V192h112zM320 320H192V192h128v128z"></path></symbol>' + '<symbol viewBox="0 0 2048.0 2048.0" id="icon-increase"><g id="document" transform="matrix(1,0,0,1,1024.0,1024.0)">			<path d="M852.574,595.004 L852.574,507.837 L-852.574,507.837 L-852.574,595.004 L852.574,595.004 Z " />			<path d="M852.574,224.232 L852.574,137.066 L-852.574,137.066 L-852.574,224.232 L852.574,224.232 Z " />			<path d="M852.574,-134.971 L852.574,-222.138 L-852.574,-222.138 L-852.574,-134.971 L852.574,-134.971 Z " />			<path d="M852.574,-505.743 L852.574,-592.909 L-852.574,-592.909 L-852.574,-505.743 L852.574,-505.743 Z " />		</g></symbol>' + '<symbol viewBox="0 0 2048.0 2048.0" id="icon-decrease"><g id="document" transform="matrix(1,0,0,1,1024.0,1024.0)">			<path d="M509.832,595.004 L509.832,507.837 L-509.832,507.837 L-509.832,595.004 L509.832,595.004 Z " />			<path d="M509.832,224.232 L509.832,137.066 L-509.832,137.066 L-509.832,224.232 L509.832,224.232 Z " />			<path d="M509.832,-136.947 L509.832,-224.113 L-509.832,-224.113 L-509.832,-136.947 L509.832,-136.947 Z " />			<path d="M509.832,-505.743 L509.832,-592.909 L-509.832,-592.909 L-509.832,-505.743 L509.832,-505.743 Z " />		</g></symbol>' + '<symbol viewBox="0 0 512 512" id="ion-ios-undo"><path d="M447.9 368.2c0-16.8 3.6-83.1-48.7-135.7-35.2-35.4-80.3-53.4-143.3-56.2V96L64 224l192 128v-79.8c40 1.1 62.4 9.1 86.7 20 30.9 13.8 55.3 44 75.8 76.6l19.2 31.2H448c0-10.1-.1-22.9-.1-31.8z"></path></symbol>' + '<symbol viewBox="0 0 512 512" id="ion-ios-redo"><path d="M64 400h10.3l19.2-31.2c20.5-32.7 44.9-62.8 75.8-76.6 24.4-10.9 46.7-18.9 86.7-20V352l192-128L256 96v80.3c-63 2.8-108.1 20.7-143.3 56.2C60.4 285.2 64 351.5 64 368.2c.1 8.9 0 21.7 0 31.8z"></path></symbol>' + '</defs>' + '</svg>' + '' + '<div id="divRteTool" class="is-tool" style="position:fixed;display:none;">' + '<div class="is-draggable" style="width: 5px;height: 50px;background: #f6f2f2;cursor: move;"></div>' + '<button title="' + out('Previous') + '" class="cell-tool-prev" style="width:35px;"><svg class="is-icon-flex" style="width:13px;height:13px"><use xlink:href="#ion-ios-arrow-left"></use></svg></button>' + '<div class="cell-tool-option-container">' + '<div>' + html_rte + '</div>' + '</div>' + '<button title="' + out('Next') + '" class="cell-tool-next" style="width:35px;"><svg class="is-icon-flex" style="width:13px;height:13px"><use xlink:href="#ion-ios-arrow-right"></use></svg></button>' + '</div>' + '' + '<div id="divCellTool" class="is-tool">' + '<button title="' + out('More') + '" class="cell-tool-menu" style="background:rgba(0,0,0,0.03);font-size:19px;"><svg class="is-icon-flex" style="fill:rgba(0, 0, 0, 0.55);width:18px;height:18px;"><use xlink:href="#ion-android-more-vertical"></use></svg></button>' + '<div class="cell-move-options" style="display:block">' + '<button title="' + out('Move Left') + '" class="cell-prev"><svg class="is-icon-flex" style="fill:rgba(0, 0, 0, 0.7);width:15px;height:15px;"><use xlink:href="#ion-ios-arrow-thin-left"></use></svg></button>' + '<button title="' + out('Move Right') + '" class="cell-next"><svg class="is-icon-flex" style="fill:rgba(0, 0, 0, 0.7);width:15px;height:15px;"><use xlink:href="#ion-ios-arrow-thin-right"></use></svg></button>' + '<button title="' + out('HTML') + '" class="cell-html"><svg class="is-icon-flex" style="margin-right:-3px;fill:rgba(0, 0, 0, 0.65);width:14px;height:14px;"><use xlink:href="#ion-ios-arrow-left"></use></svg><svg class="is-icon-flex" style="margin-left:-2px;fill:rgba(0, 0, 0, 0.65);width:14px;height:14px;"><use xlink:href="#ion-ios-arrow-right"></use></svg></button>' + '<button title="' + out('Delete') + '" class="cell-remove"><svg class="is-icon-flex" style="fill:rgba(0, 0, 0, 0.8);width:23px;height:23px;"><use xlink:href="#ion-ios-close-empty"></use></svg></button>' + '</div>' + '</div>' + '' + '<div id="divCellToolMenu" class="is-tool is-pop" style="box-sizing:border-box;height:auto;overflow:hidden;transition:none;">' + '<button title="' + out('Add') + '" class="cell-add"><svg class="is-icon-flex" style="fill:rgba(0, 0, 0, 0.8);width:21px;height:21px;"><use xlink:href="#ion-ios-plus-empty"></use></svg></button>' + '<button title="' + out('Move Up') + '" class="cell-up"><svg class="is-icon-flex" style="fill:rgba(0, 0, 0, 0.7);width:15px;height:15px;"><use xlink:href="#ion-ios-arrow-thin-up"></use></svg></button>' + '<button title="' + out('Move Down') + '" class="cell-down"><svg class="is-icon-flex" style="fill:rgba(0, 0, 0, 0.7);width:15px;height:15px;"><use xlink:href="#ion-ios-arrow-thin-down"></use></svg></button>' + '<button title="' + out('Duplicate') + '" class="cell-duplicate"><svg class="is-icon-flex" style="width:14px;height:14px;"><use xlink:href="#ion-ios-photos-outline"></use></svg></button>' + '<button title="' + out('Increase') + '" class="cell-increase"><svg class="is-icon-flex"><use xlink:href="#icon-increase"></use></svg></button>' + '<button title="' + out('Decrease') + '" class="cell-decrease"><svg class="is-icon-flex"><use xlink:href="#icon-decrease"></use></svg></button>' + '</div>' + '' + '<div id="divRowAddTool" class="" style="">' + '<button title="' + out('Add') + '" style="outline:none;line-height:1;margin:0;padding:0;cursor:pointer;background-color:#fff;"><svg class="is-icon-flex" style="fill:rgba(0, 0, 0, 0.8);width:17px;height:17px;"><use xlink:href="#ion-ios-plus-empty"></use></svg></button>' + '</div>' + '' + '<div class="cell-add-options arrow-top is-pop">' + '<div class="is-pop-close" style="display:none;z-index:1;width:40px;height:40px;position:absolute;top:0px;right:0px;box-sizing:border-box;padding:0;line-height:40px;font-size: 12px;color:#777;text-align:center;cursor:pointer;"><svg class="is-icon-flex" style="fill:rgba(0, 0, 0, 0.47);width:40px;height:40px;"><use xlink:href="#ion-ios-close-empty"></use></svg></div>' + '<button title="' + out('Paragraph') + '" class="cell-add-paragraph"><span style="display:block;margin:0 0 8px;"><svg class="is-icon-flex" style="fill:rgba(0, 0, 0, 0.8);width:12px;height:12px;"><use xlink:href="#icon-align-full"></use></svg></span>' + out('Paragraph') + '</button>' + '<button title="' + out('Headline') + '" class="cell-add-headline"><span style="font-family:serif;display:block;margin:0 0 8px;">H</span>' + out('Headline') + '</button>' + '<button title="' + out('Image') + '" class="cell-add-image"><span style="display:block;margin:0 0 8px;"><svg class="is-icon-flex ion-image" style="width:14px;height:14px;"><use xlink:href="#ion-image"></use></svg></span>' + out('Image') + '</button>' + '<button title="' + out('Heading 1') + '" class="cell-add-heading1"><span style="font-family:serif;display:block;margin:0 0 8px;">H1</span>' + out('Heading 1') + '</button>' + '<button title="' + out('Heading 2') + '" class="cell-add-heading2"><span style="font-family:serif;display:block;margin:0 0 8px;">H2</span>' + out('Heading 2') + '</button>' + '<button title="' + out('Heading 3') + '" class="cell-add-heading3"><span style="font-family:serif;display:block;margin:0 0 8px;">H3</span>' + out('Heading 3') + '</button>' + '<button title="' + out('List') + '" class="cell-add-list"><span style="display:block;margin:0 0 8px;"><svg class="is-icon-flex" style="fill:rgba(0, 0, 0, 0.8);width:13px;height:13px;"><use xlink:href="#icon-list-bullet"></use></svg></span>List</button>' + '<button title="' + out('Quote') + '" class="cell-add-quote"><span style="display:block;margin:0 0 8px;"><svg class="is-icon-flex" style="fill:rgba(0, 0, 0, 0.7);width:13px;height:13px;"><use xlink:href="#ion-quote"></use></svg></span>' + out('Quote') + '</button>' + '<button title="' + out('Preformatted') + '" class="cell-add-preformatted"><span style="display:block;margin:0 0 8px;"><svg class="is-icon-flex" style="fill:rgba(0, 0, 0, 0.7);width:13px;height:13px;"><use xlink:href="#ion-code"></use></svg></span>' + out('Preformatted') + '</button>' + '<button title="' + out('Table') + '" class="cell-add-table"><span style="display:block;margin:0 0 8px;"><svg class="is-icon-flex" style="fill:rgba(0, 0, 0, 0.7);width:15px;height:15px;"><use xlink:href="#icon-table"></use></svg></use></svg></svg></span>' + out('Table') + '</button>' + '<button title="' + out('Spacer') + '" class="cell-add-spacer"><span style="display:block;margin:0 0 8px;"><span style="display:inline-block;background:#eee;width:30px;height:5px;"></span></span>' + out('Spacer') + '</button>' + '<button title="' + out('Button') + '" class="cell-add-button"><span style="display:block;margin:0 0 8px;"><span style="display:inline-block;border:#a1a1a1 1px solid;background:#f3f3f3;width:15px;height:6px;"></span></span>' + out('Button') + '</button>' + '<button title="' + out('More...') + '" class="cell-add-more classic" style="width:100%;height:45px;margin-top:10px;">' + out('More...') + '</button>' + '</div>' + '' + '<div class="cell-rtemore-options arrow-top right is-pop">' + html_rtemore + '</div>' + '' + '<div class="cell-align-options arrow-top is-pop">' + '<button title="' + out('Align Left') + '" data-align="left"><svg class="is-icon-flex" style="fill:rgba(0, 0, 0, 0.8);width:14px;height:14px;"><use xlink:href="#icon-align-left"></use></svg></button>' + '<button title="' + out('Align Center') + '" data-align="center"><svg class="is-icon-flex" style="fill:rgba(0, 0, 0, 0.8);width:14px;height:14px;"><use xlink:href="#icon-align-center"></use></svg></button>' + '<button title="' + out('Align Right') + '" data-align="right"><svg class="is-icon-flex" style="fill:rgba(0, 0, 0, 0.8);width:14px;height:14px;"><use xlink:href="#icon-align-right"></use></svg></button>' + '<button title="' + out('Align Full') + '" data-align="justify"><svg class="is-icon-flex" style="fill:rgba(0, 0, 0, 0.8);width:14px;height:14px;"><use xlink:href="#icon-align-full"></use></svg></button>' + '</div>' + '' + '<div class="cell-list-options arrow-top is-pop">' + '<button title="' + out('Bullets') + '" data-action="insertUnorderedList"><svg class="is-icon-flex" style="fill:rgba(0, 0, 0, 0.8);"><use xlink:href="#icon-list-bullet"></use></svg></button>' + '<button title="' + out('Numbering') + '" data-action="insertOrderedList"><svg class="is-icon-flex" style="fill:rgba(0, 0, 0, 0.8);"><use xlink:href="#icon-list-number"></use></svg></button>' + '<button title="' + out('Indent') + '" data-action="indent"><svg class="is-icon-flex" style="fill:rgba(0, 0, 0, 0.7);"><use xlink:href="#icon-indent"></use></svg></button>' + '<button title="' + out('Outdent') + '" data-action="outdent"><svg class="is-icon-flex" style="fill:rgba(0, 0, 0, 0.7);"><use xlink:href="#icon-outdent"></use></svg></use></svg></svg></button>' + '</div>' + '' + '<div class="cell-block-options arrow-top is-pop">' + '<div>' + '<div title="' + out('Heading 1') + '" data-block="h1"><h1>Heading 1</h1></div>' + '<div title="' + out('Heading 2') + '" data-block="h2"><h2>Heading 2</h2></div>' + '<div title="' + out('Heading 3') + '" data-block="h3"><h3>Heading 3</h3></div>' + '<div title="' + out('Heading 4') + '" data-block="h4"><h4>Heading 4</h4></div>' + '<div title="' + out('Paragraph') + '" data-block="p"><p>Paragraph</p></div>' + '<div title="' + out('Preformatted') + '" data-block="pre"><p style="font-family:courier;">Preformatted</p></div>' + '</div>' + '</div>' + '' + '<div class="cell-textformat-options arrow-top is-pop">' + '<button title="' + out('Underline') + '" class="cell-format" data-command="underline" style="float:left"><span style="font-family:serif;line-height:50px;font-size:15px;text-decoration:underline;display:inline-block;margin-top:-2px;">U</span></button>' + '<button title="' + out('Strikethrough') + '" class="cell-format" data-command="strikethrough" style="float:left"><span style="font-family:serif;line-height:50px;font-size:19px;text-decoration:line-through;display:inline-block;margin-top:-1px;">S</span></button>' + '<button title="' + out('Superscript') + '" class="cell-format" data-command="superscript" style="float:left"><span style="font-family:serif;line-height:50px;font-size:14px;">x</span style=""><sup style="font-size:10px">2</sup></button>' + '<button title="' + out('Subscript') + '" class="cell-format" data-command="subscript" style="float:left"><span style="font-family:serif;line-height:50px;font-size:14px;">x</span style=""><sub style="font-size:10px">2</sub></button>' + '<button title="' + out('Uppercase') + '" class="cell-format" data-command="uppercase" style="float:left"><span style="font-family:serif;line-height:50px;font-size:16px;display:inline-block;text-transform: none;">Aa</span></button>' + '</div>' + '' + '<div class="cell-textsetting-options arrow-top is-pop">' + '<div style="margin-top:-5px">Font size: </div>' + '<div class="div-font-size">' + '<button title="' + out('Decrease') + '" data-value="-">-</button>' + '<button title="' + out('Increase') + '" data-value="+" style="border-left: none;">+</button>' + '<button title="' + out('Clear') + '" data-value="" style="border-left: none;font-size: 12px;"><svg class="is-icon-flex" style="fill:rgba(0, 0, 0, 0.8);width:20px;height:20px;"><use xlink:href="#ion-ios-close-empty"></use></svg></button>' + '<button title="' + out('Choose..') + '" data-value="more" style="font-size:12px;width:100%;margin-top:10px;height:40px;">' + out('Choose..') + '</button>' + '</div>' + '<div style="margin-top:5px">Line height: </div>' + '<div class="div-line-height">' + '<button title="' + out('Decrease') + '" data-value="-">-</button>' + '<button title="' + out('Increase') + '" data-value="+" style="border-left: none;">+</button>' + '<button title="' + out('Clear') + '" data-value="" style="border-left: none;font-size: 12px;"><svg class="is-icon-flex" style="fill:rgba(0, 0, 0, 0.8);width:20px;height:20px;"><use xlink:href="#ion-ios-close-empty"></use></svg></button>' + '</div>' + '<div style="margin-top:5px">Letter spacing: </div>' + '<div class="div-letter-spacing">' + '<button title="' + out('Decrease') + '" data-value="-">-</button>' + '<button title="' + out('Increase') + '" data-value="+" style="border-left: none;">+</button>' + '<button title="' + out('Clear') + '" data-value="" style="border-left: none;font-size: 12px;"><svg class="is-icon-flex" style="fill:rgba(0, 0, 0, 0.8);width:20px;height:20px;"><use xlink:href="#ion-ios-close-empty"></use></svg></button>' + '</div>' + '</div>' + '' + '<div class="cell-fontfamily-options arrow-top is-pop" style="width:200px;height:200px;">' + '<iframe src="about:blank" style="width:100%;height:100%;border: none;"></iframe>' + '</div>' + '' + '<div class="cell-color-options arrow-top is-pop" data-mode="forecolor">' + '<button title="' + out('Forecolor') + '" data-mode="forecolor" class="input-mode active" style="">' + out('Forecolor') + '</button>' + '<button title="' + out('Backcolor') + '" data-mode="backcolor" class="input-mode" style="">' + out('Backcolor') + '</button>' + '[COLORS]' + '<br style="clear:both">' + '<div class="clearfix" style="width:315px;height:45px;overflow:hidden;position:relative;">' + '<div class="gradient" style="width:630px;height:45px;;position:absolute;top:0;transition: all ease 0.3s;">[GRADIENT]</div>' + '</div>' + '<button data-color="#ffffff" style="background:#ffffff;border:#e7e7e7 1px solid;width:90px"><span style="position:absolute;top:0;left:0;width:100%;height:100%;border:#f8f8f8 1px solid;box-sizing: border-box;line-height:41px;font-size:10px;">White</span></button>' + '<button title="' + out('Clear') + '" data-color="" class="clear classic" style="">' + out('Clear') + '</button>' + '<button title="' + out('More') + '" class="input-more classic" style="font-size:20px;color:#777;"><svg class="is-icon-flex" style="width:13px;height:13px;transform: rotateZ(90deg);"><use xlink:href="#ion-ios-arrow-right"></use></svg></button>' + '<div class="more clearfix" style="display:flex">' + '<button class="is-color-preview" style="width:45px;height:45px;border:1px solid rgba(53, 53, 53, 0.28);border-right:none;box-sizing:border-box;margin-top:8px;"></button>' + '<input class="input-text" type="text" style="width:225px;margin-top:8px;"/>' + '<button title="' + out('Apply') + '" class="input-ok" style="border: 1px solid rgb(199, 199, 199);border-left:none;margin-top:8px;"><svg class="is-icon-flex" style="fill:rgba(0, 0, 0, 0.7);"><use xlink:href="#icon-ok"></use></svg></use></svg></svg></button>' + '</div>' + '</div>' + '' + '<div class="cell-tag-options arrow-top is-pop">' + '<div id="divCustomTags" style="width:100%;"></div>' + '</div>' + '' + '<div id="divSpacerTool" class="is-tool">' + '<button title="' + out('Decrease') + '" data-value="-">-</button>' + '<button title="' + out('Increase') + '" data-value="+" style="border-left: none;">+</button>' + '</div>' + '' + '<div id="divImageTool" class="is-tool" style="background:rgba(0, 0, 0, 0.15);border:transparent 1px solid;">' + '<div class="image-embed" style="width:40px;height:40px;overflow:hidden;">' + '<div style="position:absolute;width:100%;height:100%;"><svg class="is-icon-flex" style="position: absolute;top: 13px;left: 15px;width: 14px;height: 14px;fill:rgb(255,255,255);"><use xlink:href="#ion-image"></use></svg></div>' + '<input title="' + out('Change Image') + '" id="fileEmbedImage" type="file" accept="image/*" style="position:absolute;top:0px;left:0;width:100%;height:40px;opacity: 0;cursor: pointer;"/>' + '</div>' + '<button title="' + out('Link') + '" class="image-link" style="width:40px;height:40px;background:none;color:#fff;"><svg class="is-icon-flex" style="fill:rgba(255, 255, 255, 0.95);width:17px;height:17px;"><use xlink:href="#ion-link"></use></svg></button>' + '<button title="' + out('Edit') + '" class="image-edit" style="width:40px;height:40px;background:none;color:#fff;"><svg class="is-icon-flex" style="fill:rgb(255,255,255);width:14px;height:14px;"><use xlink:href="#ion-android-create"></use></svg></button>' + '</div>' + '<div id="divImageProgress">' + '<div>' + '<div class="dot"></div>' + '<div class="dot"></div>' + '<div class="dot"></div>' + '</div>' + '</div>' + '' + '<div id="divIframeTool" class="is-tool">' + '<button title="' + out('Source') + '" class="iframe-link" style="width:50px;height:50px;"><svg class="is-icon-flex" style="fill:rgba(0, 0, 0, 0.65);width:17px;height:17px;"><use xlink:href="#ion-link"></use></svg></button>' + '</div>' + '' + '<div id="divCustomCodeTool" class="is-tool">' + '<button title="' + out('Settings') + '" style="width:50px;height:50px;"><svg class="is-icon-flex" style="width:18px;height:18px;fill: rgba(0, 0, 0, 0.7);"><use xlink:href="#ion-ios-gear"></use></svg></button>' + '</div>' + '' + '<div id="divCustomModuleTool" class="is-tool">' + '<button title="' + out('Settings') + '" style="width:50px;height:50px;"><svg class="is-icon-flex" style="width:18px;height:18px;fill: rgba(0, 0, 0, 0.7);"><use xlink:href="#ion-ios-gear"></use></svg></button>' + '</div>' + '' + '<div id="divLinkTool" class="is-tool">' + '<button title="' + out('Link') + '" class="link-edit" style="width:37px;height:30px;"><svg class="is-icon-flex" style="fill:rgba(0, 0, 0, 0.65);width:16px;height:16px;"><use xlink:href="#ion-link"></use></svg></button>' + '<button title="' + out('Duplicate') + '" class="link-duplicate" style="width:37px;height:30px;"><svg class="is-icon-flex" style="fill:rgba(0, 0, 0, 0.8);width:12px;height:12px;"><use xlink:href="#ion-ios-photos-outline"></use></svg></button>' + '<button title="' + out('Delete') + '" class="link-remove" style="width:37px;height:30px;"><svg class="is-icon-flex" style="fill:rgba(0, 0, 0, 0.8);width:20px;height:20px;"><use xlink:href="#ion-ios-close-empty"></use></svg></button>' + '</div>' + '' + '<div id="divIconTool" class="is-tool">' + '<button title="' + out('Change Icon') + '" class="icon-type"><svg class="is-icon-flex" style="width:17px;height:17px"><use xlink:href="#ion-android-happy"></use></svg></button>' + '<button title="' + out('Link') + '" class="icon-link"><svg class="is-icon-flex" style="fill:rgba(0, 0, 0, 0.65);width:16px;height:16px;"><use xlink:href="#ion-link"></use></svg></button>' + '<button title="' + out('Add') + '" class="icon-add"><svg class="is-icon-flex" style="fill:rgba(0, 0, 0, 0.8);width:19px;height:19px;"><use xlink:href="#ion-ios-plus-empty"></use></svg></button>' + '<button title="' + out('Delete') + '" class="icon-remove"><svg class="is-icon-flex" style="fill:rgba(0, 0, 0, 0.8);width:20px;height:20px;"><use xlink:href="#ion-ios-close-empty"></use></svg></button>' + '</div>' + '' + '<div id="divTableTool" class="is-tool">' + '<button title="' + out('Edit Table') + '" class="icon-type" style="width:40px;height:40px;"><svg class="is-icon-flex" style="margin-top: 3px;fill:rgba(0, 0, 0, 0.8)"><use xlink:href="#ion-android-create"></use></svg></button>' + '</div>' + '' + '<div id="divElementTool" class="is-tool">' + '<button title="' + out('Add') + '" class="element-add" style="width:35px;height:25px;"><svg class="is-icon-flex" style="fill:rgba(0, 0, 0, 0.8);width:16px;height:16px;"><use xlink:href="#ion-ios-plus-empty"></use></svg></button>' + '<button title="' + out('Duplicate') + '" class="element-duplicate" style="width:35px;height:25px;"><svg class="is-icon-flex" style="width:10px;height:10px;"><use xlink:href="#ion-ios-photos-outline"></use></svg></button>' + '<button title="' + out('Move Up') + '" class="element-up" style="width:35px;height:25px;font-size: 11px;"><svg class="is-icon-flex" style="fill:rgba(0, 0, 0, 0.9);width:12px;height:12px;"><use xlink:href="#ion-ios-arrow-thin-up"></use></svg></button>' + '<button title="' + out('Move Down') + '" class="element-down" style="width:35px;height:25px;font-size: 11px;"><svg class="is-icon-flex" style="fill:rgba(0, 0, 0, 0.9);width:12px;height:12px;"><use xlink:href="#ion-ios-arrow-thin-down"></use></svg></button>' + (plugin.settings.elementEditor ? '<button title="' + out('Settings') + '" class="element-edit" style="width:35px;height:25px;font-size: 11px;"><svg class="is-icon-flex" style="width:11px;height:11px;fill: rgba(0, 0, 0, 0.6);"><use xlink:href="#ion-ios-gear"></use></svg></button>' : '') + '<button title="' + out('Delete') + '" class="element-remove" style="width:35px;height:25px;font-size: 11px;"><svg class="is-icon-flex" style="fill:rgba(0, 0, 0, 0.8);width:19px;height:19px;"><use xlink:href="#ion-ios-close-empty"></use></svg></button>' + '</div>' + '' + '<div class="is-modal createlink">' + '<div style="max-width:526px;">' + '<div class="link-src">' + '<input class="input-url" type="text" placeholder="Url"/>' + '<button title="' + out('Select') + '" class="input-select"><svg class="is-icon-flex"><use xlink:href="#ion-more"></use></svg></button>' + '</div>' + '<label style="display:inline-block;margin-top:14px;margin-bottom:10px;float:left;">' + '<input class="input-newwindow" type="checkbox" /> ' + out('Open New Window') + '&nbsp;' + '</label>' + '<input class="input-text" type="text" placeholder="' + out('Text') + '" style="width:100%;"/>' + '<input class="input-title" type="text" placeholder="' + out('Title') + '" style="width:100%;border-top: none;margin-bottom:12px;"/>' + '<div style="text-align:right">' + '<button title="' + out('Cancel') + '" class="input-cancel classic-secondary">' + out('Cancel') + '</button>' + '<button title="' + out('Ok') + '" class="input-ok classic-primary">' + out('Ok') + '</button>' + '</div>' + '</div>' + '</div>' + '' + '<div class="is-modal imageedit">' + '<div style="max-width:526px;padding-top:7px;display:flex;flex-direction:column;align-items:center;">' + '<div class="imageedit-crop" style="display:flex;height:80px;align-items:center;align-self:flex-start;">' + '<button title="5x5" data-crop-size="1" style="width: 60px;height: 60px;">5x5</button>' + '<button title="4x3" data-crop-size="1.33333" style="width: 60px;height: 45px;">4x3</button>' + '<button title="3x4" data-crop-size="0.75" style="width: 45px;height: 60px;">3x4</button>' + '<button title="6x4" data-crop-size="1.5" style="width: 60px;height: 40px;">6x4</button>' + '<button title="4x6" data-crop-size="0.6666" style="width: 40px;height: 60px;">4x6</button>' + '<button title="' + out('Free') + '" data-crop-size="" style="width: 60px;height: 45px;">' + out('Free') + '</button>' + '</div>' + '<div class="imageedit-preview" style="min-width:200px;">' + '</div>' + '<div style="margin-top:7px;text-align:right;align-self:flex-end;">' + '<button title="' + out('Cancel') + '" class="input-cancel classic-secondary">' + out('Cancel') + '</button>' + '<button title="' + out('Apply') + '" class="input-ok classic-primary">' + out('Apply') + '</button>' + '</div>' + '</div>' + '</div>' + '' + '<div class="is-modal imagelink">' + '<div style="max-width:526px;">' + '<div class="image-src">' + '<input class="input-src" type="text" placeholder="' + out('Source') + '"/>' + '<button title="' + out('Select') + '" class="input-select"><svg class="is-icon-flex"><use xlink:href="#ion-more"></use></svg></button>' + '</div>' + '<input class="input-title" type="text" placeholder="Title" style="width:100%;border-top: none;"/>' + '<div style="position:relative">' + '<input class="input-link" type="text" placeholder="' + out('Link') + '" style="width:100%;border-top: none;"/>' + '<div style="position:absolute;top:0;right:0;width:50px;height:50px;">' + '<form id="form-upload-larger" target="frame-upload-larger" method="post" action="' + this.settings.largerImageHandler + '" enctype="multipart/form-data" style="position:absolute;top:0;left:0;width:100%;height:100%;">' + '<input id="hidRefId" name="hidRefId" type="hidden" value="" />' + '<iframe id="frame-upload-larger" name="frame-upload-larger" src="about:blank" style="width:1px;height:1px;position:absolute;top:0;right:-100000px"></iframe>' + '<svg class="is-icon-flex" style="position: absolute;top: 16px;left: 15px;width: 18px;height: 18px;fill:rgb(53, 53, 53);"><use xlink:href="#ion-image"></use></svg>' + '<input title="' + out('Select') + '" id="fileImage" name="fileImage" type="file" accept="image/*" style="position:absolute;top:-30px;left:0;width:100%;height:80px;opacity: 0;cursor: pointer;">' + '</form>' + '</div>' + '</div>' + '<label style="display:inline-block;margin-top:14px;margin-bottom:10px;">' + '<input class="input-newwindow" type="checkbox" /> ' + out('Open New Window') + '&nbsp;' + '</label>' + '<div style="text-align:right">' + '<button title="' + out('Cancel') + '" class="input-cancel classic-secondary">' + out('Cancel') + '</button>' + '<button title="' + out('Ok') + '" class="input-ok classic-primary">' + out('Ok') + '</button>' + '</div>' + '</div>' + '</div>' + '' + '<div class="is-modal edittable">' + '<div style="max-width:252px;padding:0;box-sizing:border-box;position:relative;">' + '<div class="is-modal-bar is-draggable">' + out('Table') + '</div>' + '<div class="is-tabs clearfix" data-group="table">' + '<a title="' + out('Style') + '" id="tabTableGeneral" href="" data-content="divTableGeneral" class="active">' + out('Style') + '</a>' + '<a title="' + out('Layout') + '" id="tabTableLayout" href="" data-content="divTableLayout">' + out('Layout') + '</a>' + '</div>' + '<div id="divTableGeneral" class="is-tab-content" data-group="table" style="display:block">' + '<div class="is-settings clearfix" style="display:inline-block;width:115px;float:left;margin-bottom:0;">' + '<div>' + out('Background') + ':</div>' + '<div>' + '<input type="hidden" id="inpCellBgColor" value=""/>' + '<button title="' + out('Select Color') + '" class="input-table-bgcolor"><svg class="is-icon-flex" style="fill:rgba(0, 0, 0, 0.8);width:12px;height:12px;"><use xlink:href="#ion-contrast"></use></svg></button>' + '</div>' + '</div>' + '<div class="is-settings clearfix" style="display:inline-block;width:90px;margin-bottom:0;">' + '<div>' + out('Text Color') + ':</div>' + '<div>' + '<input type="hidden" id="inpCellTextColor" value=""/>' + '<button title="' + out('Select Color') + '" class="input-table-textcolor"><svg class="is-icon-flex" style="fill:rgba(0, 0, 0, 0.8);width:12px;height:12px;"><use xlink:href="#ion-contrast"></use></svg></button>' + '</div>' + '</div>' + '<div class="is-settings clearfix" style="margin-bottom:0;">' + '<div>' + out('Border Thickness') + ':</div>' + '<div>' + '<select id="selCellBorderWidth" style="width:120px;"><option value="0">No Border</option><option value="1">1</option><option value="2">2</option><option value="3">3</option></select>' + '</div>' + '</div>' + '<div class="is-settings clearfix" style="margin-bottom:0;">' + '<div>' + out('Border Color') + ':</div>' + '<div>' + '<input type="hidden" id="inpCellBorderColor" value=""/>' + '<button title="' + out('Select Color') + '" class="input-table-bordercolor"><svg class="is-icon-flex" style="fill:rgba(0, 0, 0, 0.8);width:12px;height:12px;"><use xlink:href="#ion-contrast"></use></svg></button>' + '</div>' + '</div>' + '<div class="is-settings clearfix" style="margin-bottom:0;">' + '<div>' + out('Apply To') + ':</div>' + '<div>' + '<select id="selTableApplyTo" style="width:120px;">' + '<option value="table">' + out('Table') + '</option>' + '<option value="currentrow">' + out('Current Row') + '</option>' + '<option value="currentcol">' + out('Current Column') + '</option>' + '<option value="evenrows">' + out('Even Rows') + '</option>' + '<option value="oddrows">' + out('Odd Rows') + '</option>' + '<option value="currentcell">' + out('Current Cell') + '</option>' + '</select>' + '</div>' + '</div>' + '</div>' + '<div id="divTableLayout" class="is-tab-content" data-group="table">' + '<div class="is-settings clearfix" style="margin-bottom:0;">' + '<div>' + out('Insert Row') + ':</div>' + '<div>' + '<button title="' + out('Above') + '" data-table-cmd="rowabove" title="Insert Row (Above)" style="width:100px;margin-right:5px"> ' + out('Above') + ' </button>' + '<button title="' + out('Below') + '" data-table-cmd="rowbelow" title="Insert Row (Below)" style="width:100px;"> ' + out('Below') + ' </button>' + '</div>' + '</div>' + '<div class="is-settings clearfix" style="margin-bottom:0;">' + '<div>Insert Column:</div>' + '<div>' + '<button title="' + out('Left') + '" data-table-cmd="columnleft" title="Insert Column (Left)" style="width:100px;margin-right:5px"> ' + out('Left') + ' </button>' + '<button title="' + out('Right') + '" data-table-cmd="columnright" title="Insert Column (Right)" style="width:100px;"> ' + out('Right') + ' </button>' + '</div>' + '</div>' + '<div class="is-settings clearfix" style="margin-bottom:0;">' + '<div>Delete:</div>' + '<div>' + '<button title="' + out('Row') + '" data-table-cmd="delrow" title="Delete Row" style="width:100px;margin-right:5px"> ' + out('Row') + ' </button>' + '<button title="' + out('Column') + '" data-table-cmd="delcolumn" title="Delete Column" style="width:100px;"> ' + out('Column') + ' </button>' + '</div>' + '</div>' + '<div class="is-settings clearfix" style="margin-bottom:0;">' + '<div>' + out('Merge') + ':</div>' + '<button title="' + out('Merge Cell') + '" data-table-cmd="mergecell" title="Merge Cell" style="width:205px"> Merge Cell </button>' + '</div>' + '</div>' + '</div>' + '</div>' + '</div>' + '' + (bSideSnippets == true ? '' + '<div id="divSnippetList" class="is-modal is-side' + (this.settings.sidePanel == 'right' ? '' : ' fromleft') + ' snippetlist" style="width:315px">' + '</div>' : '') + '' + '<div class="is-modal is-side' + (this.settings.sidePanel == 'right' ? '' : ' fromleft') + ' elementstyles">' + '<div class="elm-list" style="z-index:1;width:100%;height:100px;position:absolute;top:0px;left:0px;box-sizing:border-box;display:flex;align-items:center;flex-wrap: wrap;padding:10px 23px 10px 18px;border-bottom:#e8e8e8 1px solid;"></div>' + '' + '<div class="is-side-close" style="z-index:1;width:40px;height:40px;position:absolute;top:0px;right:0px;box-sizing:border-box;padding:0;line-height:40px;font-size: 12px;color:#777;text-align:center;cursor:pointer;"><svg class="is-icon-flex" style="fill:rgba(0, 0, 0, 0.47);width:40px;height:40px;"><use xlink:href="#ion-ios-close-empty"></use></svg></div>' + '' + '<div style="position: absolute;bottom:7px;right:7px;width:40px;height:25px;z-index:1;display:flex">' + '<button title="' + out('css') + '" class="elm-editstyle" style="width: 40px;height: 25px;font-family: sans-serif;font-size: 10px;padding: 0px;font-weight: bold;">css</button>' + '</div>' + '' + '<div id="divEditStyle" style="background:#fff;width:320px;height:434px;margin:0px;position:absolute;top:30px;left:-350px;z-index:1;border:1px solid rgb(199, 199, 199);">' + '<div class="is-modal-bar is-draggable" style="height:12px;"></div>' + '<div style="padding:12px">' + '<div class="is-settings clearfix" style="display:inline-block;width:100%;margin-bottom:0;">' + '<div>' + out('Style') + ':</div>' + '<div>' + '<textarea id="inpElmInlineStyle" style="width:100%;height:256px;margin:0px;border:none;background:#f3f3f3;"></textarea>' + '</div>' + '</div>' + '<div class="is-settings clearfix" style="display:inline-block;width:100%;margin-bottom:0;">' + '<div>' + out('Class') + ':</div>' + '<div>' + '<input type="text" id="inpElmClassName" value="" style="width:100%;padding-left: 16px;font-family: courier;font-size: 17px;line-height: 2;letter-spacing: 1px;border:none;background:#f3f3f3;"/>' + '</div>' + '</div>' + '</div>' + '</div>' + '' + '<div style="width:100%;height:100%;overflow-y:auto;overflow-x:hidden;position:absolute;top:0px;left:0px;box-sizing:border-box;border-top:100px solid transparent;padding:0px;">' + '' + '<div class="is-tabs clearfix" data-group="element" style="padding-right:0;padding-bottom:0;">' + '<a title="' + out('Box') + '" id="tabElementBox" href="" data-content="divElementBox" class="active">' + out('Box') + '</a>' + '<a title="' + out('Spacing') + '" id="tabElementSpacing" href="" data-content="divElementSpacing">' + out('Spacing') + '</a>' + '<a title="' + out('Border') + '" id="tabElementBorder" href="" data-content="divElementBorder">' + out('Border') + '</a>' + '<a title="' + out('Text') + '" id="tabElementType" href="" data-content="divElementType">' + out('Text') + '</a>' + '<a title="' + out('More') + '" id="tabElementMore" href=""><svg class="is-icon-flex" style="width:15px;height:15px;"><use xlink:href="#ion-more"></use></svg></a>' + '</div>' + '' + '<div id="divElementMore" style="top:50px;left:200px;" class="is-tabs-more" data-group="element">' + '<a title="' + out('Corners') + '" id="tabElementCorners" href="" data-content="divElementCorners">' + out('Corners') + '</a>' + '<a title="' + out('Shadow') + '" id="tabElementShadow" href="" data-content="divElementShadow">' + out('Shadow') + '</a>' + '<a title="' + out('Display') + '" id="tabElementDisplay" href="" data-content="divElementDisplay">' + out('Display') + '</a>' + '<a title="' + out('Position') + '" id="tabElementPosition" href="" data-content="divElementPosition">' + out('Position') + '</a>' + '<a title="' + out('Effects') + '" id="tabElementEffects" href="" data-content="divElementEffects">' + out('Effects') + '</a>' + '<a title="' + out('Attributes') + '" id="tabElementAttributes" href="" data-content="divElementAttributes">' + out('Attributes') + '</a>' + (this.settings.elementAnimate == true ? '<a title="' + out('Animation') + '" id="tabElementAnimation" href="" data-content="divElementAnimation">' + out('Animation') + '</a>' : '') + '</div>' + '' + '<div id="divElementBox" class="is-tab-content" data-group="element" style="display:block">' + '' + '<div class="is-settings clearfix" style="display:inline-block;width:100%;margin-bottom:0;">' + '<div>' + out('Background Color') + ':</div>' + '<div>' + '<div class="input-elm-bgcolor" style="margin-top:10px;height:50px;"></div>' + '<button title="' + out('Gradient') + '" class="input-elm-gradient" data-value="+" style="width:135px;font-size: 14px;margin-top:10px;"> ' + out('Gradient') + ' </button>' + '</div>' + '</div>' + '' + '<div style="margin-top: 25px;font-weight: bold;line-height: 1.7;">' + out('Dimension') + '</div>' + '' + '<div class="is-settings clearfix" style="display:inline-block;width:145px;float:left;margin-bottom:0;">' + '<div>Width:</div>' + '<div style="display:flex">' + '<input type="text" id="inpElmWidth" value="" style="width:80px"/>' + '<select id="inpElmWidthUnit" style="height:50px;border-radius:0;">' + '<option value="px">px</option>' + '<option value="em">em</option>' + '<option value="vw">vw</option>' + '<option value="vh">vh</option>' + '<option value="%">%</option>' + '</select>' + '</div>' + '</div>' + '<div class="is-settings clearfix" style="display:inline-block;width:145px;margin-bottom:0;">' + '<div>Height:</div>' + '<div style="display:flex">' + '<input type="text" id="inpElmHeight" value="" style="width:80px"/>' + '<select id="inpElmHeightUnit" style="height:50px;border-radius:0;">' + '<option value="px">px</option>' + '<option value="em">em</option>' + '<option value="vw">vw</option>' + '<option value="vh">vh</option>' + '<option value="%">%</option>' + '</select>' + '</div>' + '</div>' + '<div class="is-settings clearfix" style="display:inline-block;width:145px;float:left;margin-bottom:0;">' + '<div>Max Width:</div>' + '<div style="display:flex">' + '<input type="text" id="inpElmMaxWidth" value="" style="width:80px"/>' + '<select id="inpElmMaxWidthUnit" style="height:50px;border-radius:0;">' + '<option value="px">px</option>' + '<option value="em">em</option>' + '<option value="vw">vw</option>' + '<option value="vh">vh</option>' + '<option value="%">%</option>' + '</select>' + '</div>' + '</div>' + '<div class="is-settings clearfix" style="display:inline-block;width:145px;margin-bottom:0;">' + '<div>Max Height:</div>' + '<div style="display:flex">' + '<input type="text" id="inpElmMaxHeight" value="" style="width:80px"/>' + '<select id="inpElmMaxHeightUnit" style="height:50px;border-radius:0;">' + '<option value="px">px</option>' + '<option value="em">em</option>' + '<option value="vw">vw</option>' + '<option value="vh">vh</option>' + '<option value="%">%</option>' + '</select>' + '</div>' + '</div>' + '<div class="is-settings clearfix" style="display:inline-block;width:145px;float:left;margin-bottom:0;">' + '<div>Min Width:</div>' + '<div style="display:flex">' + '<input type="text" id="inpElmMinWidth" value="" style="width:80px"/>' + '<select id="inpElmMinWidthUnit" style="height:50px;border-radius:0;">' + '<option value="px">px</option>' + '<option value="em">em</option>' + '<option value="vw">vw</option>' + '<option value="vh">vh</option>' + '<option value="%">%</option>' + '</select>' + '</div>' + '</div>' + '<div class="is-settings clearfix" style="display:inline-block;width:145px;margin-bottom:0;">' + '<div>Min Height:</div>' + '<div style="display:flex">' + '<input type="text" id="inpElmMinHeight" value="" style="width:80px"/>' + '<select id="inpElmMinHeightUnit" style="height:50px;border-radius:0;">' + '<option value="px">px</option>' + '<option value="em">em</option>' + '<option value="vw">vw</option>' + '<option value="vh">vh</option>' + '<option value="%">%</option>' + '</select>' + '</div>' + '</div>' + '' + '<div class="is-settings clearfix" style="display:inline-block;width:145px;float:left;margin-bottom:0;">' + '<div>Overflow x:</div>' + '<div>' + '<select id="inpElmOverflowX" style="height:50px;border-radius:0;">' + '<option value=""></option>' + '<option value="auto">Auto</option>' + '<option value="hidden">Hidden</option>' + '</select>' + '</div>' + '</div>' + '<div class="is-settings clearfix" style="display:inline-block;width:145px;margin-bottom:0;">' + '<div>Overflow y:</div>' + '<div>' + '<select id="inpElmOverflowY" style="height:50px;border-radius:0;">' + '<option value=""></option>' + '<option value="auto">Auto</option>' + '<option value="hidden">Hidden</option>' + '</select>' + '</div>' + '</div>' + '' + '</div>' + '' + '<div id="divElementSpacing" class="is-tab-content" data-group="element">' + '' + '<div style="margin-top: 13px;font-weight: bold;line-height: 1.7;">Padding</div>' + '' + '<div class="is-settings clearfix" style="display:inline-block;width:140px;float:left;margin-bottom:0;">' + '<div>Top:</div>' + '<div style="display:flex;width:145px;float:left;">' + '<input type="text" id="inpElmPaddingTop" value="" style="width:80px"/>' + '<select id="inpElmPaddingTopUnit" style="height:50px;border-radius:0;">' + '<option value="px">px</option>' + '<option value="em">em</option>' + '<option value="vw">vw</option>' + '<option value="vh">vh</option>' + '<option value="%">%</option>' + '</select>' + '</div>' + '</div>' + '<div class="is-settings clearfix" style="display:inline-block;width:140px;margin-bottom:0;">' + '<div>Bottom:</div>' + '<div style="display:flex;width:145px;float:left;">' + '<input type="text" id="inpElmPaddingBottom" value="" style="width:80px"/>' + '<select id="inpElmPaddingBottomUnit" style="height:50px;border-radius:0;">' + '<option value="px">px</option>' + '<option value="em">em</option>' + '<option value="vw">vw</option>' + '<option value="vh">vh</option>' + '<option value="%">%</option>' + '</select>' + '</div>' + '</div>' + '<div class="is-settings clearfix" style="display:inline-block;width:140px;float:left;margin-bottom:0;">' + '<div>Left:</div>' + '<div style="display:flex;width:145px;float:left;">' + '<input type="text" id="inpElmPaddingLeft" value="" style="width:80px"/>' + '<select id="inpElmPaddingLeftUnit" style="height:50px;border-radius:0;">' + '<option value="px">px</option>' + '<option value="em">em</option>' + '<option value="vw">vw</option>' + '<option value="vh">vh</option>' + '<option value="%">%</option>' + '</select>' + '</div>' + '</div>' + '<div class="is-settings clearfix" style="display:inline-block;width:140px;margin-bottom:0;">' + '<div>Right:</div>' + '<div style="display:flex;width:145px;float:left;">' + '<input type="text" id="inpElmPaddingRight" value="" style="width:80px"/>' + '<select id="inpElmPaddingRightUnit" style="height:50px;border-radius:0;">' + '<option value="px">px</option>' + '<option value="em">em</option>' + '<option value="vw">vw</option>' + '<option value="vh">vh</option>' + '<option value="%">%</option>' + '</select>' + '</div>' + '</div>' + '' + '<div style="margin-top: 25px;font-weight: bold;line-height: 1.7;">Margin</div>' + '' + '<div class="is-settings clearfix" style="display:inline-block;width:140px;float:left;margin-bottom:0;">' + '<div>Top:</div>' + '<div style="display:flex;width:145px;float:left;">' + '<input type="text" id="inpElmMarginTop" value="" style="width:65px"/>' + '<select id="inpElmMarginTopUnit" style="width:65px;height:50px;border-radius:0;">' + '<option value="px">px</option>' + '<option value="em">em</option>' + '<option value="vw">vw</option>' + '<option value="vh">vh</option>' + '<option value="%">%</option>' + '<option value="auto">auto</option>' + '</select>' + '</div>' + '</div>' + '<div class="is-settings clearfix" style="display:inline-block;width:140px;margin-bottom:0;">' + '<div>Bottom:</div>' + '<div style="display:flex;width:145px;float:left;">' + '<input type="text" id="inpElmMarginBottom" value="" style="width:65px"/>' + '<select id="inpElmMarginBottomUnit" style="width:65px;height:50px;border-radius:0;">' + '<option value="px">px</option>' + '<option value="em">em</option>' + '<option value="vw">vw</option>' + '<option value="vh">vh</option>' + '<option value="%">%</option>' + '<option value="auto">auto</option>' + '</select>' + '</div>' + '</div>' + '<div class="is-settings clearfix" style="display:inline-block;width:140px;float:left;margin-bottom:0;">' + '<div>Left:</div>' + '<div style="display:flex;width:145px;float:left;">' + '<input type="text" id="inpElmMarginLeft" value="" style="width:65px"/>' + '<select id="inpElmMarginLeftUnit" style="width:65px;height:50px;border-radius:0;">' + '<option value="px">px</option>' + '<option value="em">em</option>' + '<option value="vw">vw</option>' + '<option value="vh">vh</option>' + '<option value="%">%</option>' + '<option value="auto">auto</option>' + '</select>' + '</div>' + '</div>' + '<div class="is-settings clearfix" style="display:inline-block;width:140px;margin-bottom:0;">' + '<div>Right:</div>' + '<div style="display:flex;width:145px;float:left;">' + '<input type="text" id="inpElmMarginRight" value="" style="width:65px"/>' + '<select id="inpElmMarginRightUnit" style="width:65px;height:50px;border-radius:0;">' + '<option value="px">px</option>' + '<option value="em">em</option>' + '<option value="vw">vw</option>' + '<option value="vh">vh</option>' + '<option value="%">%</option>' + '<option value="auto">auto</option>' + '</select>' + '</div>' + '</div>' + '' + '<div style="margin-top: 25px;font-weight: bold;line-height: 1.7;">' + out('Responsive Positioning') + ':</div>' + '' + '<div class="is-settings clearfix" style="display:inline-block;width:100%;margin-bottom:0;">' + '<div style="margin-top:15px">' + '<label for="chkResetMarginLeft"><input type="checkbox" id="chkResetMarginLeft" value="" /> ' + out('Reset margin left on small screen') + '</label>' + '</div>' + '</div>' + '<div class="is-settings clearfix" style="display:inline-block;width:100%;margin-bottom:0;">' + '<div style="margin-top:0px">' + '<label for="chkResetMarginRight"><input type="checkbox" id="chkResetMarginRight" value="" /> ' + out('Reset margin right on small screen') + '</label>' + '</div>' + '</div>' + '' + '</div>' + '' + '<div id="divElementBorder" class="is-tab-content" data-group="element">' + '' + '<div style="margin-top: 13px;font-weight: bold;line-height: 1.7;">Border</div>' + '' + '<div class="is-settings clearfix" style="display:inline-block;width:100%;margin-bottom:0;">' + '<div></div>' + '<div style="display:flex;width:125px;float:left;">' + '<input type="text" id="inpElmBorderWidth" value="" style="width:50px"/>' + '<select id="inpElmBorderWidthUnit" style="height:50px;border-radius:0;">' + '<option value="px">px</option>' + '<option value="em">em</option>' + '<option value="vw">vw</option>' + '<option value="vh">vh</option>' + '<option value="none">none</option>' + '</select>' + '</div>' + '<div style="width:90px;float:left;">' + '<select id="inpElmBorderStyle" style="width:80px;height:50px;border-radius:0;">' + '<option value=""></option>' + '<option value="solid">Solid</option>' + '<option value="dashed">Dashed</option>' + '<option value="dotted">Dotted</option>' + '</select>' + '</div>' + '<div style="width:105px;float:left;">' + '<div class="input-elm-bordercolor" style="height:50px;"></div>' + '</div>' + '</div>' + '' + '<div style="margin-top: 25px;font-weight: bold;line-height: 1.7;">' + out('Individual Sides') + '</div>' + '' + '<div class="is-settings clearfix" style="display:inline-block;width:100%;margin-bottom:0;">' + '<div>Border Top:</div>' + '<div style="display:flex;width:125px;float:left;">' + '<input type="text" id="inpElmBorderTopWidth" value="" style="width:50px"/>' + '<select id="inpElmBorderTopWidthUnit" style="height:50px;border-radius:0;">' + '<option value="px">px</option>' + '<option value="em">em</option>' + '<option value="vw">vw</option>' + '<option value="vh">vh</option>' + '<option value="none">none</option>' + '</select>' + '</div>' + '<div style="width:90px;float:left;">' + '<select id="inpElmBorderTopStyle" style="width:80px;height:50px;border-radius:0;">' + '<option value=""></option>' + '<option value="solid">Solid</option>' + '<option value="dashed">Dashed</option>' + '<option value="dotted">Dotted</option>' + '</select>' + '</div>' + '<div style="width:105px;float:left;">' + '<div class="input-elm-bordertopcolor" style="height:50px;"></div>' + '</div>' + '</div>' + '' + '<div class="is-settings clearfix" style="display:inline-block;width:100%;margin-bottom:0;">' + '<div>Border Bottom:</div>' + '<div style="display:flex;width:125px;float:left;">' + '<input type="text" id="inpElmBorderBottomWidth" value="" style="width:50px"/>' + '<select id="inpElmBorderBottomWidthUnit" style="height:50px;border-radius:0;">' + '<option value="px">px</option>' + '<option value="em">em</option>' + '<option value="vw">vw</option>' + '<option value="vh">vh</option>' + '<option value="none">none</option>' + '</select>' + '</div>' + '<div style="width:90px;float:left;">' + '<select id="inpElmBorderBottomStyle" style="width:80px;height:50px;border-radius:0;">' + '<option value=""></option>' + '<option value="solid">Solid</option>' + '<option value="dashed">Dashed</option>' + '<option value="dotted">Dotted</option>' + '</select>' + '</div>' + '<div style="width:105px;float:left;">' + '<div class="input-elm-borderbottomcolor" style="height:50px;"></div>' + '</div>' + '</div>' + '' + '<div class="is-settings clearfix" style="display:inline-block;width:100%;margin-bottom:0;">' + '<div>Border Left:</div>' + '<div style="display:flex;width:125px;float:left;">' + '<input type="text" id="inpElmBorderLeftWidth" value="" style="width:50px"/>' + '<select id="inpElmBorderLeftWidthUnit" style="height:50px;border-radius:0;">' + '<option value="px">px</option>' + '<option value="em">em</option>' + '<option value="vw">vw</option>' + '<option value="vh">vh</option>' + '<option value="none">none</option>' + '</select>' + '</div>' + '<div style="width:90px;float:left;">' + '<select id="inpElmBorderLeftStyle" style="width:80px;height:50px;border-radius:0;">' + '<option value=""></option>' + '<option value="solid">Solid</option>' + '<option value="dashed">Dashed</option>' + '<option value="dotted">Dotted</option>' + '</select>' + '</div>' + '<div style="width:105px;float:left;">' + '<div class="input-elm-borderleftcolor" style="height:50px;"></div>' + '</div>' + '</div>' + '' + '<div class="is-settings clearfix" style="display:inline-block;width:100%;margin-bottom:0;">' + '<div>Border Right:</div>' + '<div style="display:flex;width:125px;float:left;">' + '<input type="text" id="inpElmBorderRightWidth" value="" style="width:50px"/>' + '<select id="inpElmBorderRightWidthUnit" style="height:50px;border-radius:0;">' + '<option value="px">px</option>' + '<option value="em">em</option>' + '<option value="vw">vw</option>' + '<option value="vh">vh</option>' + '<option value="none">none</option>' + '</select>' + '</div>' + '<div style="width:90px;float:left;">' + '<select id="inpElmBorderRightStyle" style="width:80px;height:50px;border-radius:0;">' + '<option value=""></option>' + '<option value="solid">Solid</option>' + '<option value="dashed">Dashed</option>' + '<option value="dotted">Dotted</option>' + '</select>' + '</div>' + '<div style="width:105px;float:left;">' + '<div class="input-elm-borderrightcolor" style="height:50px;"></div>' + '</div>' + '</div>' + '' + '</div>' + '' + '<div id="divElementType" class="is-tab-content" data-group="element">' + '' + '<div class="is-settings clearfix" style="display:inline-block;width:145px;float:left;margin-bottom:0;">' + '<div>Text Color:</div>' + '<div>' + '<div class="input-elm-color" style="height:50px;"></div>' + '</div>' + '</div>' + '' + '<div class="is-settings clearfix" style="display:inline-block;width:145px;float:left;margin-bottom:0;">' + '<div>Font Size:</div>' + '<div style="display:flex">' + '<input type="text" id="inpElmFontSize" value="" style="width:80px"/>' + '<select id="inpElmFontSizeUnit" style="width:50px;height:50px;border-radius:0;">' + '<option value="px">px</option>' + '<option value="pt">pt</option>' + '<option value="em">em</option>' + '<option value="vw">vw</option>' + '<option value="vh">vh</option>' + '<option value="%">%</option>' + '</select>' + '</div>' + '</div>' + '' + '<div class="is-settings clearfix" style="display:inline-block;width:145px;float:left;margin-bottom:0;">' + '<div>Text Align:</div>' + '<div>' + '<select id="inpElmTextAlign" style="height:50px;border-radius:0;">' + '<option value=""></option>' + '<option value="left">Left</option>' + '<option value="center">Center</option>' + '<option value="right">Right</option>' + '<option value="justify">Full</option>' + '</select>' + '</div>' + '</div>' + '' + '<div class="is-settings clearfix" style="display:inline-block;width:145px;float:left;margin-bottom:0;">' + '<div>Line Height:</div>' + '<div style="display:flex">' + '<input type="text" id="inpElmLineHeight" value="" style="width:80px"/>' + '<select id="inpElmLineHeightUnit" style="width:50px;height:50px;border-radius:0;">' + '<option value=""></option>' + '<option value="px">px</option>' + '<option value="pt">pt</option>' + '</select>' + '</div>' + '</div>' + '' + '<div class="is-settings clearfix" style="display:inline-block;width:145px;float:left;margin-bottom:0;">' + '<div>Font Weight:</div>' + '<div>' + '<select id="inpElmFontWeight" style="height:50px;border-radius:0;">' + '<option value=""></option>' + '<option value="100">100</option>' + '<option value="200">200</option>' + '<option value="300">300</option>' + '<option value="400">400</option>' + '<option value="500">500</option>' + '<option value="600">600</option>' + '<option value="700">700</option>' + '<option value="800">800</option>' + '<option value="900">900</option>' + '<option value="bold">Bold</option>' + '<option value="normal">Normal</option>' + '</select>' + '</div>' + '</div>' + '' + '<div class="is-settings clearfix" style="display:inline-block;width:145px;margin-bottom:0;">' + '<div>Font Style:</div>' + '<div>' + '<select id="inpElmFontStyle" style="height:50px;border-radius:0;">' + '<option value=""></option>' + '<option value="italic">Italic</option>' + '<option value="normal">Normal</option>' + '</select>' + '</div>' + '</div>' + '' + '<div class="is-settings clearfix" style="display:inline-block;width:145px;float:left;margin-bottom:0;">' + '<div>Text Transform:</div>' + '<div>' + '<select id="inpElmTextTransform" style="height:50px;border-radius:0;">' + '<option value=""></option>' + '<option value="uppercase">Uppercase</option>' + '<option value="lowercase">Lowercase</option>' + '<option value="capitalize">Capitalize</option>' + '<option value="none">None</option>' + '</select>' + '</div>' + '</div>' + '' + '<div class="is-settings clearfix" style="display:inline-block;width:145px;margin-bottom:0;">' + '<div>Text Decoration:</div>' + '<div>' + '<select id="inpElmTextDecoration" style="height:50px;border-radius:0;">' + '<option value=""></option>' + '<option value="underline">Underline</option>' + '<option value="line-through">Line Through</option>' + '<option value="overline">Overline</option>' + '<option value="none">None</option>' + '</select>' + '</div>' + '</div>' + '' + '<div class="is-settings clearfix" style="display:inline-block;width:145px;float:left;margin-bottom:0;">' + '<div>Letter Spacing:</div>' + '<div>' + '<input type="text" id="inpElmLetterSpacing" value="" style="width:80px"/> px' + '</div>' + '</div>' + '' + '<div class="is-settings clearfix" style="display:inline-block;width:145px;float:left;margin-bottom:0;">' + '<div>Word Spacing:</div>' + '<div>' + '<input type="text" id="inpElmWordSpacing" value="" style="width:80px"/> px' + '</div>' + '</div>' + '' + '<div class="is-settings clearfix" style="display:inline-block;width:100%;margin-bottom:0;">' + '<div>Font Family:</div>' + '<div style="display:flex">' + '<input type="text" id="inpElmFontFamily" value="" style="width:100%"/>' + '<button title="' + out('Select Font') + '" class="input-elm-fontfamily" style="border-left: none;width:60px;height:50px;"><svg class="is-icon-flex"><use xlink:href="#ion-more"></use></svg></button>' + '</div>' + '</div>' + '' + '</div>' + '' + '<div id="divElementCorners" class="is-tab-content" data-group="element">' + '' + '<div style="margin-top: 13px;font-weight: bold;line-height: 1.7;">Corners</div>' + '' + '<div class="is-settings clearfix" style="display:inline-block;width:100%;margin-bottom:9px;">' + '<div>Border Radius:</div>' + '<div>' + '<input type="text" id="inpElmBorderRadius" value="" style="width:80px"/> px' + '</div>' + '</div>' + '' + '<div style="margin-top: 25px;font-weight: bold;line-height: 1.7;">Individual Corners</div>' + '' + '<div class="is-settings clearfix" style="display:inline-block;width:140px;float:left;margin-bottom:0;">' + '<div>Top Left</div>' + '<div>' + '<input type="text" id="inpElmBorderTopLeftRadius" value="" style="width:80px"/> px' + '</div>' + '</div>' + '' + '<div class="is-settings clearfix" style="display:inline-block;width:140px;margin-bottom:0;">' + '<div>Top Right</div>' + '<div>' + '<input type="text" id="inpElmBorderTopRightRadius" value="" style="width:80px"/> px' + '</div>' + '</div>' + '' + '<div class="is-settings clearfix" style="display:inline-block;width:140px;float:left;margin-bottom:0;">' + '<div>Bottom Left</div>' + '<div>' + '<input type="text" id="inpElmBorderBottomLeftRadius" value="" style="width:80px"/> px' + '</div>' + '</div>' + '' + '<div class="is-settings clearfix" style="display:inline-block;width:140px;margin-bottom:0;">' + '<div>Bottom Right</div>' + '<div>' + '<input type="text" id="inpElmBorderBottomRightRadius" value="" style="width:80px"/> px' + '</div>' + '</div>' + '' + '</div>' + '' + '<div id="divElementShadow" class="is-tab-content" data-group="element">' + '' + '<div style="margin-top: 13px;font-weight: bold;line-height: 1.7;">Shadow</div>' + '' + '<div class="is-settings clearfix" style="display:inline-block;width:145px;float:left;margin-bottom:0;">' + '<div>x Offset:</div>' + '<div style="display:flex">' + '<input type="text" id="inpElmBoxShadowX" value="" style="width:80px"/>' + '<select id="inpElmBoxShadowXUnit" style="height:50px;border-radius:0;">' + '<option value="px">px</option>' + '<option value="em">em</option>' + '</select>' + '</div>' + '</div>' + '' + '<div class="is-settings clearfix" style="display:inline-block;width:145px;float:left;margin-bottom:0;">' + '<div>y Offset:</div>' + '<div style="display:flex">' + '<input type="text" id="inpElmBoxShadowY" value="" style="width:80px"/>' + '<select id="inpElmBoxShadowYUnit" style="height:50px;border-radius:0;">' + '<option value="px">px</option>' + '<option value="em">em</option>' + '</select>' + '</div>' + '</div>' + '' + '<div class="is-settings clearfix" style="display:inline-block;width:145px;float:left;margin-bottom:0;">' + '<div>Blur:</div>' + '<div style="display:flex">' + '<input type="text" id="inpElmBoxShadowBlur" value="" style="width:80px"/>' + '<select id="inpElmBoxShadowBlurUnit" style="height:50px;border-radius:0;">' + '<option value="px">px</option>' + '<option value="em">em</option>' + '</select>' + '</div>' + '</div>' + '' + '<div class="is-settings clearfix" style="display:inline-block;width:145px;float:left;margin-bottom:0;">' + '<div>Spread:</div>' + '<div style="display:flex">' + '<input type="text" id="inpElmBoxShadowSpread" value="" style="width:80px"/>' + '<select id="inpElmBoxShadowSpreadUnit" style="height:50px;border-radius:0;">' + '<option value="px">px</option>' + '<option value="em">em</option>' + '</select>' + '</div>' + '</div>' + '' + '<div class="is-settings clearfix" style="display:inline-block;width:100%;margin-bottom:0;">' + '<div>Shadow Color:</div>' + '<div>' + '<div class="input-elm-shadowcolor" style="height:50px;"></div>' + '</div>' + '</div>' + '' + '<div class="is-settings clearfix" style="display:inline-block;width:100%;margin-bottom:0;">' + '<div>Outer/Inner Shadow:</div>' + '<div>' + '<select id="inpElmBoxShadowInset" style="height:50px;border-radius:0;">' + '<option value="">Outset</option>' + '<option value="inset">Inset</option>' + '</select>' + '</div>' + '</div>' + '</div>' + '' + '<div id="divElementDisplay" class="is-tab-content" data-group="element">' + '' + '<div style="margin-top: 13px;font-weight: bold;line-height: 1.7;">Display</div>' + '' + '<div class="is-settings clearfix" style="display:inline-block;width:100%;margin-bottom:0;">' + '<div style="display:flex">' + '<select id="inpElmDisplay" style="height:50px;border-radius:0;">' + '<option value=""></option>' + '<option value="block">Block</option>' + '<option value="inline-block">Inline Block</option>' + '<option value="inline">Inline</option>' + '<option value="flex">Flex</option>' + '<option value="none">None</option>' + '</select>' + '</div>' + '</div>' + '' + '<div style="margin-top: 25px;font-weight: bold;line-height: 1.7;width:100%;">Flex</div>' + '' + '<div class="is-settings clearfix" style="display:inline-block;width:140px;float:left;margin-bottom:0;">' + '<div>Flex Direction:</div>' + '<div style="display:flex">' + '<select id="inpElmFlexDirection" style="width:120px;height:50px;border-radius:0;">' + '<option value=""></option>' + '<option value="row">Row</option>' + '<option value="row-reverse">Row Reverse</option>' + '<option value="column">Column</option>' + '<option value="column-reverse">Column Reverse</option>' + '</select>' + '</div>' + '</div>' + '' + '<div class="is-settings clearfix" style="display:inline-block;width:140px;float:left;margin-bottom:0;">' + '<div>Flex Wrap:</div>' + '<div style="display:flex">' + '<select id="inpElmFlexWrap" style="height:50px;border-radius:0;">' + '<option value=""></option>' + '<option value="no-wrap">No Wrap</option>' + '<option value="wrap">Wrap</option>' + '<option value="wrap-reverse">Wrap Reverse</option>' + '</select>' + '</div>' + '</div>' + '' + '<div class="is-settings clearfix" style="display:inline-block;width:100%;margin-bottom:0;">' + '<div>Justify Content:</div>' + '<div style="display:flex">' + '<select id="inpElmJustifyContent" style="height:50px;border-radius:0;">' + '<option value=""></option>' + '<option value="center">Center</option>' + '<option value="flex-start">Flex Start</option>' + '<option value="flex-end">Flex End</option>' + '<option value="space-around">Space Around</option>' + '<option value="space-between">Space Between</option>' + '</select>' + '</div>' + '</div>' + '' + '<div class="is-settings clearfix" style="display:inline-block;width:140px;float:left;margin-bottom:0;">' + '<div>Align Items:</div>' + '<div style="display:flex">' + '<select id="inpElmAlignItems" style="height:50px;border-radius:0;">' + '<option value=""></option>' + '<option value="center">Center</option>' + '<option value="flex-start">Flex Start</option>' + '<option value="flex-end">Flex End</option>' + '<option value="stretch">Stretch</option>' + '<option value="baseline">Baseline</option>' + '</select>' + '</div>' + '</div>' + '' + '<div class="is-settings clearfix" style="display:inline-block;width:140px;float:left;margin-bottom:0;">' + '<div>Align Content:</div>' + '<div style="display:flex">' + '<select id="inpElmAlignContent" style="height:50px;border-radius:0;">' + '<option value=""></option>' + '<option value="center">Center</option>' + '<option value="flex-start">Flex Start</option>' + '<option value="flex-end">Flex End</option>' + '<option value="stretch">Stretch</option>' + '<option value="space-around">Space Around</option>' + '<option value="space-between">Space Between</option>' + '</select>' + '</div>' + '</div>' + '' + '</div>' + '' + '<div id="divElementPosition" class="is-tab-content" data-group="element">' + '' + '<div style="margin-top: 13px;font-weight: bold;line-height: 1.7;">Position</div>' + '' + '<div class="is-settings clearfix" style="display:inline-block;width:100%;margin-bottom:0;">' + '<div style="display:flex">' + '<select id="inpElmPosition" style="height:50px;border-radius:0;">' + '<option value=""></option>' + '<option value="relative">Relative</option>' + '<option value="absolute">Absolute</option>' + '<option value="fixed">Fixed</option>' + '</select>' + '</div>' + '</div>' + '' + '<div class="is-settings clearfix" style="display:inline-block;width:145px;float:left;margin-bottom:0;">' + '<div>Top:</div>' + '<div style="display:flex">' + '<input type="text" id="inpElmTop" value="" style="width:80px"/>' + '<select id="inpElmTopUnit" style="height:50px;border-radius:0;">' + '<option value="px">px</option>' + '<option value="em">em</option>' + '<option value="vw">vw</option>' + '<option value="vh">vh</option>' + '<option value="%">%</option>' + '</select>' + '</div>' + '</div>' + '' + '<div class="is-settings clearfix" style="display:inline-block;width:145px;float:left;margin-bottom:0;">' + '<div>Left:</div>' + '<div style="display:flex">' + '<input type="text" id="inpElmLeft" value="" style="width:80px"/>' + '<select id="inpElmLeftUnit" style="height:50px;border-radius:0;">' + '<option value="px">px</option>' + '<option value="em">em</option>' + '<option value="vw">vw</option>' + '<option value="vh">vh</option>' + '<option value="%">%</option>' + '</select>' + '</div>' + '</div>' + '' + '<div class="is-settings clearfix" style="display:inline-block;width:145px;float:left;margin-bottom:0;">' + '<div>Bottom:</div>' + '<div style="display:flex">' + '<input type="text" id="inpElmBottom" value="" style="width:80px"/>' + '<select id="inpElmBottomUnit" style="height:50px;border-radius:0;">' + '<option value="px">px</option>' + '<option value="em">em</option>' + '<option value="vw">vw</option>' + '<option value="vh">vh</option>' + '<option value="%">%</option>' + '</select>' + '</div>' + '</div>' + '' + '<div class="is-settings clearfix" style="display:inline-block;width:145px;margin-bottom:0;">' + '<div>Right:</div>' + '<div style="display:flex">' + '<input type="text" id="inpElmRight" value="" style="width:80px"/>' + '<select id="inpElmRightUnit" style="height:50px;border-radius:0;">' + '<option value="px">px</option>' + '<option value="em">em</option>' + '<option value="vw">vw</option>' + '<option value="vh">vh</option>' + '<option value="%">%</option>' + '</select>' + '</div>' + '</div>' + '' + '<div style="margin-top: 25px;font-weight: bold;line-height: 1.7;">Float</div>' + '' + '<div class="is-settings clearfix" style="display:inline-block;width:140px;margin-bottom:0;">' + '<div style="display:flex">' + '<select id="inpElmFloat" style="height:50px;border-radius:0;">' + '<option value=""></option>' + '<option value="left">Left</option>' + '<option value="right">Right</option>' + '<option value="none">None</option>' + '</select>' + '</div>' + '</div>' + '' + '</div>' + '' + '<div id="divElementEffects" class="is-tab-content" data-group="element">' + '' + '<div style="margin-top: 13px;font-weight: bold;line-height: 1.7;">Effects</div>' + '' + '<div class="is-settings clearfix" style="display:inline-block;width:100%;margin-bottom:0;">' + '<div>Opacity:</div>' + '<div style="display:flex">' + '<input type="text" id="inpElmOpacity" value="" style="width:100px"/>' + '</div>' + '</div>' + '' + '<div style="margin-top: 25px;font-weight: bold;line-height: 1.7;">Filters</div>' + '' + '<div class="is-settings clearfix" style="display:inline-block;width:120px;float:left;margin-bottom:0;">' + '<div>Blur:</div>' + '<div style="width:115px;float:left;">' + '<input type="text" id="inpElmBlur" value="" style="width:80px"/> px' + '</div>' + '</div>' + '' + '<div class="is-settings clearfix" style="display:inline-block;width:120px;float:left;margin-bottom:0;">' + '<div>Brightness:</div>' + '<div style="width:115px;float:left;">' + '<input type="text" id="inpElmBrightness" value="" style="width:80px"/>' + '</div>' + '</div>' + '' + '<div class="is-settings clearfix" style="display:inline-block;width:120px;float:left;margin-bottom:0;">' + '<div>Contrast:</div>' + '<div style="width:115px;float:left;">' + '<input type="text" id="inpElmContrast" value="" style="width:80px"/> %' + '</div>' + '</div>' + '' + '<div class="is-settings clearfix" style="display:inline-block;width:120px;float:left;margin-bottom:0;">' + '<div>Grayscale:</div>' + '<div style="width:115px;float:left;">' + '<input type="text" id="inpElmGrayscale" value="" style="width:80px"/> %' + '</div>' + '</div>' + '' + '<div class="is-settings clearfix" style="display:inline-block;width:120px;float:left;margin-bottom:0;">' + '<div>Hue Rotate:</div>' + '<div style="width:115px;float:left;">' + '<input type="text" id="inpElmHueRotate" value="" style="width:80px"/> <span style="font-size:14px">deg</span>' + '</div>' + '</div>' + '' + '<div class="is-settings clearfix" style="display:inline-block;width:120px;float:left;margin-bottom:0;">' + '<div>Invert:</div>' + '<div style="width:115px;float:left;">' + '<input type="text" id="inpElmInvert" value="" style="width:80px"/> %' + '</div>' + '</div>' + '' + '<div class="is-settings clearfix" style="display:inline-block;width:120px;float:left;margin-bottom:0;">' + '<div>Saturate:</div>' + '<div style="width:115px;float:left;">' + '<input type="text" id="inpElmSaturate" value="" style="width:80px"/>' + '</div>' + '</div>' + '' + '<div class="is-settings clearfix" style="display:inline-block;width:120px;float:left;margin-bottom:0;">' + '<div>Sepia:</div>' + '<div style="width:115px;float:left;">' + '<input type="text" id="inpElmSepia" value="" style="width:80px"/> %' + '</div>' + '</div>' + '' + '</div>' + '' + '<div id="divElementAttributes" class="is-tab-content" data-group="element">' + '' + '<div style="margin-top: 13px;font-weight: bold;line-height: 1.7;">Attributes</div>' + '' + '<div class="is-settings clearfix" style="display:inline-block;width:140px;float:left;margin-bottom:0;">' + '<div>Attribute Names:</div>' + '<div style="display:flex">' + '<input type="text" id="inpElmAttr1" value="" style="width:120px"/>' + '</div>' + '</div>' + '' + '<div class="is-settings clearfix" style="display:inline-block;width:180px;float:left;margin-bottom:0;">' + '<div>Attribute Values:</div>' + '<div style="display:flex">' + '<input type="text" id="inpElmAttrVal1" value="" style="width:160px"/>' + '</div>' + '</div>' + '' + '<div class="is-settings clearfix" style="display:inline-block;width:140px;float:left;margin-bottom:0;">' + '<div style="display:flex">' + '<input type="text" id="inpElmAttr2" value="" style="width:120px"/>' + '</div>' + '</div>' + '' + '<div class="is-settings clearfix" style="display:inline-block;width:180px;float:left;margin-bottom:0;">' + '<div style="display:flex">' + '<input type="text" id="inpElmAttrVal2" value="" style="width:160px"/>' + '</div>' + '</div>' + '' + '<div class="is-settings clearfix" style="display:inline-block;width:140px;float:left;margin-bottom:0;">' + '<div style="display:flex">' + '<input type="text" id="inpElmAttr3" value="" style="width:120px"/>' + '</div>' + '</div>' + '' + '<div class="is-settings clearfix" style="display:inline-block;width:180px;float:left;margin-bottom:0;">' + '<div style="display:flex">' + '<input type="text" id="inpElmAttrVal3" value="" style="width:160px"/>' + '</div>' + '</div>' + '' + '<div class="is-settings clearfix" style="display:inline-block;width:140px;float:left;margin-bottom:0;">' + '<div style="display:flex">' + '<input type="text" id="inpElmAttr4" value="" style="width:120px"/>' + '</div>' + '</div>' + '' + '<div class="is-settings clearfix" style="display:inline-block;width:180px;float:left;margin-bottom:0;">' + '<div style="display:flex">' + '<input type="text" id="inpElmAttrVal4" value="" style="width:160px"/>' + '</div>' + '</div>' + '' + '<div class="is-settings clearfix" style="display:inline-block;width:140px;float:left;margin-bottom:0;">' + '<div style="display:flex">' + '<input type="text" id="inpElmAttr5" value="" style="width:120px"/>' + '</div>' + '</div>' + '' + '<div class="is-settings clearfix" style="display:inline-block;width:180px;float:left;">' + '<div style="display:flex">' + '<input type="text" id="inpElmAttrVal5" value="" style="width:160px"/>' + '</div>' + '</div>' + '' + '</div>' + '' + '<div id="divElementAnimation" class="is-tab-content" data-group="element">' + '' + '<div style="margin-top: 13px;font-weight: bold;line-height: 1.7;">' + out('Animate') + '</div>' + '' + '<div class="is-settings clearfix" style="display:inline-block;width:100%;margin-bottom:0;">' + '<div style="display:flex">' + '<select id="selElmAnim" style="height:45px;margin-bottom:0;">' + '<option value=""></option>' + '<option value="fade">fade</option>' + '<option value="fade-up">fade-up</option>' + '<option value="fade-down">fade-down</option>' + '<option value="fade-left">fade-left</option>' + '<option value="fade-right">fade-right</option>' + '<option value="fade-up-right">fade-up-right</option>' + '<option value="fade-up-left">fade-up-left</option>' + '<option value="fade-down-right">fade-down-right</option>' + '<option value="fade-down-left">fade-down-left</option>' + '<option value="flip-up">flip-up</option>' + '<option value="flip-down">flip-down</option>' + '<option value="flip-left">flip-left</option>' + '<option value="flip-right">flip-right</option>' + '<option value="slide-up">slide-up</option>' + '<option value="slide-down">slide-down</option>' + '<option value="slide-left">slide-left</option>' + '<option value="slide-right">slide-right</option>' + '<option value="zoom-in">zoom-in</option>' + '<option value="zoom-in-up">zoom-in-up</option>' + '<option value="zoom-in-down">zoom-in-down</option>' + '<option value="zoom-in-left">zoom-in-left</option>' + '<option value="zoom-in-right">zoom-in-right</option>' + '<option value="zoom-out">zoom-out</option>' + '<option value="zoom-out-up">zoom-out-up</option>' + '<option value="zoom-out-down">zoom-out-down</option>' + '<option value="zoom-out-left">zoom-out-left</option>' + '<option value="zoom-out-right">zoom-out-right</option>' + '</select>' + '</div>' + '</div>' + '' + '<div class="is-settings clearfix" style="display:inline-block;width:140px;margin-bottom:0;">' + '<div>' + out('Delay') + ':</div>' + '<div style="width:115px;float:left;">' + '<select id="selElmAnimDelay" style="height:45px;margin-bottom:0;">' + '<option value=""></option>' + '<option value="0">0</option>' + '<option value="100">100</option>' + '<option value="200">200</option>' + '<option value="300">300</option>' + '<option value="400">400</option>' + '<option value="500">500</option>' + '<option value="600">600</option>' + '<option value="700">700</option>' + '<option value="800">800</option>' + '<option value="900">900</option>' + '<option value="1000">1000</option>' + '<option value="1100">1100</option>' + '<option value="1200">1200</option>' + '<option value="1300">1300</option>' + '<option value="1400">1400</option>' + '<option value="1500">1500</option>' + '<option value="1600">1600</option>' + '<option value="1700">1700</option>' + '<option value="1800">1800</option>' + '<option value="1900">1900</option>' + '<option value="2000">2000</option>' + '<option value="2100">2100</option>' + '<option value="2200">2200</option>' + '<option value="2300">2300</option>' + '<option value="2400">2400</option>' + '<option value="2500">2500</option>' + '<option value="2600">2600</option>' + '<option value="2700">2700</option>' + '<option value="2800">2800</option>' + '<option value="2900">2900</option>' + '<option value="3000">3000</option>' + '</select> ms' + '</div>' + '</div>' + '' + '<div class="is-settings clearfix" style="display:inline-block;width:140px;margin-bottom:0;">' + '<div>' + out('Duration') + ':</div>' + '<div style="width:115px;float:left;">' + '<select id="selElmAnimDuration" style="height:45px;margin-bottom:0;">' + '<option value=""></option>' + '<option value="0">0</option>' + '<option value="100">100</option>' + '<option value="200">200</option>' + '<option value="300">300</option>' + '<option value="400">400</option>' + '<option value="500">500</option>' + '<option value="600">600</option>' + '<option value="700">700</option>' + '<option value="800">800</option>' + '<option value="900">900</option>' + '<option value="1000">1000</option>' + '<option value="1100">1100</option>' + '<option value="1200">1200</option>' + '<option value="1300">1300</option>' + '<option value="1400">1400</option>' + '<option value="1500">1500</option>' + '<option value="1600">1600</option>' + '<option value="1700">1700</option>' + '<option value="1800">1800</option>' + '<option value="1900">1900</option>' + '<option value="2000">2000</option>' + '<option value="2100">2100</option>' + '<option value="2200">2200</option>' + '<option value="2300">2300</option>' + '<option value="2400">2400</option>' + '<option value="2500">2500</option>' + '<option value="2600">2600</option>' + '<option value="2700">2700</option>' + '<option value="2800">2800</option>' + '<option value="2900">2900</option>' + '<option value="3000">3000</option>' + '</select> ms' + '</div>' + '</div>' + '' + '<div class="is-settings clearfix" style="display:inline-block;width:100%;margin-bottom:0;">' + '<div style="margin-top:15px">' + '<label for="chkAnimateOnce"><input type="checkbox" id="chkAnimateOnce" value="" /> ' + out('Animate Once') + '</label>' + '</div>' + '</div>' + '' + '<div class="is-settings clearfix" style="display:inline-block;width:100%;float:left;margin-bottom:0;">' + '<div style="display:flex">' + '<button title="' + out('Test') + '" id="btnPreviewAnim" class="classic" value="" style="width:100%;height:45px;">' + out('TEST') + '</button>' + '</div>' + '</div>' + '</div>' + '' + '</div>' + '</div>' + '' + '<div class="is-modal pickfontfamily">' + '<div style="max-width:303px;padding:0;box-sizing:border-box;position:relative;">' + '<div class="is-modal-bar is-draggable" style="position: absolute;top: 0;left: 0;width: 100%;z-index:1;">' + out('Font') + '</div>' + '<div class="clearfix" style="margin-top:40px;padding:0px;height:300px;position:relative;">' + '<iframe src="about:blank" style="width:100%;height:100%;position:absolute;top:0;left:0;border: none;"></iframe>' + '</div>' + '</div>' + '</div>' + '' + '<div class="is-modal pickgradientcolor">' + '<div style="max-width:293px;padding:0;box-sizing:border-box;position:relative;">' + '<div class="is-modal-bar is-draggable" style="position: absolute;top: 0;left: 0;width: 100%;z-index:1;">' + out('Gradient') + '</div>' + '<div class="clearfix" style="margin-top:40px;padding: 20px;">' + '<div style="display: flex;flex-flow: wrap;">' + '[GRADIENTCOLORS]' + '<button title="' + out('Clear') + '" id="inpElmGradClear" data-value="" style="width:50px;border: 1px solid rgb(229, 229, 229);border-left: none;border-top: none;"><svg class="is-icon-flex" style="fill:rgba(0, 0, 0, 0.8);width:23px;height:23px;"><use xlink:href="#ion-ios-close-empty"></use></svg></button>' + '</div>' + '<div class="is-settings" style="margin-bottom:0">' + '<div>' + out('Custom') + ':</div>' + '<div>' + '<div id="divCustomElmGradColors" class="clearfix" style="margin-bottom:10px;"></div>' + '<input type="hidden" id="inpElmGrad1" value="">' + '<button title="' + out('Select Color') + '" class="cmd-elm-pickgradient1" data-value="dark" style="width:55px;height:50px;"><svg class="is-icon-flex" style="fill:rgba(0, 0, 0, 0.8);width:12px;height:12px;"><use xlink:href="#ion-contrast"></use></svg></button>' + '<input type="hidden" id="inpElmGrad2" value="">' + '<button title="' + out('Select Color') + '" class="cmd-elm-pickgradient2" data-value="dark" style="width:55px;height:50px;border-left:none;"><svg class="is-icon-flex" style="fill:rgba(0, 0, 0, 0.8);width:12px;height:12px;"><use xlink:href="#ion-contrast"></use></svg></button>' + '<div style="width:100px;float:left;margin-left:10px;">' + '<input type="text" id="inpElmGradDeg" value="0" style="width:60px;margin-right:3px;"/> deg' + '</div>' + '<br style="clear:both">' + '<button title="' + out('Add') + '" class="cmd-elm-savegrad" style="width:100%;font-size: 14px;margin-top:10px;"> ' + out('Add') + ' </button>' + '</div>' + '</div>' + '</div>' + '</div>' + '</div>' + '' + '<div class="is-modal pickcolor" style="background: rgba(255,255,255,0.001);">' + '<div style="max-width:341px;">' + '<div class="is-modal-bar is-draggable" style="margin-top:-12px;height:12px;"></div>' + '[COLORS]' + '<br style="clear:both">' + '<div class="clearfix" style="width:315px;height:45px;overflow:hidden;position:relative;">' + '<div class="gradient" style="width:630px;height:45px;;position:absolute;top:0;transition: all ease 0.3s;">[GRADIENT]</div>' + '</div>' + '<button data-color="#ffffff" style="background:#ffffff;border:#e7e7e7 1px solid;width:90px"><span style="position:absolute;top:0;left:0;width:100%;height:100%;border:#f8f8f8 1px solid;box-sizing: border-box;line-height:41px;font-size:10px;">White</span></button>' + '<button title="' + out('Clear') + '" data-color="" class="clear classic" style="">' + out('Clear') + '</button>' + '<button title="' + out('More') + '" class="input-more classic" style="font-size:20px;color:#777;"><svg class="is-icon-flex" style="width:13px;height:13px;transform: rotateZ(90deg);"><use xlink:href="#ion-ios-arrow-right"></use></svg></button>' + '<div class="more clearfix" style="display:flex">' + '<button class="is-color-preview" style="width:45px;height:45px;border:1px solid rgba(53, 53, 53, 0.28);border-right:none;box-sizing:border-box;margin-top:8px;"></button>' + '<input class="input-text" type="text" style="width:225px;margin-top:8px;"/>' + '<button title="' + out('Apply') + '" class="input-ok" style="border: 1px solid rgb(199, 199, 199);border-left:none;margin-top:8px;"><svg class="is-icon-flex" style="fill:rgba(0, 0, 0, 0.7);"><use xlink:href="#icon-ok"></use></svg></use></svg></svg></button>' + '</div>' + '</div>' + '</div>' + '' + '<div class="is-modal iframelink">' + '<div style="max-width:550px;">' + '<input class="input-src" type="text" placeholder="Source" style="width:100%;margin-bottom:12px;"/>' + '<textarea class="input-embedcode" type="text" placeholder="Embed Code" style="width:100%;height:300px;margin-bottom:12px;display:none;"></textarea>' + '<div style="text-align:right">' + '<button title="' + out('Cancel') + '" class="input-cancel classic-secondary">' + out('Cancel') + '</button>' + '<button title="' + out('Ok') + '" class="input-ok classic-primary">' + out('Ok') + '</button>' + '</div>' + '</div>' + '</div>' + '' + '<div class="is-modal customcode">' + '<div style="max-width:900px;height:570px;padding:0;box-sizing:border-box;position:relative;">' + '<div class="is-modal-bar is-draggable" style="position: absolute;top: 0;left: 0;width: 100%;z-index:1;">' + out('Custom Code (Javascript Allowed)') + '</div>' + '<textarea class="input-customcode" type="text" style="background: #fff;position: absolute;top: 0;left: 0;width:100%;height:100%;border:none;border-bottom:60px solid transparent;border-top:40px solid transparent;box-sizing:border-box;"></textarea>' + '<input id="hidContentModuleCode" type="hidden" />' + '<input id="hidContentModuleSettings" type="hidden" />' + '<button title="' + out('Enlarge') + '" class="cell-html-larger" style="width:35px;height:35px;position:absolute;right:0;top:0;background:transparent;z-index:2;"><svg class="is-icon-flex" style="width:19px;height:19px;fill:rgb(170, 170, 170);"><use xlink:href="#ion-arrow-expand"></use></svg></button>' + '<div style="width:100%;height:50px;position:absolute;left:0;bottom:0;border-top: #efefef 1px solid;overflow:hidden;text-align:right">' + '<button title="' + out('Cancel') + '" class="input-cancel classic-secondary">' + out('Cancel') + '</button>' + '<button title="' + out('Ok') + '" class="input-ok classic-primary">' + out('Ok') + '</button>' + '</div>' + '</div>' + '</div>' + '' + '<div class="is-modal custommodule">' + '<div style="max-width:900px;height:570px;padding:0;box-sizing:border-box;position:relative;">' + '<div class="is-modal-bar is-draggable" style="position: absolute;top: 0;left: 0;width: 100%;z-index:1;">' + out('Module Settings') + '</div>' + '<iframe style="position: absolute;top: 0;left: 0;width:100%;height:100%;border:none;border-bottom:60px solid transparent;border-top:40px solid transparent;margin:0;box-sizing:border-box;" src="about:blank"></iframe>' + '<div style="width:100%;height:50px;position:absolute;left:0;bottom:0;border-top: #efefef 1px solid;overflow:hidden;text-align:right">' + '<button title="' + out('Cancel') + '" class="input-cancel classic-secondary">' + out('Cancel') + '</button>' + '<button title="' + out('Ok') + '" class="input-ok classic-primary">' + out('Ok') + '</button>' + '</div>' + '</div>' + '</div>' + '' + '<div class="is-modal insertimage">' + '<div style="max-width:560px;">' + '<div class="is-browse-area">' + '<div class="is-drop-area">' + '<input id="fileInsertImage" type="file" accept="image/*" />' + '<div class="drag-text">' + '<p style="display:flex;justify-content:center;align-items:center;"><svg class="is-icon-flex" style="fill:rgba(0, 0, 0, 0.7);width:20px;height:20px;"><use xlink:href="#ion-camera"></use></svg> <span style="margin-left:5px;margin-top:3px;">' + out('Drag and drop an image or click to browse.') + '</span></p>' + '</div>' + '</div>' + '<div class="is-preview-area">' + '<div><img id="imgInsertImagePreview" alt="" /><i class="ion-ios-close-empty"></i></div>' + '</div>' + '</div>' + '<p>' + out('Or Specify Image Source') + ':</p>' + ((plugin.settings.onImageSelectClick + '').replace(/\s/g, '') != 'function(){}' || plugin.settings.imageselect != '' ? '<div class="image-src clearfix" style="margin-bottom: 12px;"><input class="input-src" type="text" placeholder="' + out('Source') + '"><button title="' + out('Select') + '" class="input-select"><svg class="is-icon-flex"><use xlink:href="#ion-more"></use></svg></button></div>' : '<div class="image-src clearfix" style="margin-bottom: 12px;"><input class="input-src" type="text" placeholder="' + out('Source') + '"></div>') + '<div style="text-align:right">' + '<button title="' + out('Cancel') + '" class="input-cancel classic-secondary">' + out('Cancel') + '</button>' + '<button title="' + out('Ok') + '" class="input-ok classic-primary">' + out('Ok') + '</button>' + '</div>' + '</div>' + '</div>' + '' + '<div class="is-modal is-side' + (this.settings.sidePanel == 'right' ? '' : ' fromleft') + ' viewicons" style="width:320px;">' + '<div class="is-side-close" style="z-index:1;width:40px;height:40px;position:absolute;top:0px;right:0px;box-sizing:border-box;padding:0;line-height:40px;font-size: 12px;color:#777;text-align:center;cursor:pointer;"><svg class="is-icon-flex" style="fill:rgba(0, 0, 0, 0.47);width:40px;height:40px;"><use xlink:href="#ion-ios-close-empty"></use></svg></div>' + '' + '<iframe id="ifrIconInsert" style="width:100%;height:100%;border: none;display: block;" src="about:blank"></iframe>' + '<iframe id="ifrIconEdit" style="width:100%;height:100%;border: none;display: none;" src="about:blank"></iframe>' + '' + '</div>' + '' + '<div class="is-modal is-side' + (this.settings.sidePanel == 'right' ? '' : ' fromleft') + ' viewsizes" style="width:338px;">' + '<div class="is-side-close" style="z-index:1;width:40px;height:40px;position:absolute;top:0px;right:0px;box-sizing:border-box;padding:0;line-height:40px;font-size: 12px;color:#777;text-align:center;cursor:pointer;"><svg class="is-icon-flex" style="fill:rgba(0, 0, 0, 0.47);width:40px;height:40px;"><use xlink:href="#ion-ios-close-empty"></use></svg></div>' + '' + '<iframe id="ifrApplySize" style="width:100%;height:100%;border: none;" src="about:blank"></iframe>' + '' + '</div>' + '' + '<div class="is-modal grideditor" style="' + (plugin.settings.emailMode ? 'height:200px;' : '') + 'z-index:10002">' + '<div class="is-modal-bar is-draggable" style="position: absolute;top: 0;left: 0;width: 100%;z-index:1;line-height:1.5;height:20px;border:none;">' + '<div class="is-modal-close" style="z-index:1;width:20px;height:20px;position:absolute;top:0px;right:0px;box-sizing:border-box;padding:0;line-height:20px;font-size:10px;color:#777;text-align:center;cursor:pointer;">&#10005;</div>' + '</div>' + '' + '<div style="padding:30px 0 5px 18px;font-size:11px;color:#333;text-transform:uppercase;letter-spacing:1px;">Row' + '</div>' + '<div style="display:flex;flex-flow:wrap;">' + '<button title="' + out('Add') + '" class="row-add"><svg class="is-icon-flex" style="fill:rgba(0, 0, 0, 0.8);width:23px;height:23px;"><use xlink:href="#ion-ios-plus-empty"></use></svg></button>' + '<button title="' + out('Duplicate') + '" class="row-duplicate" style="display: block;"><svg class="is-icon-flex"><use xlink:href="#ion-ios-photos-outline"></use></svg></button>' + '<button title="' + out('Move Up') + '" class="row-up" style="display: block;"><svg class="is-icon-flex" style="fill:rgba(0, 0, 0, 0.7);width:18px;height:18px;"><use xlink:href="#ion-ios-arrow-thin-up"></use></svg></button>' + '<button title="' + out('Move Down') + '" class="row-down" style="display: block;"><svg class="is-icon-flex" style="fill:rgba(0, 0, 0, 0.7);width:18px;height:18px;"><use xlink:href="#ion-ios-arrow-thin-down"></use></svg></button>' + '<button title="' + out('HTML') + '" class="row-html"><svg class="is-icon-flex" style="margin-right:-3px;fill:rgba(0, 0, 0, 0.65);width:14px;height:14px;"><use xlink:href="#ion-ios-arrow-left"></use></svg><svg class="is-icon-flex" style="margin-left:-2px;fill:rgba(0, 0, 0, 0.65);width:14px;height:14px;"><use xlink:href="#ion-ios-arrow-right"></use></svg></button>' + '<button title="' + out('Delete') + '" class="row-remove"><svg class="is-icon-flex" style="fill:rgba(0, 0, 0, 0.8);width:23px;height:23px;"><use xlink:href="#ion-ios-close-empty"></use></svg></button>' + '</div>' + (plugin.settings.emailMode ? '' : '<div style="padding:8px 0 5px 18px;font-size:11px;color:#333;text-transform:uppercase;letter-spacing:1px;">Column' + '</div>' + '<div style="display:flex;flex-flow:wrap;">' + '<button title="' + out('Add') + '" class="cell-add"><svg class="is-icon-flex" style="fill:rgba(0, 0, 0, 0.8);width:21px;height:21px;"><use xlink:href="#ion-ios-plus-empty"></use></svg></button>' + '<button title="' + out('Duplicate') + '" class="cell-duplicate"><svg class="is-icon-flex"><use xlink:href="#ion-ios-photos-outline"></use></svg></button>' + '<button title="' + out('Move Up') + '" class="cell-up"><svg class="is-icon-flex" style="fill:rgba(0, 0, 0, 0.7);width:15px;height:15px;"><use xlink:href="#ion-ios-arrow-thin-up"></use></svg></button>' + '<button title="' + out('Move Down') + '" class="cell-down"><svg class="is-icon-flex" style="fill:rgba(0, 0, 0, 0.7);width:15px;height:15px;"><use xlink:href="#ion-ios-arrow-thin-down"></use></svg></button>' + '<button title="' + out('Move Left') + '" class="cell-prev"><svg class="is-icon-flex" style="fill:rgba(0, 0, 0, 0.7);width:15px;height:15px;"><use xlink:href="#ion-ios-arrow-thin-left"></use></svg></button>' + '<button title="' + out('Move Right') + '" class="cell-next"><svg class="is-icon-flex" style="fill:rgba(0, 0, 0, 0.7);width:15px;height:15px;"><use xlink:href="#ion-ios-arrow-thin-right"></use></svg></button>' + '<button title="' + out('Increase') + '" class="cell-increase"><svg class="is-icon-flex"><use xlink:href="#icon-increase"></use></svg></button>' + '<button title="' + out('Decrease') + '" class="cell-decrease"><svg class="is-icon-flex"><use xlink:href="#icon-decrease"></use></svg></button>' + '<button title="' + out('HTML') + '" class="cell-html"><svg class="is-icon-flex" style="margin-right:-3px;fill:rgba(0, 0, 0, 0.65);width:14px;height:14px;"><use xlink:href="#ion-ios-arrow-left"></use></svg><svg class="is-icon-flex" style="margin-left:-2px;fill:rgba(0, 0, 0, 0.65);width:14px;height:14px;"><use xlink:href="#ion-ios-arrow-right"></use></svg></button>' + '<button title="' + out('Delete') + '" class="cell-remove"><svg class="is-icon-flex" style="fill:rgba(0, 0, 0, 0.8);width:23px;height:23px;"><use xlink:href="#ion-ios-close-empty"></use></svg></button>' + '<div style="width:100%;border-top:#ececec 1px solid;display:flex">' + '<button title="' + out('Outline') + '" class="cell-outline"><svg class="is-icon-flex" style="fill:rgba(0, 0, 0, 0.8);width:14px;height:14px;"><use xlink:href="#ion-ios-grid-view-outline"></use></svg></button>' + '<button title="' + out('Element Tool') + '" class="cell-elmtool"><svg class="is-icon-flex" style="fill:rgba(0, 0, 0, 0.7);width:12px;height:12px;"><use xlink:href="#ion-ios-gear"></use></svg></button>' + '</div>' + '</div>') + '' + '</div>' + '' + '<div class="is-modal viewconfig">' + '<div style="width:100%;max-width:700px;padding:5px 12px 12px 20px">' + '<div style="font-weight:600;text-align:center;">' + out('Preferences') + '</div>' + '<div style="display:flex;flex-wrap:wrap;width:100%;">' + '<div>' + '<label style="display:block;margin-top:14px;margin-bottom:5px;">' + out('Builder Mode') + ':&nbsp;' + '<select class="select-buildermode">' + '<option value="">' + out('Default') + '</option>' + '<option value="minimal">' + out('Minimal') + '</option>' + '<option value="clean">' + out('Clean') + '</option>' + '</select>' + '</label>' + '<label style="display:block;margin-top:14px;margin-bottom:10px;">' + '<input class="input-hiderowcoloutline" type="checkbox" /> ' + out('Hide outline') + '&nbsp;' + '</label>' + (!plugin.settings.emailMode ? '<label style="display:block;margin-top:14px;margin-bottom:10px;">' + '<input class="input-hidecelltool" type="checkbox" /> ' + out('Hide column tool') + '&nbsp;' + '</label>' : '') + (!plugin.settings.emailMode ? '<label style="display:block;margin-top:14px;margin-bottom:10px;">' + '<input class="input-hidecolhtmleditor" type="checkbox" /> ' + out('Hide column HTML editor') + '&nbsp;' + '</label>' : '') + '<label style="display:block;margin-top:14px;margin-bottom:10px;">' + '<input class="input-hiderowhtmleditor" type="checkbox" /> ' + out('Hide row HTML editor') + '&nbsp;' + '</label>' + (bSideSnippets ? '<label style="display:block;margin-top:14px;margin-bottom:10px;">' + '<input class="input-hiderowmovebuttons" type="checkbox" /> ' + out('Hide row move (up/down) buttons') + '&nbsp;' + '</label>' : '') + '<label style="display:block;margin-top:14px;margin-bottom:10px;">' + '<input class="input-hideelementtool" type="checkbox" /> ' + out('Hide element tool') + '&nbsp;' + '</label>' + '<label style="display:block;margin-top:14px;margin-bottom:10px;">' + '<input class="input-hideelementhighlight" type="checkbox" /> ' + out('Hide element highlight') + '&nbsp;' + '</label>' + '<label style="display:block;margin-top:5px;margin-bottom:5px;">' + out('Row tool position') + ':&nbsp;' + '<select class="select-rowtool">' + '<option value="right">' + out('Right') + '</option>' + '<option value="left">' + out('Left') + '</option>' + '</select>' + '</label>' + '<label style="display:block;margin-top:5px;margin-bottom:5px;">' + out('Add (+) button placement') + ':&nbsp;' + '<select class="select-addbuttonplace" style="margin-top:5px">' + '<option value="">' + out('Default') + '</option>' + '<option value="between-blocks-left">' + out('Between Blocks (left)') + '</option>' + '<option value="between-blocks-center">' + out('Between Blocks (center)') + '</option>' + '</select>' + '</label>' + '</div>' + '<div style="padding-top: 0px;">' + (!plugin.settings.emailMode ? '<label style="display:block;margin-top:14px;margin-bottom:5px;">' + out('Outline Mode') + ':&nbsp;' + '<select class="select-outlinemode">' + '<option value="">' + out('Row & column') + '</option>' + '<option value="row">' + out('Row only') + '</option>' + '</select>' + '</label>' : '<div style="height:60px"></div>') + (typeof jQuery.ui !== 'undefined' ? '<label style="display:block;margin-top:14px;margin-bottom:10px;">' + '<input class="input-dragwithouthandle" type="checkbox" /> ' + out('Draggable blocks without handle') + '&nbsp;' + '</label>' + '<label style="display:block;margin-top:14px;margin-bottom:10px;">' + '<input class="input-animatedsorting" type="checkbox" /> ' + out('Animated drag to sort') + '&nbsp;' + '</label>' : '') + (bSideSnippets && plugin.settings.snippetList == '#divSnippetList' ? '<label style="display:block;margin-top:14px;margin-bottom:10px;">' + '<input class="input-opensnippets" type="checkbox" /> ' + out('Open snippets sidebar on start') + '&nbsp;' + '</label>' : '') + '<label style="display:block;margin-top:14px;margin-bottom:10px;">' + '<input class="input-advancedhtmleditor" type="checkbox" /> ' + out('HTML syntax highlighting') + '&nbsp;' + '</label>' + '<label style="display:block;margin-top:14px;margin-bottom:5px;">' + out('Toolbar visibility') + ':&nbsp;' + '<select class="select-editingtoolbardisplay">' + '<option value="auto">' + out('Auto') + '</option>' + '<option value="always">' + out('Always Visible') + '</option>' + '</select>' + '</label>' + '<label style="' + (bIsAppleMobile ? 'display:none;' : 'display:block;') + 'margin-top:5px;margin-bottom:5px;">' + out('Toolbar position') + ':&nbsp;' + '<select class="select-editingtoolbar">' + '<option value="top">' + out('Top') + '</option>' + '<option value="left">' + out('Left') + '</option>' + '<option value="right">' + out('Right') + '</option>' + '</select>' + '</label>' + '<label style="' + (bIsAppleMobile ? 'display:none;' : 'display:block;') + 'margin-top:5px;margin-bottom:10px;">' + '<input class="input-scrollableeditor" type="checkbox" /> ' + out('Scrollable toolbar (top only)') + '&nbsp;' + '</label>' + '<label style="display:block;margin-top:5px;margin-bottom:5px;">' + out('Paste result') + ':&nbsp;' + '<select class="select-pasteresult">' + '<option value="html-without-styles">' + out('HTML (without styles)') + '</option>' + '<option value="html">' + out('HTML (with styles)') + '</option>' + '<option value="text">' + out('Text only') + '</option>' + '</select>' + '</label>' + '</div>' + '</div>' + '<div style="text-align:right;margin-top:30px">' + '<button title="' + out('Cancel') + '" class="input-cancel classic-secondary">' + out('Cancel') + '</button>' + '<button title="' + out('Ok') + '" class="input-ok classic-primary">' + out('Ok') + '</button>' + '</div>' + '</div>' + '</div>' + '' + '<div class="is-modal viewhtml">' + '<div style="width:80%;max-width:1200px;height:80%;padding:0;box-sizing:border-box;position:relative;">' + '<textarea class="tabSupport" style="width:100%;height:100%;border:none;border-bottom:60px solid transparent;margin:0;box-sizing:border-box;"></textarea>' + '<button title="' + out('Enlarge') + '" class="cell-html-larger" style="width:35px;height:35px;position:absolute;right:20px;top:0;background:#fff;"><svg class="is-icon-flex" style="width:19px;height:19px;fill:rgb(170, 170, 170);"><use xlink:href="#ion-arrow-expand"></use></svg></button>' + '<div style="width:100%;height:50px;position:absolute;left:0;bottom:0;border-top: #efefef 1px solid;overflow:hidden;text-align:right">' + '<button title="' + out('Cancel') + '" class="cell-html-cancel classic-secondary">' + out('Cancel') + '</button>' + '<button title="' + out('Ok') + '" class="cell-html-ok classic-primary">' + out('Ok') + '</button>' + '</div>' + '</div>' + '</div>' + '' + '<div class="is-modal viewhtmlformatted">' + '<div style="width:80%;max-width:1200px;height:80%;padding:0;box-sizing:border-box;position:relative;overflow:hidden;">' + '<iframe id="ifrHtmlFormatted" style="width:100%;height:100%;border:none;margin:0;box-sizing:border-box;" src="about:blank"></iframe>' + '<textarea style="position:absolute;display:none;"></textarea>' + '<button title="' + out('Enlarge') + '" class="cell-html-larger" style="width:35px;height:35px;position:absolute;right:20px;top:0;background:#fff;"><svg class="is-icon-flex" style="width:19px;height:19px;fill:rgb(170, 170, 170);"><use xlink:href="#ion-arrow-expand"></use></svg></button>' + '<div style="display:none">' + '<button title="' + out('Cancel') + '" class="input-cancel classic-secondary">' + out('Cancel') + '</button>' + '<button title="' + out('Ok') + '" class="input-ok classic-primary">' + out('Ok') + '</button>' + '</div>' + '</div>' + '</div>' + '' + '<div class="is-modal viewhtmllarger" style="align-items:flex-end;">' + '<div style="width:100%;height:100%;border:none;padding:0;">' + '<iframe id="ifrHtml" style="width:100%;height:100%;border: none;" src="about:blank"></iframe>' + '</div>' + '</div>' + '' + '<div class="is-modal snippets">' + '<div style="max-width:1250px;height:90%;padding:0;">' + '<iframe style="width:100%;height:100%;border: none;display: block;" src="about:blank"></iframe>' + '</div>' + '</div>' + '' + '<div class="is-modal delconfirm">' + '<div style="max-width:526px;text-align:center;">' + '<p>' + out('Are you sure you want to delete this block?') + '</p>' + '<button title="' + out('Delete') + '" class="input-ok classic">' + out('Delete') + '</button>' + '</div>' + '</div>' + '' + '<div class="is-tool mobile-tool">' + '<button title="' + out('Back') + '" class="mobile-close"><svg class="is-icon-flex" style="fill: rgb(53, 53, 53);width:20px;height:20px;"><use xlink:href="#ion-ios-redo"></use></svg></button>' + '</div>' + '' + '<div class="is-modal fileselect">' + '<div style="max-width:800px;height:80%;padding:0;">' + '<iframe style="width:100%;height:100%;border: none;display: block;" src="about:blank"></iframe>' + '</div>' + '</div>' + '' + '<div class="is-modal imageselect">' + '<div style="max-width:800px;height:80%;padding:0;">' + '<iframe style="width:100%;height:100%;border: none;display: block;" src="about:blank"></iframe>' + '</div>' + '</div>' + '' + '<div id="divTemporaryContent" style="position:absolute;top:0;left:0;width:1px;height:1px;overflow:hidden;visibility:hidden;"></div>' + '' + '<div id="divImgResizer" style="display:none;background:transparent;position:absolute;box-sizing:border-box;z-index:1">' + '<div class="ui-resizable-handle ui-resizable-ne"></div>' + '<div class="ui-resizable-handle ui-resizable-se"></div>' + '<div class="ui-resizable-handle ui-resizable-sw"></div>' + '<div class="ui-resizable-handle ui-resizable-nw"></div>' + '</div>' + '' + '<div id="divSnippetDragHelper" style="display:none;background:red;position:absolute;box-sizing:border-box;z-index:100000">' + '</div>' + '';
                var html_colors = '';
                ...
                if (typeof jQuery.ui !== 'undefined') {
                    ...
                    jQuery("#divImgResizer").on('click', function () {
                        ...
                        if (_imagetoolwidth + _left > _screenwidth) _left = $img.offset().left;
                ...
                if (bSideSnippets) {
                    ...
                    if (!this.settings.emailMode) {
                        ...
                        var html_snippets = '' + '<div style="position:absolute;top:0;right:0;padding: 0;width:100%;z-index:2;">' + '<select id="selSnippetCat">' + html_catselect + '</select>' + '</div>' + (this.settings.sidePanel == 'right' ? '<div id="divSnippetScrollUp" style="top:calc(50% - 27px);right:25px;">&#9650;</div>' + '<div id="divSnippetScrollDown" style="top:calc(50% + 27px);right:25px;">&#9660;</div>' + '<div id="divSnippetHandle" style="' + sHideHandle + '">' + '<svg class="is-icon-flex" style="width:17px;height:17px;fill:rgba(0, 0, 0, 0.75);"><use xlink:href="#ion-ios-arrow-left"></use></svg>' + '</div>' : '<div id="divSnippetScrollUp" style="top:calc(50% - 27px);left:10px;">&#9650;</div>' + '<div id="divSnippetScrollDown" style="top:calc(50% + 27px);left:10px;">&#9660;</div>' + '<div id="divSnippetHandle" style="' + sHideHandle + '">' + '<svg class="is-icon-flex" style="width:17px;height:17px;fill:rgba(0, 0, 0, 0.75);"><use xlink:href="#ion-ios-arrow-right"></use></svg>' + '</div>') + '<div class="is-design-list"></div>';
                        var defaultcat = this.settings.defaultSnippetCategory
                    } else {
                        var html_catselect = '';
                        ...
                        var html_snippets = '' + '<div style="position:absolute;top:0;right:0;padding: 0;width:100%;z-index:2;">' + '<select id="selSnippetCat">' + html_catselect + '</select>' + '</div>' + (this.settings.sidePanel == 'right' ? '<div id="divSnippetScrollUp" style="top:calc(50% - 27px);right:25px;">&#9650;</div>' + '<div id="divSnippetScrollDown" style="top:calc(50% + 27px);right:25px;">&#9660;</div>' + '<div id="divSnippetHandle" style="' + sHideHandle + '">' + '<svg class="is-icon-flex" style="width:17px;height:17px;fill:rgba(0, 0, 0, 0.75);"><use xlink:href="#ion-ios-arrow-left"></use></svg>' + '</div>' : '<div id="divSnippetScrollUp" style="top:calc(50% - 27px);left:10px;">&#9650;</div>' + '<div id="divSnippetScrollDown" style="top:calc(50% + 27px);left:10px;">&#9660;</div>' + '<div id="divSnippetHandle" style="' + sHideHandle + '">' + '<svg class="is-icon-flex" style="width:17px;height:17px;fill:rgba(0, 0, 0, 0.75);"><use xlink:href="#ion-ios-arrow-right"></use></svg>' + '</div>') + '<div class="is-design-list">' + '</div>';
                        var defaultcat = this.settings.defaultEmailSnippetCategory
                    }
                    ...
                    jQuery('.is-design-list > div').draggable({
                        ...
                        start: function () {
                            jQuery('.is-builder').each(function () {
                                if (jQuery(this).find('.dummy-space').length == 0) {
                                    if (jQuery(this).children('div').not('.dummy-space').length != 0) {
                                        jQuery(this).append('<div class="dummy-space" style="clear: both; line-height: 100px;outline:none !important;">&nbsp;</div>')
                                    } else {
                                        jQuery(this).append('<div class="dummy-space" style="clear: both; line-height: 30px;outline:none !important;">&nbsp;</div>')
                                    }
                                }
                            })
                        }
                    ...
                    jQuery('#divSnippetScrollUp').on("click touchup", function (e) {
                        jQuery(".is-design-list").animate({
                            scrollTop: (jQuery(".is-design-list").scrollTop() - (jQuery(".is-design-list").height() - 150)) + "px"
                        }, 300, function () {
                ...
                jQuery('html').on('click touchstart', function (e) {
                    ...
                    if (jQuery(e.target).parents('#divElementTool').length > 0) {
                        return
                    }
                    ...
                    if (jQuery(e.target).hasClass('sl-overlay')) return;
                    if (jQuery(e.target).parents('.sl-wrapper').length > 0) return;
                    ...
                    if (jQuery('.is-side.snippetlist').hasClass('active') && (jQuery('body').hasClass('body-fullview') || jQuery('body').hasClass('body-fullview-left'))) {
                        ...
                        if (jQuery("#divSpacerTool").css("display") == 'block') {
                            jQuery("#divSpacerTool").css("display", "none");
                            setTimeout(function () {
                                var $block = jQuery('#divCellTool').data('active');
                                $block.find('div').trigger('click')
                            }, 700)
                        }
                        setTimeout(function () {
                ...
                jQuery(window).on('resize', function (e) {
                    ...
                    jQuery(".cell-active").removeClass("cell-active");
                    plugin.positionToolbar();
                    if (jQuery(e.target).parents('#divImgResizer').length > 0 || jQuery(e.target).attr('id') == 'divImgResizer') {} else {
                        jQuery("#divImgResizer").css("display", "none")
                    }
                });
            ...
            if (jQuery(plugin.settings.page).length == 1) {
                ...
                if ($block) {
                    ...
                    $wrapper = jQuery(plugin.settings.container).first()
                }
            }
            ...
            jQuery('.cell-add-list').on('click', function (e) {
                plugin.addContent('<ul style="list-style: initial;padding-left: 20px;">' + '<li>Lorem Ipsum is simply dummy text</li>' + '<li>Lorem Ipsum is simply dummy text</li>' + '</ul>')
            });
            ...
            jQuery('.cell-add-button').on('click', function (e) {
                plugin.addContent('<div>' + '<a href="#" style="display:inline-block;text-decoration:none;transition: all 0.16s ease;border-style:solid;cursor:pointer;background-color: rgb(220, 220, 220); color: rgb(0, 0, 0); border-color: rgb(220, 220, 220); border-width: 2px; border-radius: 0px; padding: 13px 28px; line-height: 1.5; text-transform: uppercase; font-weight: 400; font-size: 14px; letter-spacing: 3px;">Read More</a>' + '</div>')
            });
            ...
            jQuery('#divRowAddTool button').on('click', function () {
                ...
                if (parseInt(jQuery('#divRowAddTool button').css('left')) < 0) {
            ...
            jQuery('.element-edit').on('click', function (e) {
                ...
                jQuery('#inpElmBorderWidth').on('keyup', function () {
                    ...
                    var val = jQuery(this).val();
                    if (!isNaN(val) && val != '') {
                        $elm_selected.css('border-style', 'solid');
                ...
                jQuery('#inpElmBorderTopWidth').on('keyup', function () {
                    ...
                    var val = jQuery(this).val();
                    if (!isNaN(val) && val != '') {
                        $elm_selected.css('border-top-style', 'solid');
                ...
                jQuery('#inpElmBorderBottomWidth').on('keyup', function () {
                    ...
                    var val = jQuery(this).val();
                    if (!isNaN(val) && val != '') {
                        $elm_selected.css('border-bottom-style', 'solid');
                ...
                jQuery('#inpElmBorderLeftWidth').on('keyup', function () {
                    ...
                    var val = jQuery(this).val();
                    if (!isNaN(val) && val != '') {
                        $elm_selected.css('border-left-style', 'solid');
                ...
                jQuery('#inpElmBorderRightWidth').on('keyup', function () {
                    ...
                    var val = jQuery(this).val();
                    if (!isNaN(val) && val != '') {
                        $elm_selected.css('border-right-style', 'solid');
            ...
            jQuery('.cell-format').on('click', function (e) {
                ...
                if (!command) command = jQuery(e.target).parent().data('command');
                var text = getSelected();
                try {
                    var el;
                    var curr;
                ...
                if (jQuery.trim(text) == '') {
                    plugin.restoreSelection();
                    if (bIsAppleMobile) jQuery(this).focus()
                }
                plugin.settings.onChange()
            });
            ...
            jQuery('.cell-color-options button').not('.input-more,.input-mode').on('click', function (e) {
                ...
                var mode = jQuery('.cell-color-options').data('mode');
            ...
            jQuery('.cell-block-options > div > div').on('click', function (e) {
                ...
                if (bIsAppleMobile) jQuery('.cell-block').focus()
            });
            ...
            jQuery('.cell-tags').on('click', function (e) {
                ...
                jQuery('.cell-tag-options button').click(function () {
                    ...
                    plugin.saveSelection();
                    plugin.settings.onChange();
                    if (bIsAppleMobile) jQuery('.cell-tags').focus()
                })
            });
            ...
            jQuery('.cell-textsettings').on('click', function (e) {
                ...
                jQuery('.div-font-size button, .div-line-height button, .div-letter-spacing button').on('click', function (e) {
                    if (bIsAppleMobile) {
                        jQuery('[contenteditable]').attr('makeeditable', '1');
                        jQuery('[contenteditable]').removeAttr('contenteditable')
                    }
                    plugin.restoreSelection();
                    if (bIsAppleMobile) {
                        jQuery('[makeeditable]').attr('contenteditable', 'true');
                        jQuery('[makeeditable]').removeAttr('makeeditable')
                    }
                    ...
                    plugin.saveSelection();
                    if (bIsAppleMobile) jQuery('.cell-textsettings').focus();
                    plugin.renderLayoutTool(false, true);
                    plugin.getState();
                    plugin.settings.onChange()
                })
            ...
            jQuery('.cell-image').on('click', function (e) {
                ...
                if (sFunc != 'function(){}' || plugin.settings.imageselect != '') {
                    ...
                    $modal.find('.input-select').on('click', function (e) {
                        if (sFunc != 'function(){}') {
                            var $modal = jQuery('.is-modal.insertimage');
                            plugin.settings.onImageSelectClick({
                                targetInput: $modal.find('.input-src').get(0),
                                theTrigger: jQuery(this).get(0)
                            })
                        } else {
            ...
            jQuery('.cell-link').on('click', function (e) {
                ...
                if (sFunc != 'function(){}' || plugin.settings.fileselect != '') {
                    ...
                    $modal.find('.input-select').on('click', function (e) {
                        if (sFunc != 'function(){}') {
                            var $modal = jQuery('.is-modal.createlink');
                            plugin.settings.onFileSelectClick({
                                targetInput: $modal.find('.input-url').get(0),
                                theTrigger: jQuery(this).get(0)
                            })
                        } else {
                ...
                $modal.find('.input-url').trigger('focus');
                $modal.off('keyup');
            ...
            jQuery('#divSpacerTool button').on('click', function (e) {
                ...
                var val = jQuery(this).data('value');
                if (val == '-') {
                    if ($spacer.hasClass('height-300')) {
                        $spacer.removeClass('height-300');
                        $spacer.addClass('height-280')
                    } else if ($spacer.hasClass('height-280')) {
                        $spacer.removeClass('height-280');
                        $spacer.addClass('height-260')
                    } else if ($spacer.hasClass('height-260')) {
                        $spacer.removeClass('height-260');
                        $spacer.addClass('height-240')
                    } else if ($spacer.hasClass('height-240')) {
                        $spacer.removeClass('height-240');
                        $spacer.addClass('height-220')
                    } else if ($spacer.hasClass('height-220')) {
                        $spacer.removeClass('height-220');
                        $spacer.addClass('height-200')
                    } else if ($spacer.hasClass('height-200')) {
                        $spacer.removeClass('height-200');
                        $spacer.addClass('height-180')
                    } else if ($spacer.hasClass('height-180')) {
                        $spacer.removeClass('height-180');
                        $spacer.addClass('height-160')
                    } else if ($spacer.hasClass('height-160')) {
                        $spacer.removeClass('height-160');
                        $spacer.addClass('height-140')
                    } else if ($spacer.hasClass('height-140')) {
                        $spacer.removeClass('height-140');
                        $spacer.addClass('height-120')
                    } else if ($spacer.hasClass('height-120')) {
                        $spacer.removeClass('height-120');
                        $spacer.addClass('height-100')
                    } else if ($spacer.hasClass('height-100')) {
                        $spacer.removeClass('height-100');
                        $spacer.addClass('height-80')
                    } else if ($spacer.hasClass('height-80')) {
                        $spacer.removeClass('height-80');
                        $spacer.addClass('height-60')
                    } else if ($spacer.hasClass('height-60')) {
                        $spacer.removeClass('height-60');
                        $spacer.addClass('height-40')
                    } else if ($spacer.hasClass('height-40')) {
                        $spacer.removeClass('height-40');
                        $spacer.addClass('height-20')
                    } else {}
                } else {
                    if ($spacer.hasClass('height-20')) {
                        $spacer.removeClass('height-20');
                        $spacer.addClass('height-40')
                    } else if ($spacer.hasClass('height-40')) {
                        $spacer.removeClass('height-40');
                        $spacer.addClass('height-60')
            ...
            jQuery('#divCustomModuleTool > button').on('click', function (e) {
                ...
                plugin.showModal($modal, true);
                var d = new Date();
                $modal.find('iframe').attr('src', plugin.settings.modulePath + modulename + '.html?' + d.getTime());
                $modal.find('.input-ok').off('click');
                $modal.find('.input-ok').on('click', function (e) {
                    plugin.saveForUndo();
                    var $block = jQuery("#divCustomCodeTool").data('active');
            ...
            if (mode == 'cell') {
                ...
                if (bIsAppleMobile) {
                    ...
                    if (!plugin.settings.mobileSimpleEdit) {
                        if (customcode || noedit || protected) {} else {
                ...
                $elm = jQuery('#divElementTool').data('active');
                if (!bIsAppleMobile) {
                    moveCursorToElement($elm.get(0), false);
                    plugin.saveSelection();
                    plugin.getState()
                }
                plugin.hideElementTools();
                ...
                jQuery('#divCellTool').data('active', $builder.children().last().children().first());
                var $block = jQuery('#divCellTool').data('active');
                jQuery('#divElementTool').data('active', $block.children().first());
                var bottompos = $snippet.offset().top + $snippet.outerHeight() - jQuery(document).scrollTop();
                var screenheight = jQuery(window).height();
        ...
        plugin.addContentMore = function (html) {
            plugin.saveForUndo();
            ...
            if (mode == 'lastrow') {
                ...
                $builder.append($newBlock);
                jQuery('#divCellTool').data('active', $newBlock.first().children().first())
            } else {
                var $block = jQuery('#divCellTool').data('active');
        ...
        plugin.addButton = function (pluginname, html, selector, exec) {
            var bUseMore = false;
            if (jQuery('#divRteTool').find('[data-plugin=' + pluginname + ']').length > 0) {
                jQuery('#divRteTool').find('[data-plugin=' + pluginname + ']').first().replaceWith(html)
            } else if (jQuery('.cell-rtemore-options').find('[data-plugin=' + pluginname + ']').length > 0) {
        ...
        plugin.moveRowToNextContainer = function ($row) {
            ...
            if ($currContainer.parents('.is-builder').length > 0) return;
            var flag = false;
            jQuery('.is-builder').each(function () {
                if (flag) {
            ...
            jQuery('.is-builder').each(function () {
                jQuery(this).children('div').each(function () {
                    ...
                    if (jQuery(this).html() != '') {
                        if (jQuery(this).find('.is-row-tool').length == 0) {
                            jQuery(this).append('<div class="is-row-tool is-tool" style="top:' + _top + 'px">' + drag_handler + '<button title="' + out('Add') + '" class="row-add"><svg class="is-icon-flex" style="fill:rgba(0, 0, 0, 0.8);width:23px;height:23px;"><use xlink:href="#ion-ios-plus-empty"></use></svg></button>' + '<button title="' + out('Grid Tool') + '" class="row-grideditor"><svg class="is-icon-flex" style="fill:rgba(0, 0, 0, 0.6);width:13px;height:13px;"><use xlink:href="#ion-grid"></use></svg></button>' + '<button title="' + out('Move Up') + '" class="row-up" style="display: block;"><svg class="is-icon-flex" style="fill:rgba(0, 0, 0, 0.7);width:15px;height:15px;"><use xlink:href="#ion-ios-arrow-thin-up"></use></svg></button>' + '<button title="' + out('Move Down') + '" class="row-down" style="display: block;"><svg class="is-icon-flex" style="fill:rgba(0, 0, 0, 0.7);width:15px;height:15px;"><use xlink:href="#ion-ios-arrow-thin-down"></use></svg></button>' + '<button title="' + out('Duplicate') + '" class="row-duplicate" style="display: block;"><svg class="is-icon-flex" style="width:14px;height:14px;"><use xlink:href="#ion-ios-photos-outline"></use></svg></button>' + '<button title="' + out('HTML') + '" class="row-html"><svg class="is-icon-flex" style="margin-right:-3px;fill:rgba(0, 0, 0, 0.65);width:14px;height:14px;"><use xlink:href="#ion-ios-arrow-left"></use></svg><svg class="is-icon-flex" style="margin-left:-2px;fill:rgba(0, 0, 0, 0.65);width:14px;height:14px;"><use xlink:href="#ion-ios-arrow-right"></use></svg></button>' + '<button title="' + out('Delete') + '" class="row-remove"><svg class="is-icon-flex" style="fill:rgba(0, 0, 0, 0.8);width:23px;height:23px;"><use xlink:href="#ion-ios-close-empty"></use></svg></button></div>' + '</div>')
                        }
                    }
                ...
                jQuery(this).children().children().not('.is-row-tool').each(function () {
                    ...
                    jQuery(this).find('a').each(function () {
                        ...
                        if(  jQuery(this).parents('.custom-module[data-modulename="DNNGo.AddModule"]').length) return ;
                        
                        if (jQuery(this).css('display') == 'inline-block' || jQuery(this).css('display') == 'inline-flex') {
                    ...
                    jQuery(this).off('click');
                    jQuery(this).on('click', function (e) {
                        if($(e.target).parents('.custom-module[data-modulename="DNNGo.AddModule"]').length) return $(e.target).parents('.custom-module[data-modulename="DNNGo.AddModule"]').trigger("click");
                        ...
                        if (bIsAppleMobile) {
                            ...
                            if (plugin.settings.mobileSimpleEdit) {
                                ...
                                if (customcode || noedit || protected) {
                                    ...
                                    if (bIsBlockHasEditableText) {
                                        if (!jQuery(this).hasClass('cell-active') && jQuery(this).parent().find('.cell-active').length == 0 || ((jQuery(this).hasClass('cell-active') && jQuery(this).parent().find('.cell-active').length > 0) && jQuery(this).attr('contenteditable') != 'true')) {
                                            jQuery('[contenteditable]').not(this).removeAttr('contenteditable');
                                            jQuery(this).attr('contenteditable', 'true');
                        ...
                        if (customcode || noedit || protected) {
                            jQuery("#divElementTool").css("display", "none");
                            jQuery("#divElementTool").data('active', jQuery('#divCellTool').data('active'));
                            jQuery("#divElementTool").data('active-inspected', jQuery('#divCellTool').data('active'))
                        } else {
                            var tagname = jQuery(e.target).prop("tagName").toLowerCase();
                            jQuery("#divElementTool").data('active-inspected', jQuery(e.target));
                            if (tagname == 'h1' || tagname == 'h2' || tagname == 'h3' || tagname == 'h4' || tagname == 'h5' || tagname == 'h6' || tagname == 'p' || tagname == 'pre' || tagname == 'blockquote' || tagname == 'li' || tagname == 'img' || tagname == 'iframe') {
                                ...
                                jQuery("#divElementTool").data('active', jQuery(e.target))
                            } else {
                                if (jQuery(e.target).hasClass('cell-active')) {
                                    ...
                                    jQuery(e.target).parents().each(function () {
                                        ...
                                        if (tagname == 'h1' || tagname == 'h2' || tagname == 'h3' || tagname == 'h4' || tagname == 'h5' || tagname == 'h6' || tagname == 'p' || tagname == 'pre' || tagname == 'blockquote' || tagname == 'li' || tagname == 'img' || tagname == 'iframe') {
                                            ...
                                            if (!bNoElmTool) jQuery("#divElementTool").css("display", "block");
                                            jQuery("#divElementTool").data('active', jQuery(this));
                                            return false
                        ...
                        if (jQuery('.elementstyles').hasClass('active')) {
                            jQuery('.element-edit').trigger('click');
                            return false
                        }
                        var $block = jQuery('#divCellTool').data('active');
                        if (parseInt(jQuery('body').css('margin-right')) != 0 || parseInt(jQuery('body').css('margin-left')) != 0) {
                            setTimeout(function () {
                                plugin.renderLayoutTool()
                            }, 301)
                        } else {
                        ...
                        if (bSideSnippets) {
                            ...
                            if (bIsAppleMobile && _screenwidth <= 1024) {
                                if ((plugin.settings.sidePanel == 'right' && plugin.settings.rowTool == 'right') || (plugin.settings.sidePanel == 'left' && plugin.settings.rowTool == 'left')) {
                        ...
                        if (jQuery(e.target).prop("tagName").toLowerCase() == 'img') {
                            ...
                            if (!fixedimage) {
                                ...
                                if (typeof jQuery.ui !== 'undefined') {
                                    ...
                                    if (bIsAppleMobile) jQuery(".cell-image").focus()
                                }
                            }
                        } else {
                            jQuery("#divImageTool").css("display", "none");
                        ...
                        if (jQuery(e.target).parents('table').length > 0) {
                            if (jQuery(e.target).parents('table').first().hasClass('default')) {
                                ...
                                jQuery("#divTableTool").data('active', $cell);
                            ...
                            $block.find('*').each(function () {
                                ...
                                if (typeof attr !== typeof undefined && attr !== false) {
                                    if (attr.indexOf('font-size') != -1) {
                                        ...
                                        if (typeof attrkeep !== typeof undefined && attrkeep !== false) {} else {
                ...
                if (plugin.settings.animatedSorting) {
                    ...
                    jQuery('.is-builder').each(function () {
                        jQuery(this).sortable({
                            ...
                            handle: '.row-handle',
                            cursor: 'move',
                            cancel: 'p,h1,h2,h3,h4,h5,h6,ul,ol,pre,blockquote,code,figcaption,label,legend,button,nav,small,span,u,em,strong,b,strike,i,var,time,sub,sup,cite,abbr,address,dl,del,ins,details,mark,meter,q,s,table',
                            tolerance: 'pointer',
                            placeholder: 'marker',
                            helper: function (event, ui) {
                            ...
                            start: function (e, ui) {
                                ...
                                if (ui.item.data('height')) uiHeight = ui.item.data('height');
            ...
            jQuery('.is-builder').each(function () {
                if (jQuery(this).children('div').not('.dummy-space').length == 0) {
                    ...
                    jQuery(this).find('.row-add-initial').on('click', function (e) {
                        jQuery('#divCellTool').data('active', jQuery(this).find('span'));
                        jQuery(".cell-add-options").data('mode', 'row');
                ...
                } else if (jQuery(this).children().length == 1 && jQuery(this).find('.row-add-initial').length == 1) {} else {
        ...
        plugin.refreshToolbar = function () {
            ...
            if (plugin.settings.toolbar == 'top') {
                if (plugin.settings.scrollableEditingToolbar) {
                    if (jQuery('.cell-tool-next').css('display') == 'none' && jQuery('.cell-tool-prev').css('display') == 'none') {
                        jQuery('.cell-tool-option-container').css('width', (buttonWidth * 7) + 'px');
            ...
            plugin.positionToolbar();
            initialRteWidth = jQuery('.cell-tool-option-container').outerWidth()
        };
        plugin.renderLinkTool = function () {
            var $link = jQuery("#divLinkTool").data('active');
            if ($link.css('display') == 'inline-block' || $link.css('display') == 'inline-flex') {
        ...
        plugin.renderLayoutTool = function (rowAction, controlStay) {
            ...
            if (rowAction) {
                ...
                jQuery('.is-row-tool').css('display', '');
                if ($block.parents('.is-builder').length > 1) {} else {
                    $block.parent().find('.is-row-tool').last().css("display", "block");
                    if (plugin.settings.builderMode == 'clean' && jQuery('.is-modal.grideditor').hasClass('active')) {
                        $block.parent().find('.is-row-tool').last().css("display", "none")
                    }
            ...
            if ($block.parents('[between-blocks-left],[between-blocks-center]').length > 0) {
                ...
                if ($block.parents('[between-blocks-center]').length > 0) {
                    if (bIsAppleMobile) {
                        ...
                        jQuery("#divRowAddTool button svg").css('margin-left', '-1px')
                    }
                }
            }
            plugin.renderElementTool();
        ...
        plugin.hideModal = function ($modal) {
            ...
            $modal.removeClass('active');
            if (jQuery('body').hasClass('full-edit')) {
                jQuery('.mobile-edit').css('transform', '')
            } else {
                if (jQuery(plugin.settings.page).length == 1) {
        ...
        plugin.showModal = function ($modal, overlayStay, controlStay, cancelCallback, animated) {
            ...
            if (animate) {
                if (jQuery('body').hasClass('full-edit')) {
                    jQuery('.mobile-edit').css('transform', 'scale(0.98)')
                } else {
                    if (jQuery(plugin.settings.page).length == 1) {
        ...
        plugin.viewSnippets = function (opensidebar) {
            if (opensidebar && bSideSnippets) {
                ...
                jQuery(".cell-add-options").data('mode', 'lastrow');
                plugin.hideElementTools();
                var $modal = jQuery('.is-modal.snippets');
                $modal.addClass('active');
                if ($modal.find('iframe').attr('src') == 'about:blank') {
        ...
        plugin.viewRowHtml = function () {
            ...
            if (plugin.settings.htmlSyntaxHighlighting) {
                var $modal = jQuery('.is-modal.viewhtmlformatted');
                var html = plugin.readHtml($block.parent(), true);
                $modal.find('textarea').val(html);
                jQuery('textarea').removeAttr('data-source-active');
                jQuery('textarea').removeAttr('data-source-ok');
                jQuery('textarea').removeAttr('data-source-cancel');
        ...
        plugin.viewHtml = function ($area) {
            if (plugin.settings.htmlSyntaxHighlighting) {
                var $modal = jQuery('.is-modal.viewhtmlformatted');
                if ($area) {
                    var html = plugin.readHtml($area, true)
                } else {
                    var html = plugin.readHtml($wrapper, true)
                }
                $modal.find('textarea').val(html);
                jQuery('textarea').removeAttr('data-source-active');
                jQuery('textarea').removeAttr('data-source-ok');
        ...
        plugin.html = function ($area) {
            ...
            if ($area === undefined) {
                var html = plugin.readHtml($wrapper)
            } else {
                var html = plugin.readHtml($area)
            }
            return html
        };
        var hash = {};
        ...
        plugin.readHtml = function ($content, view, multiple) {
            jQuery('#tmp_content').remove();
            jQuery('#tmp_buildercontent').remove();
            jQuery('body').append('<div id="tmp_content" style="position:absolute;top:0;left:0;width:1px;height:1px;overflow:hidden;visibility:hidden;"></div>' + '<div id="tmp_buildercontent" style="position:absolute;top:0;left:0;width:1px;height:1px;overflow:hidden;visibility:hidden;"></div>');
            ...
            $tmp.find("[data-html]").each(function () {
                ...
                for (var i = 1; i <= 20; i++) {
                    blockhtml = blockhtml.replace('[%HTML' + i + '%]', ($block.attr('data-html-' + i) === undefined ? '' : decodeURIComponent($block.attr('data-html-' + i))))
                }
            ...
            if (view) {
                ...
                $tmp.find("[data-html]").each(function () {
                    ...
                    for (var i = 1; i <= 20; i++) {
                        if ($block.attr('data-html-' + i) === undefined) {} else {
                            var uniqueID = makeid();
                            hash[uniqueID] = $block.attr('data-html-' + i);
                            $block.attr('data-html-' + i, uniqueID)
                        }
                    }
                    if ($block.attr('data-settings') === undefined) {} else {
                        var uniqueID = makeid();
            ...
            $tmp.find('.is-builder').css('transform', '');
            $tmp.find('.ui-sortable').removeClass('ui-sortable');
        ...
        plugin.renderCustomCodeBlock = function ($block, html) {
            ...
            html = html.replace(/{id}/g, makeid());
            for (var i = 1; i <= 20; i++) {
                html = html.replace('[%HTML' + i + '%]', ($block.attr('data-html-' + i) === undefined ? '' : decodeURIComponent($block.attr('data-html-' + i))))
            }
            $block.html(html)
        };
        ...
        plugin.applyFont = function () {
            ...
            if (!bElmMode) {
                plugin.saveSelection();
                if (bIsAppleMobile) jQuery('.cell-fontfamily').focus();
                plugin.getState()
            }
            setTimeout(function () {
                plugin.renderRowAddTool();
            ...
            jQuery('body').find('[data-rel="_del"]').remove()
        };
        ...
        plugin.getGradient = function (input) {
            var result, regExpLib = generateRegExp(),
        ...
        plugin.doUndo = function () {
            ...
            if (jQuery('.elementstyles').hasClass('active')) {
                if (jQuery('[data-saveforundo]').length == 1) {
                    ...
                    jQuery('.is-modal-overlay').trigger('click');
                    jQuery('.elementstyles .is-side-close').trigger('click')
                }
            }
        };
    ...
    function processImage(file, targetImg, processImageDone) {
        if (!file) {
            processImageDone();
            return false
        }
    ...
    function generateRegExp() {
        var searchFlags = 'gi',
            ...
            rColorStopSearch = combineRegExp(['\\s*(', rColor, ')', '(?:\\s+', '(', rValue, '))?', '(?:', rComma, '\\s*)?'], searchFlags);
        return {
...
function _imgLoaded(obj) {
    ...
    jQuery.colorpicker = function (element, options) {
        ...
        plugin.init = function () {
            ...
            var html = '<div style="width:55px;height:50px;border:1px solid rgba(53, 53, 53, 0.28);border-right:none;box-sizing:border-box;"></div>' + '<button title="Select Color" style="width:55px;height:50px;border:1px solid rgba(53, 53, 53, 0.28)"><svg class="is-icon-flex" style="fill:rgba(0, 0, 0, 0.8);width:12px;height:12px;"><use xlink:href="#ion-contrast"></use></svg></button>';
            $element.html(html);
