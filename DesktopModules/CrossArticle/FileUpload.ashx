<%@ WebHandler Language="C#" Class="Cross.Modules.Article.SilverlightFileUpload.FileUpload" %>
// see License.txt
using System;
using System.Web;
using Cross.DNN.Common.SilverlightUpload;
namespace Cross.Modules.Article.SilverlightFileUpload
{
    public class FileUpload : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            FileUploadProcess fileUpload = new FileUploadProcess(DotNetNuke.Common.Globals.ApplicationMapPath + "\\DesktopModules\\CrossArticle\\Temp\\",
                allowedExtensions);
