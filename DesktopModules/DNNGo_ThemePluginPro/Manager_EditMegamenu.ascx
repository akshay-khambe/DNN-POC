<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Manager_EditMegamenu.ascx.cs" Inherits="DNNGo.Modules.ThemePluginPro.Manager_EditMegamenu"  %>
        ...
        <div>
          <div class="col-sm-2">
            <div class="form-group">
              <label  class="control-label">Tab Type:</label>
              <div class="control-cont">
                <asp:DropDownList ID="ddlMenuType" runat="server" CssClass="form-control"></asp:DropDownList>
              </div>
            </div>
          </div>
          <div class="col-sm-2 conditional" data-condition="#MegaMenu_ddlMenuType != '0'">
            <div class="form-group">
              <label  class="control-label">Width:</label>
              <div class="control-cont">
                <select class="form-control" id="showMegaMenuWidth">
                  <option value="Auto">Auto</option>
                  <option value="Custom">Custom</option>
                </select>
                <div class="conditional row" data-condition="#showMegaMenuWidth == 'Custom'"><p></p> 
									<div class="col-sm-7">
										<asp:TextBox ID="txtMegaMenuWidth" runat="server" CssClass="form-control "></asp:TextBox>
									</div>
									<div style="margin-top: 15px;">px</div>
								</div>
              </div>
            </div>
          </div>
          <div class="col-sm-2 conditional" data-condition="#MegaMenu_ddlMenuType  != '0'">
            <div class="form-group">
              ...
              <div class="control-cont">
                <asp:DropDownList ID="ddlMegaPosition" runat="server" CssClass="form-control"></asp:DropDownList>
              </div>
            </div>
          </div>
          <div class="col-sm-2 conditional" data-condition="#MegaMenu_ddlMenuType == '1'">
            <div class="form-group">
              <label  class="control-label">Column:</label>
              <div class="control-cont">
                <asp:TextBox ID="txtMegaColumn" runat="server" CssClass="form-control "></asp:TextBox>
              </div>
            </div>
          </div>
        </div>
...
<div id="MegaMenuBox" class="conditional" data-condition="#MegaMenu_ddlMenuType == '2'">
...
<li class="dragList ${TagList}" data-tag="${TagList}" data-id="${ID}">
	<div class="panel-heading">
		...
		<div class="panel-tools">
			...
			<a class="btn btn-xs btn-primary"  href="#typedataedit" data-toggle="modal" title="Edit Control"><i class='fa fa-edit'></i> Edit</a> 
...
{{if RowType == 0}}
  ...
  <div class="modal-body form-horizontal" style="min-height:300px">
...
<div class="pageMenu" style="display:none;">
	<div class="select form-control form_default">Please Select</div>
...
jQuery.ajax({
	...
	success : function (data) {
		...
		box.find(".itme").on("click", function () {
			...
			MenuList.find(".select").html(mn?mn:"Please Select");
...
if($("#MegaMenu_txtMegaMenuWidth").val()!=0){
	$("#showMegaMenuWidth").find('option[value="Custom"]').attr("selected","selected");
}


$("#showMegaMenuWidth").on("change", function () {
	if ($(this).find("option:selected").text() == "Auto") {
		$("#MegaMenu_txtMegaMenuWidth").attr("value","0");
	}else{
		if($("#MegaMenu_txtMegaMenuWidth").val()==0){
			$("#MegaMenu_txtMegaMenuWidth").val("700")
		}
	}
})
