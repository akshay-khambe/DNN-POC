    ...
    <div class="col-sm-12">
        ...
        <div class="page-header">
            <h1>
                ...
                <%=ViewResourceText("Header_Title", "Post Settings")%></h1>
        </div>
    ...
    <div class="col-sm-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                ...
                <%=ViewTitle("lblPostSettings", "Post Form Data Settings")%>
            ...
            <div class="panel-body">
                <div class="form-horizontal">
                    ...
                    <div class="form-group">
                        <%=ViewControlTitle("lblPostEnable", "Enable", "cbPushEnable", ":", "col-sm-3 control-label")%>
                        <div class="col-sm-9">
                    ...
                    <div class="form-group hide">
                        <%=ViewControlTitle("lblPushType", "Push Type", "ddlPushType", ":", "col-sm-3 control-label")%>
                        <div class="col-sm-9">
                            <div class="control-inline">
                                <asp:DropDownList ID="ddlPushType" runat="server" CssClass="form-control validate[required]" Width="200"></asp:DropDownList>
                             </div>
                        </div>
                    </div>
                    <div class="form-group hide">
                        ...
                        <div class="col-sm-9">
                            <div class="control-inline">
                                <asp:DropDownList ID="ddlFormMethod" runat="server" CssClass="form-control validate[required]" Width="200"></asp:DropDownList>
                             </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <%=ViewControlTitle("lblTransferUrl", "Post URL", "txtTransferUrl", ":", "col-sm-3 control-label")%>
                        <div class="col-sm-9">
                            <div class="control-inline">
                                <asp:TextBox runat="server" ID="txtTransferUrl" Width="500" Rows="3" TextMode="MultiLine" CssClass="input_text validate[required,maxSize[1024],custom[url]]"></asp:TextBox><br />
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <div class="control-inline">
                                <asp:TextBox runat="server" ID="txtQueryString" Width="500" TextMode="MultiLine" Rows="5" CssClass="input_text validate[maxSize[2048]]"></asp:TextBox>
                                <%=ViewHelp("lblQueryString", "Query String: Name=Value ")%>
                             </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <%=ViewControlTitle("lblWaitText", "Waiting for text", "txtWaitText", ":", "col-sm-3 control-label")%>
                        <div class="col-sm-9">
                            <div class="control-inline">
                                <asp:TextBox runat="server" ID="txtWaitText" Width="500" TextMode="MultiLine" Rows="2" CssClass="input_text validate[maxSize[2048]]"></asp:TextBox>
                             </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group hide">
                        ...
                        <div class="col-sm-9">
                            <div class="control-inline">
                                <asp:TextBox runat="server" ID="txtAppVerify" Width="500" CssClass="input_text validate[required,maxSize[32],minSize[32]]"></asp:TextBox><br />
