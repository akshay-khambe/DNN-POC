<%@ control language="C#" autoeventwireup="true" inherits="Cross.Modules.Article.View.ViewAccountLink, App_Web_viewaccountlink.ascx.6c70b780" %>
...
<table id="tblLink" cellspacing="0" cellpadding="0" visible="false" runat="server">
    <tr>
        <td>
