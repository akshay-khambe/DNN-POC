<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="View_Index.ascx.cs" Inherits="DNNGo.Modules.ThemePluginPro.View_Index" %>
...
<asp:Panel ID="panNavigation" runat="server"  CssClass="Navigation">
    <asp:HyperLink ID="hlManager" runat="server" CssClass="ThemePluginPro_Manager" Text="<i class='icon-file'></i> Manager" resourcekey="Actions_Manager" Target="_blank"></asp:HyperLink>
</asp:Panel>
