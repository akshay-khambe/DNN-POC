<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="~/Resource_RichUrls.ascx.cs" Inherits="DNNGo.Modules.ThemePluginPro.Resource_RichUrls" %>
                    ...
                    <asp:Panel ID="div_Image" runat="server" CssClass="div_Image" style=" max-width:400px;">
                     ...
                     <div class="nav nav-tabs Urls_Pictures"  id="Urls_Pictures" runat="server" style="display:none;">
	                    ...
	                    <div class="tab-content">
		                    <div class="tab-pane active" id="panel_tab_list_<%=ClientName %>" style=" display:block;">
