...
<table width="100%" cellpadding="0" cellspacing="0" class="Normal prdblock" align="left">
    <tr valign="top">
        <td valign="top" align="left" height="<%=GetHeight()%>">
            <% =GetMarqueeBegin()%>
            <asp:DataList ID="dlArticle" runat="server" RepeatColumns="<%#Settings_List.Paging.ColCount %>" CssClass="Normal prditem"
                RepeatDirection="Horizontal" RepeatLayout="table" Width="100%" Visible="false"
                OnItemDataBound="dlArticle_ItemDataBound">
                <ItemTemplate>
                    <asp:Label ID="lblId" runat="server" Text='<%# Eval("Id") %>' Visible="false">
                    </asp:Label>
                    <table  border="0" cellpadding="0" cellspacing="1" class="prdtbl">
                        <tr align="left">
