  ...
  //Wrapper function to invoke all the necessary constructors and deal with the output.
    ...
    function Parser() {
      ...
      this.Utils = { //Uilities made available to the various functions
        whitespace: "\n\r\t ".split(''),
        single_token: 'br,input,link,meta,!doctype,basefont,base,area,hr,wbr,param,img,isindex,?xml,embed,source'.split(','), //all the single tags for HTML
      ...
      this.get_token = function () { //initial handler for token-retrieval
        ...
        //  console.log(temp_token)
          token = temp_token //call the JS Beautifier
    ...
    var noTAG = Array("svg","use","sup")//"a","span","i",
  function loseTAG(tag){ 
    ...
    while (true) {
      ...
      switch (multi_parser.token_type) {
        case 'TK_TAG_START': case 'TK_TAG_SCRIPT': case 'TK_TAG_STYLE':
            if(loseTAG(multi_parser.token_text)){
      ...
      case 'TK_TAG_END':
        ...
        case 'TK_TAG_SINGLE':
          ...
          break;
      case 'TK_CONTENT':
          if (multi_parser.token_text !== '' || (multi_parser.token_text === '' && multi_parser.tag_type  == "START")) {
              f = false;
              //multi_parser.print_newline(false, multi_parser.output);
              multi_parser.print_token(multi_parser.token_text);
          }
