<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Search.ascx.cs" Inherits="Cross.Modules.Article.View.Search" %>
...
<asp:Table ID="tblUserSearch" runat="server" Width="100%" CssClass="dnnFormItem"
    ...
    <asp:TableRow ID="trBuiltInField_ExpireDate" runat="server" Visible='<%#Settings_Search.Advanced.BuiltInField_ExpireDate %>'>
     ...
     <asp:TableRow ID="trBuiltInField_EventStart" runat="server" Visible='<%#Settings_Search.Advanced.BuiltInField_EventStart %>'>
        <asp:TableCell HorizontalAlign="Right" Width='<%# Convert.ToInt32(Settings_Search.Advanced.Width_Label) + Convert.ToInt32(Settings_Search.Advanced.Width_Operator) %>'>
            <asp:Label ID="lblBuiltInField_EventStart" runat="server" resourcekey="lblBuiltInField_EventStart"></asp:Label>
            <asp:DropDownList ID="ddlOper_EventStart" runat="server" Width='<%#Convert.ToInt32(Settings_Search.Advanced.Width_Operator)%>'>
                <asp:ListItem Value="lessthan" resourcekey="li_Oper_lessthan" />
                <asp:ListItem Value="equal" resourcekey="li_Oper_equal" />
                <asp:ListItem Value="greaterthan" resourcekey="li_Oper_greaterthan" />
            </asp:DropDownList>
        ...
        <asp:TableCell>
            <dnn:DnnDatePicker ID="ddpEventStart" runat="server" Width="<%#Convert.ToInt32(Settings_Search.Advanced.Width_Input)%>" />
        </asp:TableCell>
    </asp:TableRow>
     <asp:TableRow ID="trBuiltInField_EventEnd" runat="server" Visible='<%#Settings_Search.Advanced.BuiltInField_EventEnd %>'>
        <asp:TableCell HorizontalAlign="Right" Width='<%# Convert.ToInt32(Settings_Search.Advanced.Width_Label) + Convert.ToInt32(Settings_Search.Advanced.Width_Operator) %>'>
            <asp:Label ID="lblBuiltInField_EventEnd" runat="server" resourcekey="lblBuiltInField_EventEnd"></asp:Label>
            <asp:DropDownList ID="ddlOper_EventEnd" runat="server" Width='<%#Convert.ToInt32(Settings_Search.Advanced.Width_Operator)%>'>
                <asp:ListItem Value="lessthan" resourcekey="li_Oper_lessthan" />
                <asp:ListItem Value="equal" resourcekey="li_Oper_equal" />
                <asp:ListItem Value="greaterthan" resourcekey="li_Oper_greaterthan" />
            </asp:DropDownList>
        ...
        <asp:TableCell>
            <dnn:DnnDatePicker ID="ddpEventEnd" runat="server" Width="<%#Convert.ToInt32(Settings_Search.Advanced.Width_Input)%>" />
        </asp:TableCell>
    </asp:TableRow>
