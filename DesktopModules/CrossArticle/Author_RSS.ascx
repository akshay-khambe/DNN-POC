<%@ control language="C#" autoeventwireup="true" inherits="Cross.Modules.Article.View.Author_RSS, App_Web_author_rss.ascx.6c70b780" %>
...
<table width="100%" align="center" runat="server" id="tblButton" class="dnnFormItem">
    <tr valign="top">
        <td align="center">
            ...
            &nbsp;&nbsp;
            <dnn:CommandButton ID="btnAdd" runat="server" ImageUrl="~/images/add.gif" OnCommand="btnAdd_Click" ResourceKey="btnAddRSS"
        ...
        <div id="divBasic" class="dnnFormItem" style="height: 100%">
            <table cellspacing="0" cellpadding="2" width="100%" border="0" align="left">
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtFeedUrl" Width="1000px" runat="server" />
                ...
                <tr>
                  ...
                  {%>
                   <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtPinOrder" Columns="6" runat="server" Text="10000" Width="100px" />&nbsp;&nbsp;
