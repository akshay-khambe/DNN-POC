<%@ control language="C#" autoeventwireup="true" inherits="Cross.Modules.Article.View.Reader_Ticket, App_Web_reader_ticket.ascx.6c70b780" %>
...
<table width="100%"  cellpadding="0" cellspacing="0" border="0" runat="server" class="dnnFormItem"
    id="tblButton">
    <tr>
        <td id="td_Button_Search" runat="server">
            ...
            <asp:TextBox ID="txtTitle" Columns="40" runat="server"   Width="200px"/>
    ...
    <tr>
        <td align="right">
            <asp:GridView ID="gvTicket" runat="server" AutoGenerateColumns="False" 
                Width="100%" CellPadding="1"  CellSpacing="1"  GridLines="Both" BackColor="Gray" ForeColor="#333333" DataKeyNames="Id" OnRowCommand="gvTicket_RowCommand">
                <EmptyDataTemplate>
                        ...
                        <ItemTemplate>
                           ...
                           <asp:ImageButton ID="imgDel" runat="server" CausesValidation="False" CommandName="Del"
                             ...
                             <asp:ImageButton ID="imgViewUpload_Client" runat="server" CausesValidation="False" CommandName="ViewUpload_Client"
                                ...
                                ImageUrl="~/desktopmodules/crossarticle/images/up.gif" AlternateText='<%#Localization.GetString("imgViewUpload_Client",LocalResourceFile)%>'
                                Visible='<%#AllowUpload_Client(Convert.ToInt32(Eval("ArticleId"))) %>' />

                             <asp:ImageButton ID="imgViewUpload_Author" runat="server" CausesValidation="False" CommandName="ViewUpload_Author"
                                CommandArgument='<%# Eval("Id")%>' ToolTip='<%#Localization.GetString("imgViewUpload_Author",LocalResourceFile)%>'
                                ImageUrl="~/desktopmodules/crossarticle/images/watch.png" AlternateText='<%#Localization.GetString("imgViewUpload_Author",LocalResourceFile)%>'
                                Visible='<%#AllowUpload_Author(Convert.ToInt32(Eval("ArticleId"))) %>' />
        ...
        <td>
            <div class="dnnTreeLegend" id="divLegend" runat="server">
                ...
                <div class="dtlItem">
                    ...
                    <asp:Literal ID="litDel" runat="server" Text='<%#Localization.GetString("imgDel", Cross.Modules.Article.Business.LocalUtils.ResourcesFile_Shared)%>' />
                    <br />


                    <img alt="" id="Img6" runat="server" src="~/desktopmodules/crossarticle/images/up.gif" />&nbsp;=&nbsp;
                    <asp:Literal ID="litUpload" runat="server" Text='<%#Localization.GetString("imgViewUpload_Client",LocalResourceFile)%>' />
                    <br />

                    <img alt="" id="Img7" runat="server" src="~/desktopmodules/crossarticle/images/watch.png" />&nbsp;=&nbsp;
                    <asp:Literal ID="litUpload_Author" runat="server" Text='<%#Localization.GetString("imgViewUpload_Author",LocalResourceFile)%>' />
                </div>
            </div>
        </td>
    </tr>
        ...
        <td>
            ...
            &nbsp; &nbsp; &nbsp; &nbsp;
             <asp:HyperLink ID="hlUpload_Unlimited" runat="server" Text='<%# Localization.GetString("hlUpload_Unlimited", LocalResourceFile) %>'
                Target="_blank" />&nbsp; &nbsp; &nbsp; &nbsp;
               <dnn:CommandButton ID="btnRefeshUpload" runat="server" ResourceKey="btnRefeshUpload" ImageUrl="~/desktopmodules/crossarticle/images/watch.png"
                    ...
                    <asp:TemplateField ItemStyle-HorizontalAlign="Right">
                        ...
                        <ItemTemplate>
                            <asp:Label ID="lblSizeField" runat="server"
                                Text='<%#Cross.Modules.Article.Business.LocalUtils.FormatFileSize(Convert.ToString(Eval("FileSize"))) %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField ItemStyle-HorizontalAlign="Right">
                        <HeaderTemplate>
                    ...
                    <asp:TemplateField ItemStyle-HorizontalAlign="Center">
                        ...
                        <ItemTemplate>
                            <asp:ImageButton ID="imgDel" runat="server" CausesValidation="False" CommandName="Del"
                                ...
                                AlternateText='<%#Localization.GetString("imgDel", Cross.Modules.Article.Business.LocalUtils.ResourcesFile_Shared)%>'
                                ToolTip='<%#Localization.GetString("imgDel", Cross.Modules.Article.Business.LocalUtils.ResourcesFile_Shared)%>'
                                OnClientClick='<%# String.Format("return confirm(\"{0}\");", Localization.GetString("DeleteItem",Cross.Modules.Article.Business.LocalUtils.ResourcesFile_Shared)) %>' />
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField ItemStyle-HorizontalAlign="Center">
                        ...
                        <ItemTemplate>
                          <asp:HyperLink ID="hlDownload" runat="server" Text='<%# Localization.GetString("hlDownload", LocalResourceFile) %>'
                                Target="_blank" NavigateUrl='<%#GetUploadFileUrl(Convert.ToString(Eval("Id")),Cross.Modules.Article.Business.LocalUtils.FileUploadFrom_Client) %>' />
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
                <FooterStyle BackColor="#5D7B9D" Font-Bold="True" ForeColor="White" />
...
<table id="tblTicketDetail_Upload_Author" cellspacing="0" cellpadding="2" border="0" align="left"
    width="100%" class="dnnFormItem" visible="false" runat="server">
    <tr>
        <td>
            <asp:Label ID="lblUpload_Author" runat="server" CssClass="SubHead"  ResourceKey="lblUpload_Author" />
            <hr style="border: 1px dotted #999999; size: 1" />
        
            <asp:GridView ID="gvUploadList_Author" runat="server" AutoGenerateColumns="False" CellPadding="1" CellSpacing="1" GridLines="Both" BackColor="Gray"
                Width="100%" ForeColor="#333333" DataKeyNames="Id">
                <EmptyDataTemplate>
                    <asp:Label ID="lblNoRecordes" Text='<%# Localization.GetString("NoRecords", Cross.Modules.Article.Business.LocalUtils.ResourcesFile_Shared) %>'
                        runat="server"></asp:Label>
                ...
                <Columns>
                    ...
                    <asp:TemplateField ItemStyle-HorizontalAlign="Center">
                        ...
                        <ItemTemplate>
                             <asp:HyperLink ID="hlDownload" runat="server" Text='<%# Localization.GetString("hlDownload", LocalResourceFile) %>'
                                Target="_blank" NavigateUrl='<%#GetUploadFileUrl(Convert.ToString(Eval("Id")),Cross.Modules.Article.Business.LocalUtils.FileUploadFrom_Author) %>' />
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
                <FooterStyle BackColor="#5D7B9D" Font-Bold="True" ForeColor="White" />
