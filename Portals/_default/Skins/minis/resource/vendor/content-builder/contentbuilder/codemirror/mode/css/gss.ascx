...
<div id=nav>
  ...
  <ul>
    ...
    <li><a class=active href="<%= SkinPath %>#">Closure Stylesheets (GSS)</a>
  </ul>
</div>
...
.logo {
  ...
  background-image: url('http://www.google.com/images/logo_sm.gif');
    ...
    <p><strong>Parsing/Highlighting Tests:</strong> <a href="<%= SkinPath %>../../test/index.html#gss_*">normal</a>,  <a href="<%= SkinPath %>../../test/index.html#verbose,gss_*">verbose</a>.</p>
