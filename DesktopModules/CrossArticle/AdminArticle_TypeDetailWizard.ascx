<%@ control language="C#" autoeventwireup="true" inherits="Cross.Modules.Article.View.AdminArticle_TypeDetailWizard, App_Web_adminarticle_typedetailwizard.ascx.6c70b780" %>
...
<%@ Register TagPrefix="Portal" Namespace="DotNetNuke.Security.Permissions.Controls"
    Assembly="DotNetNuke" %>
<asp:Wizard ID="wizArticle" runat="server" CssClass="dnnFormItem" ActiveStepIndex="0"
    SideBarStyle-Width="100px" Font-Names="Verdana" CellPadding="5" CellSpacing="5"
    Width="100%" BackColor="#F7F6F3"
            ...
            <tr>
                <td align="right">
                    ...
                    <asp:LinkButton ID="StepPreviousButton" runat="server" CommandName="MovePrevious"
                        Text='<%#Localization.GetString("StepPreviousButton",Cross.Modules.Article.Business.LocalUtils.ResourcesFile_Shared)%>' CssClass="dnnSecondaryAction" />
                </td>
                <td align="right">
        ...
        <table border="0" cellpadding="5" cellspacing="5">
            <tr>
                ...
                <td align="right">
                    ...
                    Text='<%#Localization.GetString("StepFinishButton",Cross.Modules.Article.Business.LocalUtils.ResourcesFile_Shared)%>'
                        CssClass="dnnPrimaryAction"/>
                </td>
            </tr>
        </table>
    ...
    <WizardSteps>
        <asp:WizardStep ID="wsGeneral" runat="server" Title='<%# Localization.GetString("wsGeneral", LocalResourceFile) %>'
            ...
            <table cellspacing="2" cellpadding="2" class="dnnFormItem" width="100%">
                ...
                <tr>
                    <td >
                        <asp:RadioButtonList ID="rblCreateType" runat="server" AutoPostBack="True" 
        ...
        <asp:WizardStep ID="wsPage" runat="server" Title='<%# Localization.GetString("wsPage", LocalResourceFile) %>'>
            ...
            <hr />
            <table cellspacing="2" cellpadding="2"  runat="server" id="tblPageCreateNew" class="dnnFormItem" width="100%">
                <tr>
                    ...
                    <td >
                        <asp:TextBox ID="txtTabName"  runat="server" MaxLength="50"
                            Text="Article Detail" Width="300px" />
                ...
                <tr>
                    ...
                    <td >
                        <asp:DropDownList ID="ddlParentTab"  runat="server" DataTextField="IndentedTabName" Width="400px"
            ...
            <table cellspacing="2" cellpadding="2" class="dnnFormItem" runat="server" id="tblExistingTab" width="100%">
                <tr>
                    <td style="width: 200px">
                        <dnn:Label ID="plExistingTab" runat="server" ControlName="ddlExistingTab" />
                    </td>
                    <td >
                        <asp:DropDownList ID="ddlExistingTab"  runat="server" DataTextField="IndentedTabName" Width="400px"
                            DataValueField="TabId" />
                    </td>
                </tr>
            </table>
