<%@ control language="C#" autoeventwireup="true" inherits="Cross.Modules.Article.View.Author_A3File, App_Web_author_a3file.ascx.6c70b780" %>
    ...
    <tr runat="server" id="trInfo" valign="top">
        ...
        <td>
            ...
            <dnn:CommandButton ID="btnUpload_Normal" runat="server" ResourceKey="btnUpload_Normal" CausesValidation="false"
                ImageUrl="~/DesktopModules/CrossArticle/Images/up.gif" OnCommand="btnUpload_Normal_Click" />
            &nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <table style="width: 100%;" border="0" cellpadding="5" cellspacing="1" class="dnnFormItem">
                ...
                <tr>
                    <td>
                        ...
                        <asp:Silverlight ID="ctlUpload" runat="server" Height="400px" Source="~/DesktopModules/CrossArticle/Controls/FileUpload.xap"
                        ...
                        <asp:GridView ID="gvList" runat="server" AutoGenerateColumns="False" CellPadding="1"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Size" SortExpression="Size" HeaderStyle-HorizontalAlign="Center">
                                    ...
                                    <ItemTemplate>
                                        <asp:Label ID="lblSizeField" runat="server" Text='<%# Cross.Modules.Article.Business.LocalUtils.FormatFileSize(Convert.ToString(Eval("Size"))) %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                                    ...
                                    <ItemTemplate>
                                        <asp:ImageButton ID="imgDel" runat="server" AlternateText='<%#Localization.GetString("imgDel",Cross.Modules.Article.Business.LocalUtils.ResourcesFile_Shared)%>'
                                            ...
                                            ImageUrl="~/images/delete.gif" OnClientClick='<%# String.Format("return confirm(\"{0}\");", Localization.GetString("DeleteItem",Cross.Modules.Article.Business.LocalUtils.ResourcesFile_Shared)) %>' />
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
