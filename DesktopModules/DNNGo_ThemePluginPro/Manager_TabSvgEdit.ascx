<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Manager_TabSvgEdit.ascx.cs" Inherits="DNNGo.Modules.ThemePluginPro.Manager_TabSvgEdit" %>
   <!-- start: PAGE HEADER -->
<div class="row">
    <div class="col-sm-12">
        ...
        <div class="page-header">
            <h1>
                <i class="fa fa-plus"></i> <%=ViewResourceText("Header_Title", "Svg Icon Settings")%>
