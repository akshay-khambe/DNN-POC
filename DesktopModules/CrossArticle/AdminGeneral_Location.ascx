<%@ control language="C#" autoeventwireup="true" inherits="Cross.Modules.Article.View.AdminGeneral_Location, App_Web_admingeneral_location.ascx.6c70b780" %>
...
<table width="100%" class="dnnFormItem" align="center" runat="server" id="tblButton">
    <tr>
        <td align="center">
            ...
            &nbsp;&nbsp;
            <dnn:CommandButton ID="btnUpLevel" runat="server" ResourceKey="btnUpLevel"
                CausesValidation="false" Visible="false" ImageUrl="~/DesktopModules/CrossArticle/images/up.gif"
                OnCommand="btnUpLevel_Click" />
            &nbsp;&nbsp;
...
<table width="100%" class="dnnFormItem" align="left" runat="server" id="tblCountryList">
    <tr align="left" valign="top">
        <td>
            ...
            <br />
            <asp:GridView ID="gvCountryList" runat="server" AutoGenerateColumns="False" CellPadding="1"  CellSpacing="1"  GridLines="Both" BackColor="Gray"
                Width="100%"  ForeColor="#333333" DataKeyNames="Id"
                OnRowCommand="gvCountryList_RowCommand">
                <EmptyDataTemplate>
                    ...
                    <asp:TemplateField>
                        ...
                        <ItemTemplate>
                            <asp:ImageButton ID="imgState" runat="server" CausesValidation="False" CommandName="State"
                                ...
                                ImageUrl="~/DesktopModules/CrossArticle/images/Option.gif" AlternateText='<%#Localization.GetString("imgState", LocalResourceFile)%>' />
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:TemplateField>
                </Columns>
                ...
                <div class="dtlItem">
                    ...
                    <asp:Literal ID="lblDelete" runat="server" Text='<%#Localization.GetString("imgDel", Cross.Modules.Article.Business.LocalUtils.ResourcesFile_Shared)%>' />&nbsp;&nbsp;&nbsp;&nbsp;
                     ...
                     <%if (SupportsContentLocalization)
                      {%>
                    <img alt="" id="Img10" runat="server" src="~/DesktopModules/CrossArticle/images/ml_content_16.gif" />&nbsp;=&nbsp;
                    <asp:Literal ID="lblContentLocalization" runat="server" 
                    Text='<%#Localization.GetString("imgContentLocalization", Cross.Modules.Article.Business.LocalUtils.ResourcesFile_Shared)%>' />&nbsp;&nbsp;&nbsp;&nbsp;
                    <% } %>
                    
                    <img alt="" id="Img2" runat="server" src="~/DesktopModules/CrossArticle/images/Option.gif" />&nbsp;=&nbsp;
...
<table id="tblCountryDetail" cellspacing="0" cellpadding="2" width="100%" border="0" class="dnnFormItem"
    ...
    <tr >
        ...
        <td>
            <asp:TextBox ID="txtCountryName" Columns="70" runat="server" /><asp:Image ID="Image1"
                runat="server" ImageUrl="~/DesktopModules/CrossArticle/images/required.jpg"
    ...
    <tr>
        ...
        <td>
            <asp:TextBox ID="txtCountryDisplayOrder" runat="server" width="200px" Text="10"></asp:TextBox>
    ...
    <tr>
        <td colspan="2">
         <asp:Label ID="Label2" runat="server" resourcekey="Tip_CountryIsDefault"
...
<table width="100%" class="dnnFormItem" align="left" runat="server" id="tblStateList">
    <tr>
        <td>
            ...
            <asp:GridView ID="gvStateList" runat="server" AutoGenerateColumns="False" CellPadding="1"  CellSpacing="1"  GridLines="Both" BackColor="Gray"
                Width="100%"  ForeColor="#333333" DataKeyNames="Id"
                OnRowCommand="gvStateList_RowCommand">
                <EmptyDataTemplate>
                    <asp:Label ID="lblNoRecordes" Text='<%# Localization.GetString("NoRecords", Cross.Modules.Article.Business.LocalUtils.ResourcesFile_Shared) %>'
                        runat="server"></asp:Label>
                </EmptyDataTemplate>
                     ...
                     <asp:TemplateField>
                        ...
                        <ItemTemplate>
                            <asp:ImageButton ID="imgCity" runat="server" CausesValidation="False" CommandName="City"
                                ...
                                ImageUrl="~/DesktopModules/CrossArticle/images/Home.gif" AlternateText='<%#Localization.GetString("imgCity", LocalResourceFile)%>' />
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:TemplateField>
                </Columns>
        ...
        <td>
            <div class="dnnTreeLegend" id="div1" runat="server">
                ...
                <div class="dtlItem">
                    ...
                    <asp:Literal ID="Literal1" runat="server" Text='<%#Localization.GetString("imgEdit", Cross.Modules.Article.Business.LocalUtils.ResourcesFile_Shared)%>' />&nbsp;&nbsp;&nbsp;&nbsp;
                    <img alt="" id="Img4" runat="server" src="~/images/delete.gif" />&nbsp;=&nbsp;
                    <asp:Literal ID="Literal2" runat="server" Text='<%#Localization.GetString("imgDel", Cross.Modules.Article.Business.LocalUtils.ResourcesFile_Shared)%>' />&nbsp;&nbsp;&nbsp;&nbsp;
                   
                    <%if (SupportsContentLocalization)
                      {%>
                    <img alt="" id="Img11" runat="server" src="~/DesktopModules/CrossArticle/images/ml_content_16.gif" />&nbsp;=&nbsp;
                    <asp:Literal ID="Literal7" runat="server" 
                    Text='<%#Localization.GetString("imgContentLocalization", Cross.Modules.Article.Business.LocalUtils.ResourcesFile_Shared)%>' />&nbsp;&nbsp;&nbsp;&nbsp;
                    <% } %>

                    <img alt="" id="Img5" runat="server" src="~/DesktopModules/CrossArticle/images/Home.gif" />&nbsp;=&nbsp;
...
<table id="tblStateDetail" cellspacing="0" cellpadding="2" width="100%" border="0" class="dnnFormItem"
    ...
    <tr>
        ...
        <td>
            <asp:TextBox ID="txtStateDisplayOrder" runat="server" width="200px" Text="10"></asp:TextBox>
...
<table width="100%" class="dnnFormItem" align="left" runat="server" id="tblCityList">
    <tr>
        <td>
            ...
            <asp:GridView ID="gvCityList" runat="server" AutoGenerateColumns="False" CellPadding="1"  CellSpacing="1"  GridLines="Both" BackColor="Gray"
                Width="100%"  ForeColor="#333333" DataKeyNames="Id"
                OnRowCommand="gvCityList_RowCommand">
                <EmptyDataTemplate>
                    <asp:Label ID="lblNoRecordes" Text='<%# Localization.GetString("NoRecords", Cross.Modules.Article.Business.LocalUtils.ResourcesFile_Shared) %>'
                        runat="server"></asp:Label>
                </EmptyDataTemplate>
                     ...
                     <asp:TemplateField>
                        ...
                        <ItemTemplate>
                            <asp:ImageButton ID="imgTown" runat="server" CausesValidation="False" CommandName="Town"
                                ...
                                ImageUrl="~/DesktopModules/CrossArticle/images/Home.gif" AlternateText='<%#Localization.GetString("imgTown", LocalResourceFile)%>' />
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:TemplateField>
                </Columns>
        ...
        <td>
            <div class="dnnTreeLegend" id="div2" runat="server">
                ...
                <div class="dtlItem">
                    ...
                    <asp:Literal ID="Literal4" runat="server" Text='<%#Localization.GetString("imgEdit", Cross.Modules.Article.Business.LocalUtils.ResourcesFile_Shared)%>' />&nbsp;&nbsp;&nbsp;&nbsp;
                    <img alt="" id="Img8" runat="server" src="~/images/delete.gif" />&nbsp;=&nbsp;
                    <asp:Literal ID="Literal5" runat="server" Text='<%#Localization.GetString("imgDel", Cross.Modules.Article.Business.LocalUtils.ResourcesFile_Shared)%>' />&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <img alt="" id="Img9" runat="server" src="~/DesktopModules/CrossArticle/images/Home.gif" />&nbsp;=&nbsp;
...
<table id="tblCityDetail" cellspacing="0" cellpadding="2" width="100%" border="0" class="dnnFormItem"
    align="left" runat="server">
    <tr>
        <td style="width: 150px">
    ...
    <tr>
        ...
        <td>
            <asp:TextBox ID="txtCityDisplayOrder" runat="server" width="200px" Text="10"></asp:TextBox>
 ...
 <table width="100%" class="dnnFormItem"  runat="server" id="tblTownList">
    <tr>
        <td>
            ...
            <asp:GridView ID="gvTownList" runat="server" AutoGenerateColumns="False" CellPadding="1"  CellSpacing="1"  GridLines="Both" BackColor="Gray"
                Width="100%"  ForeColor="#333333" DataKeyNames="Id"
                OnRowCommand="gvTownList_RowCommand">
                <EmptyDataTemplate>
                    <asp:Label ID="lblNoRecordes" Text='<%# Localization.GetString("NoRecords", Cross.Modules.Article.Business.LocalUtils.ResourcesFile_Shared) %>'
                        runat="server"></asp:Label>
                </EmptyDataTemplate>
...
<table id="tblTownDetail" cellspacing="0" cellpadding="2" width="100%" border="0" class="dnnFormItem"
     runat="server">
    <tr>
        <td style="width: 150px">
    ...
    <tr>
        ...
        <td>
            <asp:TextBox ID="txtTownDisplayOrder" runat="server" width="200px" Text="10"></asp:TextBox>
