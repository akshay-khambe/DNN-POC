              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                    <div class="control-inline">
                        <asp:TextBox ID="txtToolTip" runat="server" Width="330" TextMode="MultiLine" Rows="2" CssClass=" validate[maxSize[256]]"></asp:TextBox>
                    </div>
                </div>
              </div> 
              <div class="form-group">
            ...
            <div class="panel-body">
              <div class="row">
                <div class="form-horizontal">
                     ...
                     <div class="form-group conditional" id="trFTDirection" data-condition="['5','8'].includes(#AddNewField_ddlControlType)">
                    ...
                    <div class="form-group conditional" id="trFTListColumn" data-condition="['5','8'].includes(#AddNewField_ddlControlType)">
                     ...
                     <div class="form-group conditional" id="trFTWidth"  data-condition="['1','2','3','4','5','6','8','9','111','112','130','131','132'].includes(#AddNewField_ddlControlType)">
                        ...
                        <div class="form-group conditional"  id="trFTRows" data-condition="['1','2','4'].includes(#AddNewField_ddlControlType)">
                        ...
                        <div class="form-group conditional" id="trFTListCollection" data-condition="['3','4','5','8','132'].includes(#AddNewField_ddlControlType)">
                        ...
                        <div class="col-sm-9">
                            ...
                            <div class="ListCollection_Help conditional" data-condition="['3','4','5','8'].includes(#AddNewField_ddlControlType)">
                            <%=ViewHelp("lblFTListCollection", "Please enter the item colection of List Control here, only one item for each line.")%>
                            </div>
                            <div class="ListCollection_SendMail_Help conditional" data-condition="['132'].includes(#AddNewField_ddlControlType)">
                      ...
                      <div class="form-group conditional" data-condition="['1','2','3','4','5','7','8','10','11','130','131','132','140'].includes(#AddNewField_ddlControlType)">
                        <%=ViewControlTitle("lblFTDefaultValue", "Default Value", "txtFTDefaultValue", ":", "col-sm-3 control-label")%>
                        <div class="col-sm-9">
                             <div class="TextDefaultValue conditional"  data-condition="['1','3','4','5','7','8','10','130','131','132','140'].includes(#AddNewField_ddlControlType)"> 
                            ...
                            <div class="HtmlDefaultValue conditional" data-condition="['2','11'].includes(#AddNewField_ddlControlType)"> 
                                <asp:TextBox ID="txtTinymceDefaultValue" runat="server" CssClass=" NormalTextBox tinymce form-control validate[maxSize[512]]" Width="90%" TextMode="MultiLine"></asp:TextBox>
                            </div>
                            <div class="DefaultValue_Help_1 conditional" data-condition="['1','2'].includes(#AddNewField_ddlControlType)">
                                <%=ViewHelp("lblFTDefaultValue", "You can enter Default Value for thr control here.")%>
                            </div>
                            <div class="DefaultValue_Help_2 conditional" data-condition="['3','5','130','131','132'].includes(#AddNewField_ddlControlType)">
                                <%=ViewHelp("lblFTDefaultValue_Radio", "For DropDownList and RadioButtonList, you can enter one value of List Collection as Default Value.")%>
                            </div>
                            <div class="DefaultValue_Help_3 conditional" data-condition="['4','8'].includes(#AddNewField_ddlControlType)">
                                <%=ViewHelp("lblFTDefaultValue_Multiple", "For CheckBoxList and ListBox, you can enter one or mutiple value(s) of List Collection as Default Value(s) , mutiple default values should be separated by ','.")%>
                            </div>
                            <div class="DefaultValue_Help_4 conditional" data-condition="['7'].includes(#AddNewField_ddlControlType)">
                                <%=ViewHelp("lblFTDefaultValue_CheckBox", "For CheckBox, you can enter true or false as Default Value.")%>
                            </div>
                            <div class="DefaultValue_Help_5 conditional" data-condition="['140'].includes(#AddNewField_ddlControlType)">
                                <%=ViewHelp("lblFTDefaultValue_Confirm", "You can enter true or false as Default Value.")%>
                            </div>
                        </div>
                      </div>
                       <div class="form-group conditional" id="trFTVerification"  data-condition="['1'].includes(#AddNewField_ddlControlType)">
                      ...
                      <div class="form-group conditional" id="trFTEquals" data-condition="['1'].includes(#AddNewField_ddlControlType)">
                      ...
                      <div class="form-group conditional" id="trFTAssociatedControl"  data-condition="['130'].includes(#AddNewField_ddlControlType)">
                      ...
                      <div class="form-group conditional" id="trFTInputLength"  data-condition="['1'].includes(#AddNewField_ddlControlType)">
                       ...
                       <div class="form-group conditional"  id="trFTRequired" data-condition="['1','3','4','5','6','7','8','9','111','112','130','131','132'].includes(#AddNewField_ddlControlType)">
