...
<table cellspacing="2" cellpadding="2" width="100%">
    ...
    <tr valign="top" align="left">
        <td colspan="2">
            ...
            <asp:Image ID="imgAuthorAvatar" runat="server" Width="48px"
                ...
                Visible="<%#Settings_Detail.General.ShowAuthorAvatar %>" ImageAlign="AbsMiddle"></asp:Image>
            <!-- user name-->
    ...
    <tr>
        <td colspan="2">
            <table cellspacing="2" cellpadding="2" width="100%">
                <tr>
                    <td id="ShareBadgePRO_Toolbar"></td>
                </tr>
            </table>
        </td>
    </tr>
...
<div id="tabs" style="width: 100%; overflow: hidden">
    <ul>
        ...
        <li id="Li2" runat="server" visible='<%#Settings_Detail.General.ShowField1&&objType.EnableField1&&!string.IsNullOrEmpty(objArticle.Field1.Trim()) %>'>
            <a href="#divField1"><span>
                <%#objType.Field1Title%></span></a> </li>
        <li id="Li3" runat="server" visible='<%#Settings_Detail.General.ShowField2&&objType.EnableField2&&!string.IsNullOrEmpty(objArticle.Field2.Trim()) %>'>
            <a href="#divField2"><span>
                <%#objType.Field2Title%></span></a> </li>
        <li id="Li4" runat="server" visible='<%#Settings_Detail.General.ShowField3&&objType.EnableField3&&!string.IsNullOrEmpty(objArticle.Field3.Trim()) %>'>
            <a href="#divField3"><span>
                <%#objType.Field3Title%></span></a> </li>
        <li id="Li5" runat="server" visible='<%#Settings_Detail.General.ShowField4&&objType.EnableField4&&!string.IsNullOrEmpty(objArticle.Field4.Trim()) %>'>
            <a href="#divField4"><span>
                <%#objType.Field4Title%></span></a> </li>
        <li id="Li6" runat="server" visible='<%#Settings_Detail.General.ShowField5&&objType.EnableField5&&!string.IsNullOrEmpty(objArticle.Field5.Trim()) %>'>
            <a href="#divField5"><span>
                <%#objType.Field5Title%></span></a>
        </li>

        <li id="Li7" runat="server" visible='<%#ShowVote %>'><a href="#divVote"><span>
            <%#Localization.GetString("tabVote",LocalResourceFile)%></span></a>
        </li>

        <li id="Li8" runat="server" visible='<%#ShowGoogleMap %>'><a href="#divGoogleMap"><span>
            <%#Localization.GetString("tabGoogleMap",LocalResourceFile)%></span></a> </li>
        <li id="Li9" runat="server" visible='<%#ShowAttachment %>'><a href="#divAttachment"><span>
            <%#Localization.GetString("tabAttachment",LocalResourceFile)%></span></a> </li>
        <li id="Li10" runat="server" visible='<%#ShowRelatedVideo %>'><a href="#divRelatedVideo"><span>
            <%#Localization.GetString("tabRelatedVideo",LocalResourceFile)%></span></a>
        </li>
        <li id="Li11" runat="server" visible='<%#ShowRelatedAudio %>'><a href="#divRelatedAudio"><span>
            <%#Localization.GetString("tabRelatedAudio",LocalResourceFile)%></span></a>
        </li>
        <li id="Li12" runat="server" visible='<%#ShowRelatedImage %>'><a href="#divRelatedImage"><span>
            <%#Localization.GetString("tabRelatedImage",LocalResourceFile)%></span></a>
        </li>
        <li id="Li13" runat="server" visible='<%#Settings_Portal.Rating.AllowRating && Settings_Detail.General.ShowRating &&   objArticle.AllowRating %>'>
            <a href="#divRating"><span>
                <%#Localization.GetString("tabRating",LocalResourceFile)%></span></a> </li>
        <li id="Li14" runat="server" visible='<%#Settings_Portal.Comment.AllowComment && objArticle.AllowComment&&Settings_Detail.General.ShowComment %>'>
            <a href="#divComment"><span>
                <%#Localization.GetString("tabComment",LocalResourceFile)%></span></a> </li>

        <li id="Li15" runat="server" visible='<%#Settings_Detail.AuthorProfile.ShowAuthorProfile%>'>
            <a href="#divAboutAuthor"><span>
                <%#Localization.GetString("tabAboutAuthor",LocalResourceFile)%></span></a>
        </li>

        <li id="Li16" runat="server" visible='<%#ShowRelatedArticle %>'><a href='#divRelatedArticle'><span>
    ...
    <div id="divDescription" style="height: 100%">
        <table cellspacing="2" cellpadding="2" width="100%">
            ...
            <tr>
                <td valign="top">
                    <%if (Settings_Detail.General.ShowImage && !string.IsNullOrEmpty(objArticle.Image))
                        {%>
                    <a href="<%=GetRelativeUrlByFileId(objArticle.Image) %>" target="_blank">
                        <asp:Image BorderWidth="0" ID="imgArticleImage" runat="server" AlternateText="<%#objArticle.Title%>"
                            ImageAlign="Left" ToolTip="<%#objArticle.Title%>" ImageUrl='<%#GetRelativeUrlByFileId(objArticle.Image) %>'></asp:Image>
                    </a>
                    <%} %>
    ...
    <div id="divVote" style="height: 100%">
        <table cellspacing="2" cellpadding="2" width="100%" class="dnnFormItem">
            <tr>
                <td>
                    <asp:Label ID="lblVoteTitle" runat="server" CssClass="SubHead" Text="<%#objArticle.VoteTitle%>"></asp:Label><br />
                    <br />
