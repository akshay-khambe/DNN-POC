            ...
            <div class="panel-body">
                <div class="form-horizontal">
                    <div class="form-group">
                        <%=ViewControlTitle("lblSenderEmail", "Custom 'From' email address", "txtSenderEmail", ":", "col-sm-3 control-label")%>
                        <div class="col-sm-5">
                    ...
                    <div class="form-group">
                        <%=ViewControlTitle("lblSenderEmailName", "Custom 'From' email name", "txtSenderEmailName", ":", "col-sm-3 control-label")%>
                        <div class="col-sm-5">
                            <div class="control-inline">
                                <asp:TextBox runat="server" ID="txtSenderEmailName" Width="300px" CssClass="form-control"></asp:TextBox>
                   ...
                   <div class="form-group">
                    ...
                    <div class="form-group">
                        <%=ViewControlTitle("lblAdminEmailCC", "Admin Email To CC", "txtAdminEmailCC", ":", "col-sm-3 control-label")%>
                        <div class="col-sm-5">
                            <div class="control-inline">
                                <asp:TextBox runat="server" ID="txtAdminEmailCC" Width="300px" CssClass="form-control"></asp:TextBox>
                             </div>
                                <%=ViewHelp("AdminEmailCC_Help", "Carbon Copy")%>
                            
                        </div>
                    </div>
                    <div class="form-group">
                        <%=ViewControlTitle("lblAdminEmailBCC", "Admin Email To BCC", "txtAdminEmailBCC", ":", "col-sm-3 control-label")%>
                        <div class="col-sm-5">
                            <div class="control-inline">
                                <asp:TextBox runat="server" ID="txtAdminEmailBCC" Width="300px" CssClass="form-control"></asp:TextBox>
                             </div>
                                <%=ViewHelp("AdminEmailBCC_Help", "Blind Carbon Copy")%>
