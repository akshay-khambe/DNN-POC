(function(jQuery) {
    ...
    jQuery.contentbox = function(element, options) {
        ...
        this.init = function() {
            ...
            if (this.settings.useSidebar) {
                html_sidebar += '<svg width="0" height="0" style="position:absolute">' + '<defs>' + '<symbol viewBox="0 0 512 512" id="ion-android-add"><path d="M416 277.333H277.333V416h-42.666V277.333H96v-42.666h138.667V96h42.666v138.667H416v42.666z"></path></symbol>' + '<symbol viewBox="0 0 512 512" id="cb-android-list"><path d="M408 64H104c-22.091 0-40 17.908-40 40v304c0 22.092 17.909 40 40 40h304c22.092 0 40-17.908 40-40V104c0-22.092-17.908-40-40-40zM304 368H144v-48h160v48zm64-88H144v-48h224v48zm0-88H144v-48h224v48z"></path></symbol>' + '<symbol viewBox="0 0 512 512" id="ion-code"><path d="M168 392a23.929 23.929 0 0 1-16.971-7.029l-112-112c-9.373-9.373-9.373-24.569 0-33.941l112-112c9.373-9.372 24.568-9.372 33.941 0 9.371 9.372 9.371 24.568 0 33.941L89.941 256l95.029 95.029c9.371 9.373 9.371 24.568 0 33.941A23.925 23.925 0 0 1 168 392zM344 392a23.929 23.929 0 0 0 16.971-7.029l112-112c9.373-9.373 9.373-24.569 0-33.941l-112-112c-9.373-9.372-24.568-9.372-33.941 0-9.371 9.372-9.371 24.568 0 33.941L422.059 256l-95.029 95.029c-9.371 9.373-9.371 24.568 0 33.941A23.925 23.925 0 0 0 344 392z"></path></symbol>' + '</defs>' + '</svg>';
                html_sidebar += '<div class="is-sidebar"  style="transform: translate3d(0,0,0);">';
                var enableContentStyle = this.settings.enableContentStyle;
                $.each(this.settings.sidebarData.buttons,
                    function() {
                        if (this.name == 'section') {
                            html_sidebar += '<div class="is-sidebar-button" data-content="divSidebarSections" data-command="section" title="' + this.title + '">' + '<svg class="svg-icon"><use xlink:href="#ion-android-add"></use></svg>' + '</div>'
                        } else if (this.name == 'snippet') {
                            if (bSideSnippets) {
                                html_sidebar += '<div class="is-sidebar-button" data-content="divSidebarSnippets" title="' + this.title + '">' + '<svg class="svg-icon cb-android-list"><use xlink:href="#cb-android-list"></use></svg>' + '</div>'
                            }
                        } else if (this.name == 'typography') {
                            if (enableContentStyle) {
                                html_sidebar += '<div class="is-sidebar-button" data-content="divSidebarTypography" data-command="typography" title="' + this.title + '">' + '<span style="font-family:serif;font-size:24px;display: inline-block;position:absolute;left:0;width:50px;">a</span>' + '</div>'
                            }
                        } else if (this.name == 'code') {
                            html_sidebar += '<div class="is-sidebar-button" data-content="divSidebarSource" data-command="code" title="' + this.title + '">' + '<svg class="svg-icon"><use xlink:href="#ion-code"></use></svg>' + '</div>'
                        } else if (this.name == 'custom1') {
                            html_sidebar += '<div class="is-sidebar-button" data-content="divCustomSidebarArea1" title="' + this.title + '" data-src="' + this.src + '">' + this.html + '</div>'
                        } else if (this.name == 'custom2') {
                            html_sidebar += '<div class="is-sidebar-button" data-content="divCustomSidebarArea2" title="' + this.title + '" data-src="' + this.src + '">' + this.html + '</div>'
                        } else {
                            html_sidebar += '<div class="is-sidebar-button" data-content="' + this.content.substr(1) + '" title="' + this.title + '">' + this.html + '</div>'
                        }
                    });
                html_sidebar += '</div>';
                html_sidebar += '' + '<div id="divSidebarSections" class="is-sidebar-content" style="-webkit-transition-duration:0.2s;transition-duration:0.2s;">' + '<div>' + '<iframe id="ifrIdeasPanel" src="' + scriptPath + 'blank.html" style="width:100%;height:100%;box-sizing:border-box;border:none;">' + '</iframe>' + '</div>' + '</div>' + '<div id="divSidebarSnippets" class="is-sidebar-content" style="max-width:366px;border-left: transparent 50px solid;box-sizing: border-box;">' + '' + '</div>' + '<div id="divSidebarSource" class="is-sidebar-content" style="-webkit-transition-duration:0.2s;transition-duration:0.2s;">' + '<div>' + '<div style="position:absolute;width:240px;height:35px;right:18px;top:7px;z-index:1;">' + '<button title="' + out('Cancel') + '" id="btnViewHtmlCancel2" class="secondary"> ' + out('Cancel') + ' </button>' + '<button title="' + out('Ok') + '" id="btnViewHtmlOk2" class="primary"> ' + out('Ok') + ' </button>' + '</div>' + '<div style="height:100%;box-sizing:border-box;border-top:#f3f3f3 50px solid;position:relative">' + '<textarea id="inpViewHtml2" style="width:100%;height:100%;resize: none;"></textarea>' + '<button title="' + out('Enlarge') + '" class="edit-html-larger" style="width:40px;height:40px;position:absolute;right:20px;top:0;background:#fff;padding: 0;"><svg class="is-icon-flex" style="width:22px;height:22px;fill:rgb(170, 170, 170);"><use xlink:href="#ion-arrow-expand"></use></svg></button>' + '</div>' + '</div>' + '</div>' + '<div id="divSidebarTypography" class="is-sidebar-content" style="-webkit-transition-duration:0.2s;transition-duration:0.2s;">' + '<div>' + '<iframe id="ifrTypographyPanel" src="' + scriptPath + 'blank.html" style="width:100%;height:100%;box-sizing:border-box;border:none;">' + '</iframe>' + '</div>' + '</div>' + '<div id="divCustomSidebarArea1" class="is-sidebar-content" style="max-width:500px;">' + '<div style="padding:0 0 0 50px;box-sizing:border-box;">' + '<iframe id="ifrCustomSidebarArea1" src="' + scriptPath + 'blank.html" style="width:100%;height:100%;box-sizing:border-box;border:none;">' + '</iframe>' + '</div>' + '</div>' + '<div id="divCustomSidebarArea2" class="is-sidebar-content" style="max-width:500px;">' + '<div style="padding:0 0 0 50px;box-sizing:border-box;">' + '<iframe id="ifrCustomSidebarArea2" src="' + scriptPath + 'blank.html" style="width:100%;height:100%;box-sizing:border-box;border:none;">' + '</iframe>' + '</div>' + '</div>';
                jQuery('#divCb').append(html_sidebar)
            } else {
                ...
                jQuery('#divCb').append(html_normal)
            }
            _fb = $.contentbuilder({
            ...
            s = s.replace('[COLORS]', html_colors);
            html_colors = '';
            for (i = 0; i <= 13; i++) {
                var percent = (i - 2) * 30;
                var color = _fb.LightenDarkenColor('#777777', percent);
                html_colors += '<button data-color="' + color + '" style="background:' + color + ';border:' + color + ' 1px solid"></button>'
            }
            s = s.replace('[GRADIENT]', html_colors);
            var html_gradcolors = '';
            for (var i = 0; i < this.settings.gradientcolors.length; i++) {
                html_gradcolors += '<button data-boxgradient="' + this.settings.gradientcolors[i][0] + '" data-textcolor="' + this.settings.gradientcolors[i][1] + '" style="background-image:' + this.settings.gradientcolors[i][0] + ';width: 50px;border:none;"></button>'
            }
            s = s.replace('[GRADIENTCOLORS]', html_gradcolors);
            jQuery('#divCb').append(s);
            if (localStorage.getItem("_customgradcolors") != null) {
                var customgradcolors = JSON.parse(localStorage.getItem("_customgradcolors"));
                var html_gradcolors = '';
                for (var i = 0; i < customgradcolors.length; i++) {
                    html_gradcolors += '<button class="is-customgrad-item" data-boxgradient="' + customgradcolors[i] + '" style="background-image:' + customgradcolors[i] + ';width: 50px;border:none;"><div class="is-customgrad-remove">&#10005;</div></button>'
                }
                jQuery('#divCustomGradColors').html(html_gradcolors)
            }
            if (this.settings.useSidebar) {
                jQuery('body').addClass('sidebar-active');
                jQuery('.is-sidebar > div').on('click',
                    function() {
                        ...
                        jQuery('#divCb').append('<div class="is-sidebar-overlay" style="position:fixed;top:0;left:0;width:100%;height:100%;background:rgba(255,255,255,0.000001);z-index: 1000;;"></div>');
                        jQuery('.is-sidebar-overlay').off('click');
                        jQuery('.is-sidebar-overlay').on('click',
                            function(e) {
                                jQuery('.is-sidebar-overlay').remove();
                                jQuery('.is-sidebar > div').removeClass('active');
                                jQuery('.is-sidebar-content').removeClass('active');
            ...
            if (!this.settings.useSidebar) {
                jQuery.get(scriptPath + 'contentbox.html',
                    function(data) {
                        var htmlData = '';
                        var htmlThumbs = '';
                        var i = 1;
                        ...
                        jQuery('#divSectionList > *').on('click',
                            function(e) {
                                var newArea = '';
                                ...
                                _fb.applyBehavior();
                                $newSection.append('<div class="is-section-tool">' + '<div class="is-section-edit" title="Section Settings"><svg class="is-icon-flex" style="margin-right:-2px;fill:rgba(255,255,255,1);"><use xlink:href="#ion-wrench"></use></svg></div>' + '<div class="is-section-remove" title="Remove">&#10005;</div>' + '</div>');
                                $newSection.find('.is-section-edit').on('click',
                                    function(e) {
                                        $activeSection = jQuery(this).parent().parent();
                                        $element.data("contentbox").editSection()
                                    });
                                $newSection.find('.is-section-remove').on('click',
                                    function(e) {
                                        ...
                                        $modal.find('.input-ok').on('click',
                                            function(e) {
                                                $newSection.fadeOut(400,
                                                    function() {
                                                        $newSection.remove();
            ...
            if (jQuery("#divboxtool").length == 0) {
                var s = '<div id="divboxtool">' + '<form id="form-upload-cover" target="frame-upload-cover" method="post" action="' + this.settings.coverImageHandler + '" enctype="multipart/form-data" style="position:relative;width:40px;height:40px;display:inline-block;float:left;background: rgb(90, 156, 38);">' + '<div style="width:40px;height:40px;overflow:hidden;">' + '<div style="position:absolute;width:100%;height:100%;"><svg class="is-icon-flex" style="position: absolute;top: 12px;left: 12px;fill:rgb(255,255,255);"><use xlink:href="#ion-image"></use></svg></div>' + '<input type="file" id="fileCover" name="fileCover" accept="image/*" style="position:absolute;top:-30px;left:0;width:100%;height:80px;opacity: 0;cursor: pointer;"/>' + '</div>' + '<input id="hidcustomval" name="hidcustomval" type="hidden" value="" />' + '<iframe id="frame-upload-cover" name="frame-upload-cover" src="' + scriptPath + 'blank.html" style="width:1px;height:1px;position:absolute;top:0;right:-100000px"></iframe>' + '</form>' + '<div id="lnkeditbox" title="Box Settings" style="display:inline-block;width:40px;height:40px;background: rgb(0, 172, 214);"><svg class="is-icon-flex" style="margin-right:-2px;margin-top:9px;fill:rgba(255,255,255,1);"><use xlink:href="#ion-wrench"></use></svg></div>' + '<div id="lnkeditmodule" title="Module Settings" style="display:inline-block;width:40px;height:40px;background: #FF9800;"><svg class="is-icon-flex" style="margin-right:-2px;margin-top:9px;fill:rgba(255,255,255,1);"><use xlink:href="#ion-ios-gear"></use></svg></div>' + '</div>';
                jQuery('#divCb').append(s)
            }
        ...
        this.addIdea = function(newArea) {
            ...
            newArea = newArea.replace(/%5B%25IMAGE_PATH%25%5D/g, designPath);
            var $newSection;
        ...
        this.setup = function() {
            $element.children('.is-section').each(function() {
                ...
                $currentSection.append('<div class="is-section-tool">' + '<div class="is-section-edit" title="Section Settings"><svg class="is-icon-flex" style="margin-right:-2px;fill:rgba(255,255,255,1);"><use xlink:href="#ion-wrench"></use></svg></div>' + '<div class="is-section-remove" title="Remove">&#10005;</div>' + '</div>');
                $currentSection.find(".is-section-edit").off('click');
                $currentSection.find(".is-section-edit").on('click',
                    function(e) {
                        $activeSection = jQuery(this).parent().parent();
                        $element.data("contentbox").editSection()
                    });
                $currentSection.find(".is-section-remove").off('click');
                $currentSection.find(".is-section-remove").on('click',
                    function(e) {
                        jQuery('body, html').animate({
        ...
        this.editSection = function() {
            ...
            jQuery(".cmd-section-up").on('click',
                function(e) {
            ...
            jQuery(".cmd-section-down").on('click',
                function(e) {
            ...
            jQuery(".cmd-section-top").on('click',
                function(e) {
            ...
            jQuery(".cmd-section-bottom").on('click',
                function(e) {
            ...
            jQuery(".cmd-section-height").on('click',
                function(e) {
            ...
            jQuery(".cmd-section-scroll").on('click',
                function(e) {
        ...
        this.applyBoxBehavior = function() {
            jQuery(".is-box").on('mouseenter mouseleave',
                function(e) {
                    switch (e.type) {
                        case 'mouseenter':
                            var $box = jQuery(this);
                            ...
                            jQuery("#divboxtool").on('mouseenter mouseleave',
                                function(e) {
                                    switch (e.type) {
                                        case 'mouseenter':
        ...
        this.editModule = function() {
            ...
            if (moduleName == 'code') {
                ...
                jQuery('.editcustomcode .cell-html-larger').on('click',
                    function(e) {
                        ...
                        $modal.addClass('active');
                        _fb.showModal($modal);
                        $modal.find('#ifrHtml').attr('src', _fb.getScriptPath() + 'html.html?1')
                    });
                $modal.find('.input-ok').off('click');
                $modal.find('.input-ok').on('click',
                    function(e) {
        ...
        this.editBox = function() {
            ...
            jQuery(".cmd-box-smaller").on('click',
                function(e) {
            ...
            jQuery(".cmd-box-larger").on('click',
                function(e) {
            ...
            jQuery(".cmd-box-bgcolor").on('click',
                function(e) {
            ...
            jQuery(".cmd-box-textcolor").on('click',
                function(e) {
            ...
            jQuery(".cmd-box-textalign").on('click',
                function(e) {
            ...
            jQuery(".cmd-box-textopacity").on('click',
                function(e) {
            ...
            jQuery(".cmd-box-typography").on('click',
                function(e) {
                    $element.data("contentbox").hideModal($modal);
            ...
            jQuery(".cmd-box-content-pos").on('click',
                function(e) {
            ...
            jQuery(".cmd-box-content-edge-x").on('click',
                function(e) {
                    var s = jQuery(this).data("value");
                    if (s == "-") {
            ...
            jQuery(".cmd-box-content-edge-y").on('click',
                function(e) {
                    var s = jQuery(this).data("value");
                    if (s == "-") {
            ...
            jQuery(".cmd-box-pickphoto").on('click',
                function(e) {
            ...
            jQuery(".cmd-box-pickbgcolor").on('click',
                function(e) {
                    $element.data("contentbox").openCustomColor('boxbg');
                    var $modal = jQuery('.is-modal.customcolor');
                    $modal.find('.more .input-text').val(jQuery('#inpBoxBgColor').val());
                    $modal.find('.more .is-color-preview').css('background-color', jQuery('#inpBoxBgColor').val())
                });
            jQuery(".cmd-box-gradient").unbind("click");
            jQuery(".cmd-box-gradient").on('click',
                function(e) {
                    jQuery("#inpBoxBgGrad1").val('');
                    jQuery("#inpBoxBgGrad2").val('');
                    jQuery("#inpBoxBgGradDeg").val(0);
                    if ($activeBox.css("background-image").indexOf('linear-gradient') != -1) {
                        var s = jQuery.trim($activeBox.css("background-image"));
                        var result = _fb.getGradient(s);
                        if (result !== null) {
                            var _color1 = result.colorStopList[0].color;
                            var _color2 = result.colorStopList[1].color;
                            var _line = result.line;
                            jQuery("#inpBoxBgGrad1").val(_color1);
                            jQuery("#inpBoxBgGrad2").val(_color2);
                            if (_line.indexOf('deg') != -1) {
                                jQuery("#inpBoxBgGradDeg").val(_line.replace('deg', ''))
                            }
                        }
                    }
                    var $modal = jQuery('.is-modal.gradientcolor');
                    $element.data("contentbox").showModal($modal);
                    $modal.not('.is-modal *').off('click');
                    $modal.not('.is-modal *').on('click',
                        function(e) {
                    ...
                    jQuery("[data-boxgradient]").unbind("click");
                    jQuery("[data-boxgradient]").on('click',
                        function(e) {
                            ...
                            var css = jQuery(this).data('boxgradient');
                            $activeBox.css("background-image", css);
                            ...
                            jQuery("[data-boxgradient]").removeClass('active');
                            jQuery(this).addClass('active')
                        });
                    jQuery('.is-customgrad-remove').off('click');
                    jQuery('.is-customgrad-remove').on('click',
                        function() {
                            if (localStorage.getItem("_customgradcolors") != null) {
                                customgradcolors = JSON.parse(localStorage.getItem("_customgradcolors"))
                            }
                            var css = jQuery(this).parent().data('boxgradient');
                            for (var i = 0; i < customgradcolors.length; i++) {
            ...
            jQuery(".cmd-box-pickbggradient1").unbind("click");
            jQuery(".cmd-box-pickbggradient1").on('click',
                function(e) {
                    $element.data("contentbox").openCustomColor('boxgrad1');
                    var $modal = jQuery('.is-modal.customcolor');
                    $modal.find('.more .input-text').val(jQuery('#inpBoxBgGrad1').val());
                    $modal.find('.more .is-color-preview').css('background-color', jQuery('#inpBoxBgGrad1').val())
                });
            jQuery(".cmd-box-pickbggradient2").unbind("click");
            jQuery(".cmd-box-pickbggradient2").on('click',
                function(e) {
                    $element.data("contentbox").openCustomColor('boxgrad2');
                    var $modal = jQuery('.is-modal.customcolor');
                    $modal.find('.more .input-text').val(jQuery('#inpBoxBgGrad2').val());
                    $modal.find('.more .is-color-preview').css('background-color', jQuery('#inpBoxBgGrad2').val())
                });
            jQuery('#inpBoxBgGradDeg').off('keyup');
            jQuery('#inpBoxBgGradDeg').on('keyup',
                function() {
                    if (jQuery("#inpBoxBgGrad1").val() == "") {
                        jQuery("#inpBoxBgGrad1").val("#fff")
                    }
                    if (jQuery("#inpBoxBgGrad2").val() == "") {
                        jQuery("#inpBoxBgGrad2").val("#fff")
                    }
                    $activeBox.css("background-image", "linear-gradient(" + jQuery("#inpBoxBgGradDeg").val() + "deg," + jQuery("#inpBoxBgGrad1").val() + "," + jQuery("#inpBoxBgGrad2").val() + ")")
                });
            jQuery('#inpBoxBgGradClear').off('click');
            jQuery('#inpBoxBgGradClear').on('click',
                function() {
                    var $overlay = $activeBox.find(".is-overlay");
            ...
            jQuery('.cmd-box-savebggrad').off('click');
            jQuery('.cmd-box-savebggrad').on('click',
                function() {
                    if (jQuery("#inpBoxBgGrad1").val() == "") {
                        jQuery("#inpBoxBgGrad1").val("#fff")
                    }
                    ...
                    customgradcolors.push("linear-gradient(" + jQuery("#inpBoxBgGradDeg").val() + "deg," + jQuery("#inpBoxBgGrad1").val() + "," + jQuery("#inpBoxBgGrad2").val() + ")");
                    localStorage.setItem("_customgradcolors", JSON.stringify(customgradcolors));
                    var html_gradcolors = '';
                    for (var i = 0; i < customgradcolors.length; i++) {
                        html_gradcolors += '<button class="is-customgrad-item" data-boxgradient="' + customgradcolors[i] + '" style="background-image:' + customgradcolors[i] + ';width: 50px;border:none;"><div class="is-customgrad-remove">&#10005;</div></button>'
            ...
            jQuery(".cmd-box-pickoverlaycolor").on('click',
                function(e) {
                    $element.data("contentbox").openCustomColor('boxoverlay');
                    var $modal = jQuery('.is-modal.customcolor');
                    $modal.find('.more .input-text').val('');
                    $modal.find('.more .is-color-preview').css('background-color', '')
                });
            jQuery("#chkBgModule").unbind("click");
            jQuery("#chkBgModule").on('click',
                function(e) {
            ...
            jQuery(".cmd-box-overlayopacity").on('click',
                function(e) {
            ...
            jQuery(".cmd-box-selectasset").on('click',
                function(e) {
            ...
            jQuery('.cmd-box-animate-test').on('click',
                function(e) {
                    $activeBox.removeClass('animated');
                    $activeBox.removeClass('pulse');
                    $activeBox.removeClass('bounceIn');
        ...
        this.openCustomColor = function(target) {
            var $modal = jQuery('.is-modal.customcolor');
            $element.data("contentbox").showModal($modal);
            ...
            $modal.find('.input-more').on('click',
                function(e) {
            ...
            $modal.find('button').not('.input-more,.input-mode').on('click',
                function(e) {
                    var base = jQuery(this).attr('data-color');
                    if (!jQuery(e.target).hasClass('clear') && !jQuery(e.target).hasClass('input-ok') && base != '#ffffff' && base != '#000000') {
                        ...
                        if (jQuery(e.target).parents('.gradient').length == 0) {
                            ...
                            for (i = 0; i <= 13; i++) {
                                ...
                                if (prevcolor == '#b7b7b7') {
                                    ...
                                    color = _fb.LightenDarkenColor(base, percent)
                                }
                                prevcolor = color;
                                var $button = jQuery(e.target).parent().find('.gradient button:eq(' + i + ')');
                    ...
                    if (jQuery(e.target).hasClass('input-ok')) {
                    ...
                    $element.data("contentbox").customColor(base);
                    $element.data("contentbox").settings.onChange()
                })
        };
        this.customColor = function(s) {
            var $modal = jQuery('.is-modal.customcolor');
            var ctarget = $modal.data('target');
        ...
        this.sectionUseScroll = function() {
            if (jQuery("#chkScrollIcon").prop("checked")) {
                ...
                jQuery('.is-arrow-down a').on('click',
                    function(e) {
        ...
        this.html = function(bForView) {
            cleanupUnused();
            var html = _fb.readHtml($element, bForView, true);
            return html
        };
        this.viewHtml = function(s) {
            var $modal = jQuery('.is-modal.viewfullhtml');
            $element.data("contentbox").showModal($modal);
            $modal.not('.is-modal *').off('click');
            $modal.not('.is-modal *').on('click',
                function(e) {
        ...
        this.viewHtml2 = function(s) {
            ...
            var html = this.html(true);
            jQuery('#inpViewHtml2').val(html);
            jQuery('#btnViewHtmlOk2').off('click');
            jQuery('#btnViewHtmlOk2').on('click',
                function(e) {
                    var html = jQuery('#inpViewHtml2').val();
                    html = _fb.fromViewToActual(html);
                    jQuery('.is-wrapper').html(html);
                    $element.data("contentbox").setup();
                    $element.data("contentbox").settings.onChange();
            ...
            jQuery('#btnViewHtmlCancel2').off('click');
            jQuery('#btnViewHtmlCancel2').bind('click',
                function(e) {
                    jQuery('.is-sidebar-overlay').remove();
                    jQuery('.is-sidebar > div').removeClass('active');
                    jQuery('.is-sidebar-content').removeClass('active');
            ...
            jQuery('#divSidebarSource .edit-html-larger').on('click',
                function(e) {
                    jQuery('textarea').removeAttr('data-source-active');
                    jQuery('textarea').removeAttr('data-source-ok');
                    jQuery('textarea').removeAttr('data-source-cancel');
                    jQuery('#divSidebarSource textarea').attr('data-source-active', '1');
                    jQuery('#divSidebarSource textarea').attr('data-source-ok', '#btnViewHtmlOk2');
                    jQuery('#divSidebarSource textarea').attr('data-source-cancel', '#btnViewHtmlCancel2');
                    var $modal = jQuery('.is-modal.viewhtmllarger');
                    $modal.addClass('active');
                    _fb.showModal($modal);
                    $modal.find('#ifrHtml').attr('src', _fb.getScriptPath() + 'html.html?1')
    ...
    function currentScriptPath() {
     /*    var scripts = document.querySelectorAll('script[src]');
        ...
        return SkinPath + "resource/vendor/content-builder/contentbox/";
    };
