<%@ Control Language="C#" AutoEventWireup="true" Inherits="DNNGo.Modules.ThemePluginPro.License" Codebehind="License.ascx.cs" %>
      <!-- start: PAGE HEADER -->
      <div class="row">
        <div class="col-sm-12"> 
          ...
          <div class="page-header">
            <h1><i class="fa clip-globe"></i> <%=ViewResourceText("Header_Title", "License")%> <%--<small>overview &amp; stats </small>--%></h1>
          </div>
