<%@ control language="C#" autoeventwireup="true" inherits="Cross.Modules.Article.View.AdminArticle_Newsletter, App_Web_adminarticle_newsletter.ascx.6c70b780" %>
...
<table cellspacing="2" cellpadding="2" border="0" width="100%" class="dnnFormItem">
    ...
    <tr>
        ...
        <td style="width: 525px; text-align: left" align="left">
            <dnn:RolesSelectionGrid runat="server" ID="dgSelectedRoles" />
        </td>
    </tr>
     <tr>
        <td  colspan="2">
         <asp:Label ID="Label2" runat="server" resourcekey="Tip_Email"
                            CssClass="dnnFormMessage dnnFormInfo"></asp:Label>
    ...
    <tr>
        ...
        <td>
            <asp:TextBox ID="txtFrom" runat="server" Style="width: 525px" MaxLength="100" />
...
<p align="center">
    <dnn:CommandButton ID="cmdSend" ResourceKey="cmdSend" runat="server" CssClass="CommandButton"
        OnCommand="cmdSend_Click" CausesValidation="true" ImageUrl="~/images/rt.gif" />
    &nbsp;&nbsp;
