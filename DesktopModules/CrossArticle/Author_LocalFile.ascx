<%@ control language="C#" autoeventwireup="true" inherits="Cross.Modules.Article.View.Author_LocalFile, App_Web_author_localfile.ascx.6c70b780" %>

<%@ Import Namespace="System.Globalization" %>
<%@ Import Namespace="Cross.Modules.DigitalAssets.Components.Controllers" %>
...
<div style="width: 100%;">
    <asp:Label ID="Label1" runat="server" CssClass="dnnFormMessage dnnFormInfo" resourcekey="Tip_FileManager"></asp:Label>
</div>
<div class="dnnClear" style="width: 100%;">
   <asp:Label ID="lblFileSpace" runat="server"></asp:Label>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <asp:HyperLink runat="server" ID="hlUpload2" ResourceKey="hlUpload2" NavigateUrl="<%#FileUploadUrl2%>"   />
   
    &nbsp;&nbsp;&nbsp;&nbsp;
      <asp:HyperLink runat="server" ID="hlUpload" ResourceKey="hlUpload" NavigateUrl="<%#FileUploadUrl%>" Visible="<%#Settings_Portal.General.EnableSilverlightUpload%>" />
    &nbsp;&nbsp;&nbsp;&nbsp;
...
<asp:Panel ID="ScopeWrapper" runat="server">
    ...
    <div class="dnnModuleDigitalAssetsBackground" oncontextmenu="return false;">
        ...
        <dnnext:EditPageTabExtensionControl ID="EditPageTabExtensionControl1" runat="server" Module="CrossDigitalAssets" Group="LeftPaneTabs" TabControlId="LeftPaneTabsControl" PanelControlId="LeftPaneContents"></dnnext:EditPageTabExtensionControl>
        <div id="dnnModuleDigitalAssetsLeftPane">
            <ul class="dnnAdminTabNav dnnModuleDigitalAssetsTabNav buttonGroup" runat="server" id="LeftPaneTabsControl">
                <li>
                    <asp:HyperLink ID="HyperLink1" href="#dnnModuleDigitalAssetsLeftPaneFilesTabContent" runat="server" resourcekey="LeftPaneFilesTab.Text"/>            
                </li>
            </ul>
        ...
        <div id="dnnModuleDigitalAssetsContentPane">
           ...
           <asp:Panel runat="server" ID="SearchBoxPanel"  Visible="false"/>             
            ...
            <div id="dnnModuleDigitalAssetsMainToolbar">                
                <dnnext:ToolBarButtonExtensionControl Module="CrossDigitalAssets" runat="server" ID="MainToolBar" Group="Main" />                
            </div>
            <div id="dnnModuleDigitalAssetsSelectionToolbar">
                <span id="dnnModuleDigitalAssetsSelectionText"></span>
                <dnnext:ToolBarButtonExtensionControl Module="CrossDigitalAssets" runat="server" ID="SelectionToolBar" Group="Selection" />
            </div>
    ...
    <div id="dnnModuleDigitalAssetsCreateFolderModal" style="display: none;">
        ...
        <div class="dnnClear">
            <fieldset>
                ...
                <!--we don't want user see folder type, this is unnecessary -->
...
<script type="text/javascript">
    ...
    dnnModule.digitalAssets.init(
        ...
        // Settings
        {
            ...
            fileUploadUrl: '<%= ClientAPI.GetSafeJSString(FileUploadUrl2)%>',           
            selectedTab: '0',
            ...
            maxFileUploadSizeHumanReadable: '<%= string.Format(new DotNetNuke.Services.FileSystem.FileSizeFormatProvider(), "{0:fs}", MaxUploadSize) %>',
