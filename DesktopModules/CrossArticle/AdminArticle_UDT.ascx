<%@ control language="C#" autoeventwireup="true" inherits="Cross.Modules.Article.View.AdminArticle_UDT, App_Web_adminarticle_udt.ascx.6c70b780" %>
                    ...
                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                        ...
                        <ItemTemplate>
                            ...
                            <asp:ImageButton ID="imgUp" runat="server" CausesValidation="false" CommandName="Up"
                                CommandArgument='<%# Eval("Id")%>' ImageUrl="~/images/up.gif" ToolTip='<%#Localization.GetString("imgUp", Cross.Modules.Article.Business.LocalUtils.ResourcesFile_Shared)%>'
                                AlternateText='<%#Localization.GetString("imgUp", Cross.Modules.Article.Business.LocalUtils.ResourcesFile_Shared)%>'
                                Visible="<%#Container.DataItemIndex>0%>" />
                            <asp:ImageButton ID="imgDown" runat="server" CausesValidation="false" CommandName="Down"
                                CommandArgument='<%# Eval("Id")%>' ImageUrl="~/images/dn.gif" ToolTip='<%#Localization.GetString("imgDown", Cross.Modules.Article.Business.LocalUtils.ResourcesFile_Shared)%>'
                                AlternateText='<%#Localization.GetString("imgDown", Cross.Modules.Article.Business.LocalUtils.ResourcesFile_Shared)%>'
        ...
        <td>
            <div class="dnnTreeLegend" id="divLegend" runat="server">
                ...
                <div class="dtlItem">
                    ...
                    <asp:Literal ID="lblUp" runat="server" Text='<%#Localization.GetString("imgUp", Cross.Modules.Article.Business.LocalUtils.ResourcesFile_Shared)%>' />&nbsp;&nbsp;&nbsp;&nbsp;
                    <img alt="" id="Img2" runat="server" src="~/images/dn.gif" />&nbsp;=&nbsp;
                    <asp:Literal ID="lblDown" runat="server" Text='<%#Localization.GetString("imgDown", Cross.Modules.Article.Business.LocalUtils.ResourcesFile_Shared)%>' />
    ...
    <tr runat="server" id="trDetail" visible="False" width="100%">
        <td>
            <table width="100%" cellspacing="2" cellpadding="2" border="0" class="dnnFormItem">
                ...
                <tr>
                    <td colspan="2">
                        <asp:Label ID="Label1" runat="server" resourcekey="Tip_AddAttribute" CssClass="dnnFormMessage dnnFormInfo"></asp:Label>
                    </td>
                </tr>
                <tr>
