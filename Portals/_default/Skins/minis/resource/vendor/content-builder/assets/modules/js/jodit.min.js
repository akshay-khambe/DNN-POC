...
function CKEditorLoad(d) {

    d.each(function () {
        var e = $(this);

        if (e.attr("name") == "html_js_css") {
            var editor = new Jodit(e[0], {
            ...
            var editor = new Jodit(e[0], {
                ...
                "disablePlugins": "preview,print,file,video,media,image,image-processor,image-properties,fullsize,search,clipboard,class-span,font,mobile,symbols,tooltip,sticky,inline-popup,iframe,indent,copy-format,about,redo-undo"
            });
