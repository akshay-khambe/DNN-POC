...
<div class="dng-main mm-page mm-slideout ${xf.ViewGlobalSetting("ContainerLayout","Wide")}#if($Sidebarenabled == "true")#if($SidebarPosition == "fixleftfull" || $SidebarPosition == "fixrightfull") has-sidebar-${SidebarPosition}#end#end" id="mm-content-box" data-page-type="onepage">
  <div id="dng-wrapper"> 
