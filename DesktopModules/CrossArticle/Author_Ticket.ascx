<%@ control language="C#" autoeventwireup="true" inherits="Cross.Modules.Article.View.Author_Ticket, App_Web_author_ticket.ascx.6c70b780" %>
...
<table id="tblTicketDetail_Upload_Author" cellspacing="0" cellpadding="2" border="0" align="left"
    ...
    <tr>
        <td>
            <asp:Label ID="lblUpload_Author" runat="server" CssClass="SubHead"/><br /><br />

               <asp:Label ID="lblUploadSummary_Author" runat="server" />
            &nbsp; &nbsp; &nbsp; &nbsp;
            ...
            <asp:GridView ID="gvUploadList_Author" runat="server" AutoGenerateColumns="False" CellPadding="1" CellSpacing="1" GridLines="Both" BackColor="Gray"
                Width="100%" ForeColor="#333333" DataKeyNames="Id" OnRowCommand="gvUploadList_Author_RowCommand">
                <EmptyDataTemplate>
                    <asp:Label ID="lblNoRecordes" Text='<%# Localization.GetString("NoRecords", Cross.Modules.Article.Business.LocalUtils.ResourcesFile_Shared) %>'
                        runat="server"></asp:Label>
                </EmptyDataTemplate>
