...
var reachEnd = false;
var galleryThumbs;  
var stopMaximum = true;

var dnnEaseOut= function(t,b,c,d){
    return -c *(t/=d)*(t-2) + b;
    };
var swiper_effect = {
    leftzoomout: {
        ...
        on: {
            ...
            transitionEnd: function(){ 
                //  $(this.slides.eq(this.activeIndex)).siblings().removeClass("swiper-slide-transitionEnd");
                //  $(this.slides.eq(this.activeIndex)).addClass('swiper-slide-transitionEnd');
        ...
        on: {
            progress: function(progress) {
                ...
                for (i = 0; i < this.slides.length; i++) {
                    ...
                    var slideProgress = this.slides[i].progress;
                    modify =2.1;
                    translate = slideProgress * slidesSizesGrid * 0.7 + 'px';
                    scale = 1 - Math.abs(slideProgress) / 5;
                    zIndex = 999 - Math.abs(Math.round(10 * slideProgress));
                    slide.transform('translateX(' + translate + ') scale(' + scale + ')');
                    slide.css('zIndex', zIndex);
        ...
        on: {
            progress: function(progress) {
                ...
                for (i = 0; i < this.slides.length; i++) {
                   ...
                   if(Math.abs(slideProgress) <= 1){
                        scale = (1-Math.abs(slideProgress))*.18+1;
                        scale2 =0.82 + (1-Math.abs(slideProgress))*.18;
                        opacity =(1-Math.abs(slideProgress));
                    }

                    zIndex = 999 - Math.abs(Math.round(10 * slideProgress));

                    slide.find(".pic").transform('scale(' + scale + ')');
                    slide.find(".shadow").css('opacity', opacity);
                    slide.find(".cont").css('opacity', opacity).transform('scale(' + scale2 + ')');
                    slide.css('zIndex', zIndex);
                    slide.css('opacity', 1);
                }
            },
            setTransition: function(transition) {
                for (var i = 0; i < this.slides.length; i++) {
                    var slide = this.slides.eq(i)
                    slide.transition(transition); 
                    slide.find(".pic").transition(transition); 
                    slide.find(".shadow").transition(transition); 
                    slide.find(".cont").transition(transition); 
                }
    
            },
            init:function() {
                var w =  -$(this.slides.eq(0)).width()*1.18 -160;
                var e =this.$el;
                setTimeout(function(){
                    e.find(".swiper-button-next").css("margin-right",w/2+"px")
                    e.find(".swiper-button-prev").css("margin-left",w/2+"px")
                },100)
            },
            resize:function() {
                var w =  -$(this.slides.eq(0)).width()*1.18 -160;
                this.$el.find(".swiper-button-next").css("margin-right",w/2+"px")
                this.$el.find(".swiper-button-prev").css("margin-left",w/2+"px")
        }
        }
    },
    scaleup:{
        ...
        on:{
            progress: function(progress) {
                ...
                var depth = this.$el.data("depth")?this.$el.data("depth"):2; //0.71
            ...
            progress: function (progress) {
                ...
                for (i = 0; i < this.slides.length; i++) {
                    ...
                    var style = slide[0].style;
                        ...
                        translate = slideProgress * slidesSizesGrid  + 'px';
                    ...
                    if (slideProgress > 1) {
                        ...
                        zIndex = 1000;
                        scale =dnnEaseOut(slideProgress, 1, 0.1 , 1);

                        modify = (slidesSizesGrid * (scale - 1 )) / depth + dnnEaseOut(Math.abs(slideProgress), 0, width, number);

                        slide.transform('translate(' + translate + ','+ modify +'px) scale(' + scale + ')');
                        slide.css('zIndex', zIndex);
    ...
    scaleleft: {
        ...
        on: {
            ...
            setTransition: function (transition) {
                ...
                this.$el.find('img:not(.swiper-lazy-loaded)').each(function(){
                    $(this).attr("src",$(this).data("src")).load(function(){
                    $(this).addClass("swiper-lazy-loaded");
...
var swiperLauncher= function(mod){
    ...
    mod.each(function(){
       ...
       function  MutationObserveridden(){ 
                    ...
                    if(e.hasClass("is-section") && typeof DNNapplyTypography != "undefined"){
                        swiper_default["loop"] = false;
                        swiper_default["autoplay"] = false;

                        swiper_default["simulateTouch"] = false;
                        swiper_default["preventClicks"] = false;
                    ...
                    if(swiper_default.slidesPerView && swiper_default.slidesPerView.constructor===Array){
                        ...
                        for(var i in swiper_default.breakpoints){
                            swiper_default.breakpoints[i]["slidesPerView"] =swiper_default.slidesPerView[n+1];
                            n++;
                        }

                        swiper_default.slidesPerView =  swiper_default.slidesPerView[0];

                    }

                    
                    //responsive spaceBetween
                    ...
                    if(!swiper_default.loopedSlides && (e.hasClass("swiper-thumbnail-pagination") || e.hasClass("swiper-container-main"))){
                        swiper_default.loopedSlides =5;
                    }else if(!swiper_default.loopedSlides && swiper_default.breakpoints && swiper_default.breakpoints[1600]["slidesPerView"]){
                        swiper_default.loopedSlides = swiper_default.breakpoints[1600]["slidesPerView"]+1;
                    }
                    ...
                    var swiper = new Swiper(e[0], swiper_default);
                    if(!e.hasClass("section-slider")){
                    ...
                    if( btnGroup.length ){
                        ...
                        btnGroup.find(".slideTo").click(function(){
                            ...
                            swiper.slideToLoop(index, swiper_default.speed, true);
                            return false;
                        });

                        swiper.on('transitionEnd', function(){
                            btnGroup.find(".slideTo").eq(swiper.realIndex).addClass("active").siblings(".active").removeClass("active");
                        })
                    }

                    if(swiper_default.lazy ){

                        function lazyprevimg(){
                            e.find(".swiper-slide-prev .swiper-lazy-preloader ,.swiper-slide-duplicate-prev .swiper-lazy-preloader,.swiper-pagination .swiper-lazy-preloader").each(function(){
                                $(this).siblings('img:not(.swiper-lazy-loaded)').each(function(){
                                        $(this).attr("src",$(this).data("src")).load(function(){
                                        $(this).addClass("swiper-lazy-loaded");
                                        $(this).siblings(".swiper-lazy-preloader").remove();
                                    })
                        ...
                        if(typeof IntersectionObserver =="function"){
                            var io = new IntersectionObserver(function(d){
                                if (d[0].intersectionRatio <= 0) return;
                                lazyprevimg();
                                io.disconnect();
                            });
                            io.observe(e[0]);
                    ...
                    if(e.hasClass("swiper-thumbnail-pagination") || e.hasClass("swiper-container-main")){
                        var siblingSwiper = false;
                        if(e.hasClass("swiper-thumbnail-pagination")){
                            siblingSwiper = e.siblings(".swiper-container-main")[0];
                        }else if(e.hasClass("swiper-container-main")){
                            siblingSwiper = e.siblings(".swiper-thumbnail-pagination")[0];
                        }

                        //  console.log(siblingSwiper);
                        if(siblingSwiper){
                            function linkageSiblingSwiper(){

                                var siblingLoop= siblingSwiper.swiper.passedParams.loop;

                                var currIndex = swiper.realIndex -1;
                                var siblingIndex = siblingSwiper.swiper.realIndex -1;

                                if( currIndex != siblingIndex && siblingIndex < currIndex ){
                                    stopMaximum =false;
                                    if(siblingLoop){
                                        siblingSwiper.swiper.slideTo(currIndex);
                                    }else{
                                        siblingSwiper.swiper.slideToLoop(currIndex);
                                    }
                                    stopMaximum =true;
                                }
                                swiper.on('transitionStart', function() {
                                    if(stopMaximum){
                                        stopMaximum =false;
                                        if(siblingLoop){
                                            siblingSwiper.swiper.slideTo(swiper.activeIndex);
                                        }else{
                                            siblingSwiper.swiper.slideToLoop(swiper.activeIndex);
                                        }
                                    }
                                })
                                swiper.on('transitionEnd', function() {
                            ...
                            if(typeof siblingSwiper.swiper != "undefined" ){
                                linkageSiblingSwiper();
                            }else{
                            var getSiblingSwiper = setInterval(function(){
                                    if(typeof siblingSwiper.swiper != "undefined" ){
                                        clearTimeout(getSiblingSwiper);
                                        linkageSiblingSwiper();
                                    }
                                },16)
                            }
         ...
         if(e.is(":visible")){
            MutationObserveridden();
         }else{
            if(typeof MutationObserver == "function"){
                var observer = new MutationObserver(function(){if(e.is(":visible")){observer.disconnect();MutationObserveridden();}});
                    observer.observe(e.parents(":hidden").length?e.parents(":hidden").last()[0]:e[0],{"attributes" : true});
            }else{
                e.show();MutationObserveridden();
            }
        }
...
jQuery(document).ready(function () {
    ...
    if( typeof DNNapplyTypography == "undefined" ){
        swiperLauncher($(".swiper-container"));
    }else{
        setTimeout(function(){
            swiperLauncher($(".swiper-container"));
        },1000)
    }
    $('.swiper-container .is-lightbox').off().on("click",function (event) {
