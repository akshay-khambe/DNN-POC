<%@ control language="C#" inherits="Cross.Modules.Article.View.Settings_ListDashboard, App_Web_settings_listdashboard.ascx.6c70b780" autoeventwireup="true" %>
<%@ Register TagPrefix="dnn" TagName="Label" Src="~/controls/LabelControl.ascx" %>
<%@ Register TagPrefix="dnn" TagName="sectionhead" Src="~/controls/SectionHeadControl.ascx" %>
<%@ Register TagPrefix="dnn" Assembly="DotNetNuke" Namespace="DotNetNuke.UI.WebControls" %>
<asp:Wizard ID="wizFlash" runat="server" CssClass="dnnFormItem" ActiveStepIndex="0" Font-Names="Verdana"
    SideBarStyle-Width="150px" CellPadding="5" CellSpacing="5" FinishCompleteButtonType="Link"
    FinishPreviousButtonType="Link" StartNextButtonType="Link" StepNextButtonType="Link"
    StepPreviousButtonType="Link" Width="100%" BackColor="#F7F6F3" BorderColor="#CCCCCC"
    ...
    <WizardSteps>
        <asp:WizardStep ID="wsGeneral" runat="server" Title='<%# Localization.GetString("wsGeneral", LocalResourceFile) %>'
            ...
            <table cellspacing="2" cellpadding="2" runat="server" id="tblPlayModeTips" class="dnnFormItem"
                width="100%">
                <tr>
                    <td colspan="2">
                        <asp:Image ID="imgImageNavigate_Classical" runat="server" CssClass="dnnFormMessage dnnFormInfo"
                            ImageAlign="Top" ImageUrl="~/DesktopModules/CrossArticle/images/ImageNavigate_Classical.jpg" />
                        <br />
                ...
                <tr>
                    <td colspan="2">
                        <br />
                        <asp:Image ID="imgImageNavigate_Integrative" runat="server" CssClass="dnnFormMessage dnnFormInfo"
                            ImageAlign="Top" ImageUrl="~/DesktopModules/CrossArticle/images/ImageNavigate_Integrative.jpg" />
                        <br />
                ...
                <tr>
                    <td colspan="2">
                        <br />
                        <asp:Image ID="imgNavigate_ButtonFree" runat="server" CssClass="dnnFormMessage dnnFormInfo"
                            ImageAlign="Top" ImageUrl="~/DesktopModules/CrossArticle/images/ImageNavigate_ButtonFree.jpg" />
                        <br />
        ...
        <asp:WizardStep ID="wsFlashSettings" runat="server" Title='<%# Localization.GetString("wsFlashSettings",LocalResourceFile) %>'>
            ...
            <table cellspacing="2" cellpadding="2" runat="server" id="tblFlashGeneral" class="dnnFormItem"
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtFlashWidth" runat="server" Width="200px"></asp:TextBox>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtFlashHeight" runat="server" Width="200px"></asp:TextBox>
            ...
            <table cellspacing="2" cellpadding="2" runat="server" id="tblNavigateSettings" visible="false"
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtIntervalTime" runat="server" Width="200px"></asp:TextBox>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtTextHeight" runat="server" Width="200px"></asp:TextBox>
            ...
            <table cellspacing="2" cellpadding="2" runat="server" id="tblNavigateIntegrativeSettings"
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtNavigateIntegrative_TextSize" runat="server" Width="200px"></asp:TextBox>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtNavigateIntegrative_Speed" runat="server" Width="200px"></asp:TextBox>
            ...
            <dnn:sectionhead ID="secNavigateButtonFreeSettings" runat="server" Section="tblNavigateButtonFreeSettings"
                ...
                CssClass="SubHead"></dnn:sectionhead>
            <table cellspacing="2" cellpadding="2" runat="server" id="tblNavigateButtonFreeSettings"
                class="dnnFormItem" width="100%" visible="false">
                <tr>
                    <td style="width: 250px">
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtNavigateButtonFree_Stop_Time" runat="server" Width="200px"></asp:TextBox>
